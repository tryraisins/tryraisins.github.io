...
const PROJECTS: Project[] = [
  {
    title: 'QuickBillz',
    tagline: 'Freelance invoicing without the SaaS subscription. Custom styling, multiple export formats, typography that does not look like a template. Next.js, TypeScript, Tailwind.',
    categories: ['Next.js', 'TypeScript', 'PDF'],
    url: 'https://quickbillz.tryraisins.dev',
    domain: 'quickbillz.tryraisins.dev',
    year: '2026',
  },
  {
    title: 'Terror Tracker',
    tagline: 'A live map of insurgent activity across Nigeria — verified incident reports, casualty counts, and threat clusters, updated as the news comes in. Next.js, MongoDB, Node pipelines.',
    categories: ['Next.js', 'MongoDB', 'Dashboard'],
  ...
  {
    title: 'Talent Hunter',
    tagline: 'Recruiters drowning in resumes: paste a job spec, upload the pile, get a ranked shortlist in minutes instead of hours. Vite + React with NLP-driven candidate matching.',
    categories: ['React', 'Vite', 'NLP'],
  ...
  {
    title: 'Echo List',
    tagline: 'Your Shazam history is a graveyard of songs you meant to save. This resurrects it as a YouTube playlist — one upload, done. React + Vite, tapped into the YouTube Data API.',
    categories: ['React', 'Vite', 'YouTube API'],
  ...
  {
    title: 'StreamSlip',
    tagline: 'Your YouTube Music listening history, printed as a receipt you can actually screenshot. Wrapped-style stats, whenever you want them. Next.js with canvas rendering and OAuth.',
    categories: ['Next.js', 'Canvas', 'OAuth'],
  ...
  {
    title: 'ISS Tracker',
    tagline: 'The International Space Station is somewhere over Earth right now. Here is exactly where — plus who is onboard. React with live API polling and interactive mapping.',
    categories: ['React', 'Live Data', 'Mapping'],
