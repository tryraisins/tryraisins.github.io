...
`)}const Pf={1:"Linear",2:"Reinhard",3:"Cineon",4:"ACESFilmic",6:"AgX",7:"Neutral",5:"Custom"};function Lf(i,e){const t=Pf[e];return t===void 0?(He("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ji=new U;function Df(){tt.getLuminanceCoefficients(ji);const i=ji.x.toFixed(4),e=ji.y.toFixed(4),t=ji.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+d);const w=b+m+a,M=b+d+o,y=sa(r,r.VERTEX_SHADER,w),E=sa(r,r.FRAGMENT_SHADER,M);r.attachShader(S,y),r.attachShader(S,E),t.index0AttributeName!==void 0?r.bindAttribLocation(S,0,t.index0AttributeName):t.hasPositionAttribute===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function R(D){if(i.debug.checkShaderErrors){const F=r.getProgramInfoLog(S)||"",B=r.getShaderInfoLog(y)||"",N=r.getShaderInfoLog(E)||"",G=F.trim(),Q=B.trim(),X=N.trim();let oe=!0,Y=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(oe=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,S,y,E);else{const ie=oa(r,y,"vertex"),ne=oa(r,E,"fragment");rt("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
...
Program Info Log: `+G+`
`+ie+`
`+ne)}else G!==""?He("WebGLProgram: Program Info Log:",G):(Q===""||X==="")&&(Y=!1);Y&&(D.diagnostics={runnable:oe,programLog:G,vertexShader:{log:Q,prefix:m},fragmentShader:{log:X,prefix:d}})}r.deleteShader(y),r.deleteShader(E),x=new er(r,S),A=Uf(r,S)}let x;this.getUniforms=function(){return x===void 0&&R(this),x};let A;this.getAttributes=function(){return A===void 0&&R(this),A};let P=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return P===!1&&(P=r.getProgramParameter(S,bf)),P},this.destroy=function(){n.releaseStatesOfProgram(this),r.deleteProgram(S),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Af++,this.cacheKey=e,this.usedTimes=1,this.program=S,this.vertexShader=y,this.fragmentShader=E,this}let $f=0;class Qf{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,t,n){const r=this._getShaderCacheForMaterial(e);return r.has(t)===!1&&(r.add(t),t.usedTimes++),r.has(n)===!1&&(r.add(n),n.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new jf(e),t.set(e,n)),n}}class jf{constructor(e){this.id=$f++,this.code=e,this.usedTimes=0}}function ed(i){return i===1030||i===37490||i===36285}function td(i,e,t,n,r,s){const a=new Ma,o=new Qf,l=new Set,c=[],u=new Map,f=n.logarithmicDepthBuffer;let h=n.precision;const p={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(x){return l.add(x),x===0?"uv":`uv${x}`}function S(x,A,P,D,F,B){const N=D.fog,G=F.geometry,Q=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?D.environment:null,X=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,oe=e.get(x.envMap||Q,X),Y=oe&&oe.mapping===306?oe.image.height:null,ie=p[x.type];x.precision!==null&&(h=n.getMaxPrecision(x.precision),h!==x.precision&&He("WebGLProgram.getParameters:",x.precision,"not supported, using",h,"instead."));const ne=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,Le=ne!==void 0?ne.length:0;let be=0;G.morphAttributes.position!==void 0&&(be=1),G.morphAttributes.normal!==void 0&&(be=2),G.morphAttributes.color!==void 0&&(be=3);let nt,Ye,et,K;if(ie){const ut=Qt[ie];nt=ut.vertexShader,Ye=ut.fragmentShader}else{nt=x.vertexShader,Ye=x.fragmentShader;const ut=o.getVertexShaderStage(x),st=o.getFragmentShaderStage(x);o.update(x,ut,st),et=ut.id,K=st.id}const re=i.getRenderTarget(),V=i.state.buffers.depth.getReversed(),z=F.isInstancedMesh===!0,ee=F.isBatchedMesh===!0,pe=!!x.map,ke=!!x.matcap,Z=!!oe,J=!!x.aoMap,he=!!x.lightMap,ae=!!x.bumpMap&&x.wireframe===!1,le=!!x.normalMap,De=!!x.displacementMap,Te=!!x.emissiveMap,Be=!!x.metalnessMap,ze=!!x.roughnessMap,C=x.anisotropy>0,$e=x.clearcoat>0,qe=x.dispersion>0,T=x.retroreflectivity>0,g=x.iridescence>0,O=x.sheen>0,W=x.transmission>0,$=C&&!!x.anisotropyMap,ue=$e&&!!x.clearcoatMap,de=$e&&!!x.clearcoatNormalMap,j=$e&&!!x.clearcoatRoughnessMap,se=g&&!!x.iridescenceMap,me=g&&!!x.iridescenceThicknessMap,Ue=O&&!!x.sheenColorMap,ve=O&&!!x.sheenRoughnessMap,ge=!!x.specularMap,Fe=!!x.specularColorMap,Ge=!!x.specularIntensityMap,Xe=W&&!!x.transmissionMap,I=W&&!!x.thicknessMap,_e=!!x.gradientMap,te=!!x.alphaMap,xe=x.alphaTest>0,Ee=!!x.alphaHash,ce=!!x.extensions;let Oe=0;x.toneMapped&&(re===null||re.isXRRenderTarget===!0)&&(Oe=i.toneMapping);const Ie={shaderID:ie,shaderType:x.type,shaderName:x.name,vertexShader:nt,fragmentShader:Ye,defines:x.defines,customVertexShaderID:et,customFragmentShaderID:K,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:h,batching:ee,batchingColor:ee&&F._colorsTexture!==null,instancing:z,instancingColor:z&&F.instanceColor!==null,instancingMorph:z&&F.morphTexture!==null,outputColorSpace:re===null?i.outputColorSpace:re.isXRRenderTarget===!0?re.texture.colorSpace:tt.workingColorSpace,alphaToCoverage:!!x.alphaToCoverage,map:pe,matcap:ke,envMap:Z,envMapMode:Z&&oe.mapping,envMapCubeUVHeight:Y,aoMap:J,lightMap:he,bumpMap:ae,normalMap:le,displacementMap:De,emissiveMap:Te,normalMapObjectSpace:le&&x.normalMapType===1,normalMapTangentSpace:le&&x.normalMapType===0,packedNormalMap:le&&x.normalMapType===0&&ed(x.normalMap.format),metalnessMap:Be,roughnessMap:ze,anisotropy:C,anisotropyMap:$,clearcoat:$e,clearcoatMap:ue,clearcoatNormalMap:de,clearcoatRoughnessMap:j,dispersion:qe,retroreflection:T,iridescence:g,iridescenceMap:se,iridescenceThicknessMap:me,sheen:O,sheenColorMap:Ue,sheenRoughnessMap:ve,specularMap:ge,specularColorMap:Fe,specularIntensityMap:Ge,transmission:W,transmissionMap:Xe,thicknessMap:I,gradientMap:_e,opaque:x.transparent===!1&&x.blending===1&&x.alphaToCoverage===!1,alphaMap:te,alphaTest:xe,alphaHash:Ee,combine:x.combine,mapUv:pe&&_(x.map.channel),aoMapUv:J&&_(x.aoMap.channel),lightMapUv:he&&_(x.lightMap.channel),bumpMapUv:ae&&_(x.bumpMap.channel),normalMapUv:le&&_(x.normalMap.channel),displacementMapUv:De&&_(x.displacementMap.channel),emissiveMapUv:Te&&_(x.emissiveMap.channel),metalnessMapUv:Be&&_(x.metalnessMap.channel),roughnessMapUv:ze&&_(x.roughnessMap.channel),anisotropyMapUv:$&&_(x.anisotropyMap.channel),clearcoatMapUv:ue&&_(x.clearcoatMap.channel),clearcoatNormalMapUv:de&&_(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:j&&_(x.clearcoatRoughnessMap.channel),iridescenceMapUv:se&&_(x.iridescenceMap.channel),iridescenceThicknessMapUv:me&&_(x.iridescenceThicknessMap.channel),sheenColorMapUv:Ue&&_(x.sheenColorMap.channel),sheenRoughnessMapUv:ve&&_(x.sheenRoughnessMap.channel),specularMapUv:ge&&_(x.specularMap.channel),specularColorMapUv:Fe&&_(x.specularColorMap.channel),specularIntensityMapUv:Ge&&_(x.specularIntensityMap.channel),transmissionMapUv:Xe&&_(x.transmissionMap.channel),thicknessMapUv:I&&_(x.thicknessMap.channel),alphaMapUv:te&&_(x.alphaMap.channel),vertexTangents:!!G.attributes.tangent&&(le||C),vertexNormals:!!G.attributes.normal,vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,pointsUvs:F.isPoints===!0&&!!G.attributes.uv&&(pe||te),fog:!!N,useFog:x.fog===!0,fogExp2:!!N&&N.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||G.attributes.normal===void 0&&le===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:f,reversedDepthBuffer:V,skinning:F.isSkinnedMesh===!0,hasPositionAttribute:G.attributes.position!==void 0,morphTargets:G.morphAttributes.position!==void 0,morphNormals:G.morphAttributes.normal!==void 0,morphColors:G.morphAttributes.color!==void 0,morphTargetsCount:Le,morphTextureStride:be,numSunLights:A.sun.length,numDirLights:A.directional.length,numPointLights:A.point.length,numSpotLights:A.spot.length,numSpotLightMaps:A.spotLightMap.length,numRectAreaLights:A.rectArea.length,numHemiLights:A.hemi.length,numSunLightShadows:A.sunShadowMap.length,numDirLightShadows:A.directionalShadowMap.length,numPointLightShadows:A.pointShadowMap.length,numSpotLightShadows:A.spotShadowMap.length,numSpotLightShadowsWithMaps:A.numSpotLightShadowsWithMaps,numLightProbes:A.numLightProbes,numLightProbeGrids:B.length,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:x.dithering,shadowMapEnabled:i.shadowMap.enabled&&P.length>0,shadowMapType:i.shadowMap.type,toneMapping:Oe,decodeVideoTexture:pe&&x.map.isVideoTexture===!0&&tt.getTransfer(x.map.colorSpace)===ot,decodeVideoTextureEmissive:Te&&x.emissiveMap.isVideoTexture===!0&&tt.getTransfer(x.emissiveMap.colorSpace)===ot,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===2,flipSided:x.side===1,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:ce&&x.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ce&&x.extensions.multiDraw===!0||ee)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return Ie.vertexUv1s=l.has(1),Ie.vertexUv2s=l.has(2),Ie.vertexUv3s=l.has(3),l.clear(),Ie}function m(x){const A=[];if(x.shaderID?A.push(x.shaderID):(A.push(x.customVertexShaderID),A.push(x.customFragmentShaderID)),x.defines!==void 0)for(const P in x.defines)A.push(P),A.push(x.defines[P]);return x.isRawShaderMaterial===!1&&(d(A,x),b(A,x),A.push(i.outputColorSpace)),A.push(x.customProgramCacheKey),A.join()}function d(x,A){x.push(A.precision),x.push(A.outputColorSpace),x.push(A.envMapMode),x.push(A.envMapCubeUVHeight),x.push(A.mapUv),x.push(A.alphaMapUv),x.push(A.lightMapUv),x.push(A.aoMapUv),x.push(A.bumpMapUv),x.push(A.normalMapUv),x.push(A.displacementMapUv),x.push(A.emissiveMapUv),x.push(A.metalnessMapUv),x.push(A.roughnessMapUv),x.push(A.anisotropyMapUv),x.push(A.clearcoatMapUv),x.push(A.clearcoatNormalMapUv),x.push(A.clearcoatRoughnessMapUv),x.push(A.iridescenceMapUv),x.push(A.iridescenceThicknessMapUv),x.push(A.sheenColorMapUv),x.push(A.sheenRoughnessMapUv),x.push(A.specularMapUv),x.push(A.specularColorMapUv),x.push(A.specularIntensityMapUv),x.push(A.transmissionMapUv),x.push(A.thicknessMapUv),x.push(A.combine),x.push(A.fogExp2),x.push(A.sizeAttenuation),x.push(A.morphTargetsCount),x.push(A.morphAttributeCount),x.push(A.numSunLights),x.push(A.numDirLights),x.push(A.numPointLights),x.push(A.numSpotLights),x.push(A.numSpotLightMaps),x.push(A.numHemiLights),x.push(A.numRectAreaLights),x.push(A.numSunLightShadows),x.push(A.numDirLightShadows),x.push(A.numPointLightShadows),x.push(A.numSpotLightShadows),x.push(A.numSpotLightShadowsWithMaps),x.push(A.numLightProbes),x.push(A.shadowMapType),x.push(A.toneMapping),x.push(A.numClippingPlanes),x.push(A.numClipIntersection),x.push(A.depthPacking)}function b(x,A){a.disableAll(),A.instancing&&a.enable(0),A.instancingColor&&a.enable(1),A.instancingMorph&&a.enable(2),A.matcap&&a.enable(3),A.envMap&&a.enable(4),A.normalMapObjectSpace&&a.enable(5),A.normalMapTangentSpace&&a.enable(6),A.clearcoat&&a.enable(7),A.iridescence&&a.enable(8),A.alphaTest&&a.enable(9),A.vertexColors&&a.enable(10),A.vertexAlphas&&a.enable(11),A.vertexUv1s&&a.enable(12),A.vertexUv2s&&a.enable(13),A.vertexUv3s&&a.enable(14),A.vertexTangents&&a.enable(15),A.anisotropy&&a.enable(16),A.alphaHash&&a.enable(17),A.batching&&a.enable(18),A.dispersion&&a.enable(19),A.retroreflection&&a.enable(24),A.batchingColor&&a.enable(20),A.gradientMap&&a.enable(21),A.packedNormalMap&&a.enable(22),A.vertexNormals&&a.enable(23),x.push(a.mask),a.disableAll(),A.fog&&a.enable(0),A.useFog&&a.enable(1),A.flatShading&&a.enable(2),A.logarithmicDepthBuffer&&a.enable(3),A.reversedDepthBuffer&&a.enable(4),A.skinning&&a.enable(5),A.morphTargets&&a.enable(6),A.morphNormals&&a.enable(7),A.morphColors&&a.enable(8),A.premultipliedAlpha&&a.enable(9),A.shadowMapEnabled&&a.enable(10),A.doubleSided&&a.enable(11),A.flipSided&&a.enable(12),A.useDepthPacking&&a.enable(13),A.dithering&&a.enable(14),A.transmission&&a.enable(15),A.sheen&&a.enable(16),A.opaque&&a.enable(17),A.pointsUvs&&a.enable(18),A.decodeVideoTexture&&a.enable(19),A.decodeVideoTextureEmissive&&a.enable(20),A.alphaToCoverage&&a.enable(21),A.numLightProbeGrids>0&&a.enable(22),A.hasPositionAttribute&&a.enable(23),x.push(a.mask)}function w(x){const A=p[x.type];let P;if(A){const D=Qt[A];P=gl.clone(D.uniforms)}else P=x.uniforms;return P}function M(x,A){let P=u.get(A);return P!==void 0?++P.usedTimes:(P=new Kf(i,A,x,r),c.push(P),u.set(A,P)),P}function y(x){if(--x.usedTimes===0){const A=c.indexOf(x);c[A]=c[c.length-1],c.pop(),u.delete(x.cacheKey),x.destroy()}}function E(x){o.remove(x)}function R(){o.dispose()}return{getParameters:S,getProgramCacheKey:m,getUniforms:w,acquireProgram:M,releaseProgram:y,releaseShaderCache:E,programs:c,dispose:R}}function nd(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function r(a,o,l){i.get(a)[o]=l}function s(){i=new WeakMap}return{has:e,get:t,remove:n,update:r,dispose:s}}function id(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.materialVariant!==e.materialVariant?i.materialVariant-e.materialVariant:i.z!==e.z?i.z-e.z:i.id-e.id}function fa(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function da(){const i=[];let e=0;const t=[],n=[],r=[];function s(){e=0,t.length=0,n.length=0,r.length=0}function a(h){let p=0;return h.isInstancedMesh&&(p+=2),h.isSkinnedMesh&&(p+=1),p}function o(h,p,_,S,m,d){let b=i[e];return b===void 0?(b={id:h.id,object:h,geometry:p,material:_,materialVariant:a(h),groupOrder:S,renderOrder:h.renderOrder,z:m,group:d},i[e]=b):(b.id=h.id,b.object=h,b.geometry=p,b.material=_,b.materialVariant=a(h),b.groupOrder=S,b.renderOrder=h.renderOrder,b.z=m,b.group=d),e++,b}function l(h,p,_,S,m,d,b){b.reversedDepth===!0&&(m=-m);const w=o(h,p,_,S,m,d);_.transmission>0?n.push(w):_.transparent===!0?r.push(w):t.push(w)}function c(h,p,_,S,m,d){const b=o(h,p,_,S,m,d);_.transmission>0?n.unshift(b):_.transparent===!0?r.unshift(b):t.unshift(b)}function u(h,p){t.length>1&&t.sort(h||id),n.length>1&&n.sort(p||fa),r.length>1&&r.sort(p||fa)}function f(){for(let h=e,p=i.length;h<p;h++){const _=i[h];if(_.id===null)break;_.id=null,_.object=null,_.geometry=null,_.material=null,_.group=null}}return{opaque:t,transmissive:n,transparent:r,init:s,push:l,unshift:c,finish:f,sort:u}}function rd(){let i=new WeakMap;function e(n,r){const s=i.get(n);let a;return s===void 0?(a=new da,i.set(n,[a])):r>=s.length?(a=new da,s.push(a)):a=s[r],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function sd(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"SunLight":case"DirectionalLight":t={direction:new U,color:new je};break;case"SpotLight":t={position:new U,direction:new U,color:new je,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new U,color:new je,distance:0,decay:0};break;case"HemisphereLight":t={direction:new U,skyColor:new je,groundColor:new je};break;case"RectAreaLight":t={color:new je,position:new U,halfWidth:new U,halfHeight:new U};break}return i[e.id]=t,t}}}function ad(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"SunLight":case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new fe};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new fe};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new fe,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let od=0;function ld(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function cd(i){const e=new sd,t=ad(),n={version:0,hash:{sunLength:-1,directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numSunShadows:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],sun:[],sunShadow:[],sunShadowMap:[],sunShadowMatrix:[],sunShadowCascade:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new U);const r=new U,s=new ht,a=new ht;function o(c){let u=0,f=0,h=0;for(let F=0;F<9;F++)n.probe[F].set(0,0,0);let p=0,_=0,S=0,m=0,d=0,b=0,w=0,M=0,y=0,E=0,R=0,x=0,A=0,P=0;c.sort(ld);for(let F=0,B=c.length;F<B;F++){const N=c[F],G=N.color,Q=N.intensity,X=N.distance;let oe=null;if(N.shadow&&N.shadow.map&&(N.shadow.map.texture.format===1030?oe=N.shadow.map.texture:oe=N.shadow.map.depthTexture||N.shadow.map.texture),N.isAmbientLight)u+=G.r*Q,f+=G.g*Q,h+=G.b*Q;else if(N.isLightProbe){for(let Y=0;Y<9;Y++)n.probe[Y].addScaledVector(N.sh.coefficients[Y],Q);P++}else if(N.isSunLight){const Y=e.get(N);if(Y.color.copy(N.color).multiplyScalar(N.intensity),N.castShadow){const ie=N.shadow,ne=t.get(N);ne.shadowIntensity=ie.intensity,ne.shadowBias=ie.bias,ne.shadowNormalBias=ie.normalBias,ne.shadowRadius=ie.radius,ne.shadowMapSize.copy(ie.mapSize).multiply(ie.getFrameExtents()),n.sunShadow[_]=ne,n.sunShadowMap[_]=oe;const Le=ie.getViewportCount();for(let be=0;be<Le;be++)n.sunShadowMatrix[S+be]=ie.getMatrix(be),n.sunShadowCascade[S+be]=ie._cascadeData[be];S+=Le,_++}n.sun[p]=Y,p++}else if(N.isDirectionalLight){const Y=e.get(N);if(Y.color.copy(N.color).multiplyScalar(N.intensity),N.castShadow){const ie=N.shadow,ne=t.get(N);ne.shadowIntensity=ie.intensity,ne.shadowBias=ie.bias,ne.shadowNormalBias=ie.normalBias,ne.shadowRadius=ie.radius,ne.shadowMapSize=ie.mapSize,n.directionalShadow[m]=ne,n.directionalShadowMap[m]=oe,n.directionalShadowMatrix[m]=N.shadow.matrix,y++}n.directional[m]=Y,m++}else if(N.isSpotLight){const Y=e.get(N);Y.position.setFromMatrixPosition(N.matrixWorld),Y.color.copy(G).multiplyScalar(Q),Y.distance=X,Y.coneCos=Math.cos(N.angle),Y.penumbraCos=Math.cos(N.angle*(1-N.penumbra)),Y.decay=N.decay,n.spot[b]=Y;const ie=N.shadow;if(N.map&&(n.spotLightMap[x]=N.map,x++,ie.updateMatrices(N),N.castShadow&&A++),n.spotLightMatrix[b]=ie.matrix,N.castShadow){const ne=t.get(N);ne.shadowIntensity=ie.intensity,ne.shadowBias=ie.bias,ne.shadowNormalBias=ie.normalBias,ne.shadowRadius=ie.radius,ne.shadowMapSize=ie.mapSize,n.spotShadow[b]=ne,n.spotShadowMap[b]=oe,R++}b++}else if(N.isRectAreaLight){const Y=e.get(N);Y.color.copy(G).multiplyScalar(Q),Y.halfWidth.set(N.width*.5,0,0),Y.halfHeight.set(0,N.height*.5,0),n.rectArea[w]=Y,w++}else if(N.isPointLight){const Y=e.get(N);if(Y.color.copy(N.color).multiplyScalar(N.intensity),Y.distance=N.distance,Y.decay=N.decay,N.castShadow){const ie=N.shadow,ne=t.get(N);ne.shadowIntensity=ie.intensity,ne.shadowBias=ie.bias,ne.shadowNormalBias=ie.normalBias,ne.shadowRadius=ie.radius,ne.shadowMapSize=ie.mapSize,ne.shadowCameraNear=ie.camera.near,ne.shadowCameraFar=ie.camera.far,n.pointShadow[d]=ne,n.pointShadowMap[d]=oe,n.pointShadowMatrix[d]=N.shadow.matrix,E++}n.point[d]=Y,d++}else if(N.isHemisphereLight){const Y=e.get(N);Y.skyColor.copy(N.color).multiplyScalar(Q),Y.groundColor.copy(N.groundColor).multiplyScalar(Q),n.hemi[M]=Y,M++}}w>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=Me.LTC_FLOAT_1,n.rectAreaLTC2=Me.LTC_FLOAT_2):(n.rectAreaLTC1=Me.LTC_HALF_1,n.rectAreaLTC2=Me.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=f,n.ambient[2]=h;const D=n.hash;(D.sunLength!==p||D.directionalLength!==m||D.pointLength!==d||D.spotLength!==b||D.rectAreaLength!==w||D.hemiLength!==M||D.numSunShadows!==_||D.numDirectionalShadows!==y||D.numPointShadows!==E||D.numSpotShadows!==R||D.numSpotMaps!==x||D.numLightProbes!==P)&&(n.sun.length=p,n.directional.length=m,n.spot.length=b,n.rectArea.length=w,n.point.length=d,n.hemi.length=M,n.sunShadow.length=_,n.sunShadowMap.length=_,n.sunShadowMatrix.length=S,n.sunShadowCascade.length=S,n.directionalShadow.length=y,n.directionalShadowMap.length=y,n.directionalShadowMatrix.length=y,n.pointShadow.length=E,n.pointShadowMap.length=E,n.pointShadowMatrix.length=E,n.spotShadow.length=R,n.spotShadowMap.length=R,n.spotLightMatrix.length=R+x-A,n.spotLightMap.length=x,n.numSpotLightShadowsWithMaps=A,n.numLightProbes=P,D.sunLength=p,D.directionalLength=m,D.pointLength=d,D.spotLength=b,D.rectAreaLength=w,D.hemiLength=M,D.numSunShadows=_,D.numDirectionalShadows=y,D.numPointShadows=E,D.numSpotShadows=R,D.numSpotMaps=x,D.numLightProbes=P,n.version=od++)}function l(c,u){let f=0,h=0,p=0,_=0,S=0,m=0;const d=u.matrixWorldInverse;for(let b=0,w=c.length;b<w;b++){const M=c[b];if(M.isSunLight){const y=n.sun[f];y.direction.setFromMatrixPosition(M.matrixWorld),y.direction.transformDirection(d),f++}else if(M.isDirectionalLight){const y=n.directional[h];y.direction.setFromMatrixPosition(M.matrixWorld),r.setFromMatrixPosition(M.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(d),h++}else if(M.isSpotLight){const y=n.spot[_];y.position.setFromMatrixPosition(M.matrixWorld),y.position.applyMatrix4(d),y.direction.setFromMatrixPosition(M.matrixWorld),r.setFromMatrixPosition(M.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(d),_++}else if(M.isRectAreaLight){const y=n.rectArea[S];y.position.setFromMatrixPosition(M.matrixWorld),y.position.applyMatrix4(d),a.identity(),s.copy(M.matrixWorld),s.premultiply(d),a.extractRotation(s),y.halfWidth.set(M.width*.5,0,0),y.halfHeight.set(0,M.height*.5,0),y.halfWidth.applyMatrix4(a),y.halfHeight.applyMatrix4(a),S++}else if(M.isPointLight){const y=n.point[p];y.position.setFromMatrixPosition(M.matrixWorld),y.position.applyMatrix4(d),p++}else if(M.isHemisphereLight){const y=n.hemi[m];y.direction.setFromMatrixPosition(M.matrixWorld),y.direction.transformDirection(d),m++}}}return{setup:o,setupView:l,state:n}}function pa(i){const e=new cd(i),t=[],n=[],r=[];function s(h){f.camera=h,t.length=0,n.length=0,r.length=0}function a(h){t.push(h)}function o(h){n.push(h)}function l(h){r.push(h)}function c(){e.setup(t)}function u(h){e.setupView(t,h)}const f={lightsArray:t,shadowsArray:n,lightProbeGridArray:r,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:s,state:f,setupLights:c,setupLightsView:u,pushLight:a,pushShadow:o,pushLightProbeGrid:l}}function hd(i){let e=new WeakMap;function t(r,s=0){const a=e.get(r);let o;return a===void 0?(o=new pa(i),e.set(r,[o])):s>=a.length?(o=new pa(i),a.push(o)):o=a[s],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const ud=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,dd=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],pd=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)],ma=new ht,gi=new U,Hr=new U;function md(i,e,t){let n=new jr;const r=new fe,s=new fe,a=new pt,o=new Sl,l=new yl,c={},u=t.maxTextureSize,f={0:1,1:0,2:2},h=new en({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new fe},radius:{value:4}},vertexShader:ud,fragmentShader:fd}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const _=new It;_.setAttribute("position",new jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new xt(_,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=1;let d=this.type;this.render=function(E,R,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||E.length===0)return;this.type===2&&(He("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=1);const A=i.getRenderTarget(),P=i.getActiveCubeFace(),D=i.getActiveMipmapLevel(),F=i.state;F.setBlending(0),F.buffers.depth.getReversed()===!0?F.buffers.color.setClear(0,0,0,0):F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const B=d!==this.type;B&&R.traverse(function(N){N.material&&(Array.isArray(N.material)?N.material.forEach(G=>G.needsUpdate=!0):N.material.needsUpdate=!0)});for(let N=0,G=E.length;N<G;N++){const Q=E[N],X=Q.shadow;if(X===void 0){He("WebGLShadowMap:",Q,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;r.copy(X.mapSize);const oe=X.getFrameExtents();r.multiply(oe),s.copy(X.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/oe.x),r.x=s.x*oe.x,X.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/oe.y),r.y=s.y*oe.y,X.mapSize.y=s.y));const Y=i.state.buffers.depth.getReversed();if(X.camera._reversedDepth=Y,X.map===null||B===!0){if(X.map!==null&&(X.map.depthTexture!==null&&(X.map.depthTexture.dispose(),X.map.depthTexture=null),X.map.dispose()),this.type===3){if(Q.isPointLight){He("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}X.map=new qt(r.x,r.y,{format:1030,type:1016,minFilter:1006,magFilter:1006,generateMipmaps:!1}),X.map.texture.name=Q.name+".shadowMap",X.map.depthTexture=new Si(r.x,r.y,1015),X.map.depthTexture.name=Q.name+".shadowMapDepth",X.map.depthTexture.format=1026,X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=1003,X.map.depthTexture.magFilter=1003}else Q.isPointLight?(X.map=new ka(r.x),X.map.depthTexture=new No(r.x,1014)):(X.map=new qt(r.x,r.y),X.map.depthTexture=new Si(r.x,r.y,1014)),X.map.depthTexture.name=Q.name+".shadowMap",X.map.depthTexture.format=1026,this.type===1?(X.map.depthTexture.compareFunction=Y?518:515,X.map.depthTexture.minFilter=1006,X.map.depthTexture.magFilter=1006):(X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=1003,X.map.depthTexture.magFilter=1003);X.camera.updateProjectionMatrix()}X.map.isWebGLCubeRenderTarget!==!0&&(X.map.width!==r.x||X.map.height!==r.y)&&X.map.setSize(r.x,r.y);const ie=X.map.isWebGLCubeRenderTarget?6:X.getViewportCount();Q.isPointLight!==!0&&X.updateMatrices(Q,x);for(let ne=0;ne<ie;ne++){const Le=X.getCamera(ne);if(Q.isPointLight){const be=X.camera,nt=X.matrix,Ye=Q.distance||be.far;Ye!==be.far&&(be.far=Ye,be.updateProjectionMatrix()),gi.setFromMatrixPosition(Q.matrixWorld),be.position.copy(gi),Hr.copy(be.position),Hr.add(dd[ne]),be.up.copy(pd[ne]),be.lookAt(Hr),be.updateMatrixWorld(),nt.makeTranslation(-gi.x,-gi.y,-gi.z),ma.multiplyMatrices(be.projectionMatrix,be.matrixWorldInverse),X._frustum.setFromProjectionMatrix(ma,be.coordinateSystem,be.reversedDepth)}if(X.map.isWebGLCubeRenderTarget)i.setRenderTarget(X.map,ne),i.clear();else{ne===0&&(i.setRenderTarget(X.map),i.clear());const be=X.getViewport(ne);a.set(s.x*be.x,s.y*be.y,s.x*be.z,s.y*be.w),F.viewport(a)}n=X.getFrustum(ne),M(R,x,Le,Q,this.type)}X.isPointLightShadow!==!0&&this.type===3&&b(X,x),X.needsUpdate=!1}d=this.type,m.needsUpdate=!1,i.setRenderTarget(A,P,D)};function b(E,R){const x=e.update(S);h.defines.VSM_SAMPLES!==E.blurSamples&&(h.defines.VSM_SAMPLES=E.blurSamples,p.defines.VSM_SAMPLES=E.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),E.mapPass===null?E.mapPass=new qt(r.x,r.y,{format:1030,type:1016}):(E.mapPass.width!==E.map.width||E.mapPass.height!==E.map.height)&&E.mapPass.setSize(E.map.width,E.map.height),h.uniforms.shadow_pass.value=E.map.depthTexture,h.uniforms.resolution.value.set(E.map.width,E.map.height),h.uniforms.radius.value=E.radius,i.setRenderTarget(E.mapPass),i.clear(),i.renderBufferDirect(R,null,x,h,S,null),p.uniforms.shadow_pass.value=E.mapPass.texture,p.uniforms.resolution.value.set(E.map.width,E.map.height),p.uniforms.radius.value=E.radius,i.setRenderTarget(E.map),i.clear(),i.renderBufferDirect(R,null,x,p,S,null)}function w(E,R,x,A){let P=null;const D=x.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(D!==void 0)P=D;else if(P=x.isPointLight===!0?l:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const F=P.uuid,B=R.uuid;let N=c[F];N===void 0&&(N={},c[F]=N);let G=N[B];G===void 0&&(G=P.clone(),N[B]=G,R.addEventListener("dispose",y)),P=G}if(P.visible=R.visible,P.wireframe=R.wireframe,A===3?P.side=R.shadowSide!==null?R.shadowSide:R.side:P.side=R.shadowSide!==null?R.shadowSide:f[R.side],P.alphaMap=R.alphaMap,P.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,P.map=R.map,P.clipShadows=R.clipShadows,P.clippingPlanes=R.clippingPlanes,P.clipIntersection=R.clipIntersection,P.displacementMap=R.displacementMap,P.displacementScale=R.displacementScale,P.displacementBias=R.displacementBias,P.wireframeLinewidth=R.wireframeLinewidth,P.linewidth=R.linewidth,x.isPointLight===!0&&P.isMeshDistanceMaterial===!0){const F=i.properties.get(P);F.light=x}return P}function M(E,R,x,A,P){if(E.visible===!1)return;if(E.layers.test(R.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&P===3)&&(!E.frustumCulled||E.intersectsFrustum(n))){E.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,E.matrixWorld);const B=e.update(E),N=E.material;if(Array.isArray(N)){const G=B.groups;for(let Q=0,X=G.length;Q<X;Q++){const oe=G[Q],Y=N[oe.materialIndex];if(Y&&Y.visible){const ie=w(E,Y,A,P);E.onBeforeShadow(i,E,R,x,B,ie,oe),i.renderBufferDirect(x,null,B,ie,E,oe),E.onAfterShadow(i,E,R,x,B,ie,oe)}}}else if(N.visible){const G=w(E,N,A,P);E.onBeforeShadow(i,E,R,x,B,G,null),i.renderBufferDirect(x,null,B,G,E,null),E.onAfterShadow(i,E,R,x,B,G,null)}}const F=E.children;for(let B=0,N=F.length;B<N;B++)M(F[B],R,x,A,P)}function y(E){E.target.removeEventListener("dispose",y);for(const x in c){const A=c[x],P=E.target.uuid;P in A&&(A[P].dispose(),delete A[P])}}}function gd(i,e){function t(){let I=!1;const _e=new pt;let te=null;const xe=new pt(0,0,0,0);return{setMask:function(Ee){te!==Ee&&!I&&(i.colorMask(Ee,Ee,Ee,Ee),te=Ee)},setLocked:function(Ee){I=Ee},setClear:function(Ee,ce,Oe,Ie,ut){ut===!0&&(Ee*=Ie,ce*=Ie,Oe*=Ie),_e.set(Ee,ce,Oe,Ie),xe.equals(_e)===!1&&(i.clearColor(Ee,ce,Oe,Ie),xe.copy(_e))},reset:function(){I=!1,te=null,xe.set(-1,0,0,0)}}}function n(){let I=!1,_e=!1,te=null,xe=null,Ee=null;return{setReversed:function(ce){if(_e!==ce){const Oe=e.get("EXT_clip_control");ce?Oe.clipControlEXT(Oe.LOWER_LEFT_EXT,Oe.ZERO_TO_ONE_EXT):Oe.clipControlEXT(Oe.LOWER_LEFT_EXT,Oe.NEGATIVE_ONE_TO_ONE_EXT),_e=ce;const Ie=Ee;Ee=null,this.setClear(Ie)}},getReversed:function(){return _e},setTest:function(ce){ce?re(i.DEPTH_TEST):V(i.DEPTH_TEST)},setMask:function(ce){te!==ce&&!I&&(i.depthMask(ce),te=ce)},setFunc:function(ce){if(_e&&(ce=oo[ce]),xe!==ce){switch(ce){case 0:i.depthFunc(i.NEVER);break;case 1:i.depthFunc(i.ALWAYS);break;case 2:i.depthFunc(i.LESS);break;case 3:i.depthFunc(i.LEQUAL);break;case 4:i.depthFunc(i.EQUAL);break;case 5:i.depthFunc(i.GEQUAL);break;case 6:i.depthFunc(i.GREATER);break;case 7:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}xe=ce}},setLocked:function(ce){I=ce},setClear:function(ce){Ee!==ce&&(Ee=ce,_e&&(ce=1-ce),i.clearDepth(ce))},reset:function(){I=!1,te=null,xe=null,Ee=null,_e=!1}}}function r(){let I=!1,_e=null,te=null,xe=null,Ee=null,ce=null,Oe=null,Ie=null,ut=null;return{setTest:function(st){I||(st?re(i.STENCIL_TEST):V(i.STENCIL_TEST))},setMask:function(st){_e!==st&&!I&&(i.stencilMask(st),_e=st)},setFunc:function(st,zt,Yt){(te!==st||xe!==zt||Ee!==Yt)&&(i.stencilFunc(st,zt,Yt),te=st,xe=zt,Ee=Yt)},setOp:function(st,zt,Yt){(ce!==st||Oe!==zt||Ie!==Yt)&&(i.stencilOp(st,zt,Yt),ce=st,Oe=zt,Ie=Yt)},setLocked:function(st){I=st},setClear:function(st){ut!==st&&(i.clearStencil(st),ut=st)},reset:function(){I=!1,_e=null,te=null,xe=null,Ee=null,ce=null,Oe=null,Ie=null,ut=null}}}const s=new t,a=new n,o=new r,l=new WeakMap,c=new WeakMap;let u={},f={},h={},p=new WeakMap,_=[],S=null,m=!1,d=null,b=null,w=null,M=null,y=null,E=null,R=null,x=new je(0,0,0),A=0,P=!1,D=null,F=null,B=null,N=null,G=null;const Q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,oe=0;const Y=i.getParameter(i.VERSION);Y.indexOf("WebGL")!==-1?(oe=parseFloat(/^WebGL (\d)/.exec(Y)[1]),X=oe>=1):Y.indexOf("OpenGL ES")!==-1&&(oe=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),X=oe>=2);let ie=null,ne={};const Le=i.getParameter(i.SCISSOR_BOX),be=i.getParameter(i.VIEWPORT),nt=new pt().fromArray(Le),Ye=new pt().fromArray(be);function et(I,_e,te,xe){const Ee=new Uint8Array(4),ce=i.createTexture();i.bindTexture(I,ce),i.texParameteri(I,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(I,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Oe=0;Oe<te;Oe++)I===i.TEXTURE_3D||I===i.TEXTURE_2D_ARRAY?i.texImage3D(_e,0,i.RGBA,1,1,xe,0,i.RGBA,i.UNSIGNED_BYTE,Ee):i.texImage2D(_e+Oe,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Ee);return ce}const K={};K[i.TEXTURE_2D]=et(i.TEXTURE_2D,i.TEXTURE_2D,1),K[i.TEXTURE_CUBE_MAP]=et(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),K[i.TEXTURE_2D_ARRAY]=et(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),K[i.TEXTURE_3D]=et(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),re(i.DEPTH_TEST),a.setFunc(3),ae(!1),le(1),re(i.CULL_FACE),J(0);function re(I){u[I]!==!0&&(i.enable(I),u[I]=!0)}function V(I){u[I]!==!1&&(i.disable(I),u[I]=!1)}function z(I,_e){return h[I]!==_e?(i.bindFramebuffer(I,_e),h[I]=_e,I===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=_e),I===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=_e),!0):!1}function ee(I,_e){let te=_,xe=!1;if(I){te=p.get(_e),te===void 0&&(te=[],p.set(_e,te));const Ee=I.textures;if(te.length!==Ee.length||te[0]!==i.COLOR_ATTACHMENT0){for(let ce=0,Oe=Ee.length;ce<Oe;ce++)te[ce]=i.COLOR_ATTACHMENT0+ce;te.length=Ee.length,xe=!0}}else te[0]!==i.BACK&&(te[0]=i.BACK,xe=!0);xe&&i.drawBuffers(te)}function pe(I){return S!==I?(i.useProgram(I),S=I,!0):!1}const ke={100:i.FUNC_ADD,101:i.FUNC_SUBTRACT,102:i.FUNC_REVERSE_SUBTRACT};ke[103]=i.MIN,ke[104]=i.MAX;const Z={200:i.ZERO,201:i.ONE,202:i.SRC_COLOR,204:i.SRC_ALPHA,210:i.SRC_ALPHA_SATURATE,208:i.DST_COLOR,206:i.DST_ALPHA,203:i.ONE_MINUS_SRC_COLOR,205:i.ONE_MINUS_SRC_ALPHA,209:i.ONE_MINUS_DST_COLOR,207:i.ONE_MINUS_DST_ALPHA,211:i.CONSTANT_COLOR,212:i.ONE_MINUS_CONSTANT_COLOR,213:i.CONSTANT_ALPHA,214:i.ONE_MINUS_CONSTANT_ALPHA};function J(I,_e,te,xe,Ee,ce,Oe,Ie,ut,st){if(I===0){m===!0&&(V(i.BLEND),m=!1);return}if(m===!1&&(re(i.BLEND),m=!0),I!==5){if(I!==d||st!==P){if((b!==100||y!==100)&&(i.blendEquation(i.FUNC_ADD),b=100,y=100),st)switch(I){case 1:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case 2:i.blendFunc(i.ONE,i.ONE);break;case 3:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case 4:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:rt("WebGLState: Invalid blending: ",I);break}else switch(I){case 1:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case 2:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case 3:rt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case 4:rt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:rt("WebGLState: Invalid blending: ",I);break}w=null,M=null,E=null,R=null,x.set(0,0,0),A=0,d=I,P=st}return}Ee=Ee||_e,ce=ce||te,Oe=Oe||xe,(_e!==b||Ee!==y)&&(i.blendEquationSeparate(ke[_e],ke[Ee]),b=_e,y=Ee),(te!==w||xe!==M||ce!==E||Oe!==R)&&(i.blendFuncSeparate(Z[te],Z[xe],Z[ce],Z[Oe]),w=te,M=xe,E=ce,R=Oe),(Ie.equals(x)===!1||ut!==A)&&(i.blendColor(Ie.r,Ie.g,Ie.b,ut),x.copy(Ie),A=ut),d=I,P=!1}function he(I,_e){I.side===2?V(i.CULL_FACE):re(i.CULL_FACE);let te=I.side===1;_e&&(te=!te),ae(te),I.blending===1&&I.transparent===!1?J(0):J(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),a.setFunc(I.depthFunc),a.setTest(I.depthTest),a.setMask(I.depthWrite),s.setMask(I.colorWrite);const xe=I.stencilWrite;o.setTest(xe),xe&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),Te(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?re(i.SAMPLE_ALPHA_TO_COVERAGE):V(i.SAMPLE_ALPHA_TO_COVERAGE)}function ae(I){D!==I&&(I?i.frontFace(i.CW):i.frontFace(i.CCW),D=I)}function le(I){I!==0?(re(i.CULL_FACE),I!==F&&(I===1?i.cullFace(i.BACK):I===2?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):V(i.CULL_FACE),F=I}function De(I){I!==B&&(X&&i.lineWidth(I),B=I)}function Te(I,_e,te){I?(re(i.POLYGON_OFFSET_FILL),(N!==_e||G!==te)&&(N=_e,G=te,a.getReversed()&&(_e=-_e),i.polygonOffset(_e,te))):V(i.POLYGON_OFFSET_FILL)}function Be(I){I?re(i.SCISSOR_TEST):V(i.SCISSOR_TEST)}function ze(I){I===void 0&&(I=i.TEXTURE0+Q-1),ie!==I&&(i.activeTexture(I),ie=I)}function C(I,_e,te){te===void 0&&(ie===null?te=i.TEXTURE0+Q-1:te=ie);let xe=ne[te];xe===void 0&&(xe={type:void 0,texture:void 0},ne[te]=xe),(xe.type!==I||xe.texture!==_e)&&(ie!==te&&(i.activeTexture(te),ie=te),i.bindTexture(I,_e||K[I]),xe.type=I,xe.texture=_e)}function $e(){const I=ne[ie];I!==void 0&&I.type!==void 0&&(i.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function qe(){try{i.compressedTexImage2D(...arguments)}catch(I){rt("WebGLState:",I)}}function T(){try{i.compressedTexImage3D(...arguments)}catch(I){rt("WebGLState:",I)}}function g(){try{i.texSubImage2D(...arguments)}catch(I){rt("WebGLState:",I)}}function O(){try{i.texSubImage3D(...arguments)}catch(I){rt("WebGLState:",I)}}function W(){try{i.compressedTexSubImage2D(...arguments)}catch(I){rt("WebGLState:",I)}}function $(){try{i.compressedTexSubImage3D(...arguments)}catch(I){rt("WebGLState:",I)}}function ue(){try{i.texStorage2D(...arguments)}catch(I){rt("WebGLState:",I)}}function de(){try{i.texStorage3D(...arguments)}catch(I){rt("WebGLState:",I)}}function j(){try{i.texImage2D(...arguments)}catch(I){rt("WebGLState:",I)}}function se(){try{i.texImage3D(...arguments)}catch(I){rt("WebGLState:",I)}}function me(I){return f[I]!==void 0?f[I]:i.getParameter(I)}function Ue(I,_e){f[I]!==_e&&(i.pixelStorei(I,_e),f[I]=_e)}function ve(I){nt.equals(I)===!1&&(i.scissor(I.x,I.y,I.z,I.w),nt.copy(I))}function ge(I){Ye.equals(I)===!1&&(i.viewport(I.x,I.y,I.z,I.w),Ye.copy(I))}function Fe(I,_e){let te=c.get(_e);te===void 0&&(te=new WeakMap,c.set(_e,te));let xe=te.get(I);xe===void 0&&(xe=i.getUniformBlockIndex(_e,I.name),te.set(I,xe))}function Ge(I,_e){const xe=c.get(_e).get(I);l.get(_e)!==xe&&(i.uniformBlockBinding(_e,xe,I.__bindingPointIndex),l.set(_e,xe))}function Xe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),u={},f={},ie=null,ne={},h={},p=new WeakMap,_=[],S=null,m=!1,d=null,b=null,w=null,M=null,y=null,E=null,R=null,x=new je(0,0,0),A=0,P=!1,D=null,F=null,B=null,N=null,G=null,nt.set(0,0,i.canvas.width,i.canvas.height),Ye.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:re,disable:V,bindFramebuffer:z,drawBuffers:ee,useProgram:pe,setBlending:J,setMaterial:he,setFlipSided:ae,setCullFace:le,setLineWidth:De,setPolygonOffset:Te,setScissorTest:Be,activeTexture:ze,bindTexture:C,unbindTexture:$e,compressedTexImage2D:qe,compressedTexImage3D:T,texImage2D:j,texImage3D:se,pixelStorei:Ue,getParameter:me,updateUBOMapping:Fe,uniformBlockBinding:Ge,texStorage2D:ue,texStorage3D:de,texSubImage2D:g,texSubImage3D:O,compressedTexSubImage2D:W,compressedTexSubImage3D:$,scissor:ve,viewport:ge,reset:Xe}}function _d(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new fe,u=new WeakMap,f=new Set;let h;const p=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(T,g){return _?new OffscreenCanvas(T,g):rr("canvas")}function m(T,g,O){let W=1;const $=qe(T);if(($.width>O||$.height>O)&&(W=O/Math.max($.width,$.height)),W<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const ue=Math.floor(W*$.width),de=Math.floor(W*$.height);h===void 0&&(h=S(ue,de));const j=g?S(ue,de):h;return j.width=ue,j.height=de,j.getContext("2d").drawImage(T,0,0,ue,de),He("WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+ue+"x"+de+")."),j}else return"data"in T&&He("WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),T;return T}function d(T){return T.generateMipmaps}function b(T){i.generateMipmap(T)}function w(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function M(T,g,O,W,$,ue=!1){if(T!==null){if(i[T]!==void 0)return i[T];He("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let de;W&&(de=e.get("EXT_texture_norm16"),de||He("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=g;if(g===i.RED&&(O===i.FLOAT&&(j=i.R32F),O===i.HALF_FLOAT&&(j=i.R16F),O===i.UNSIGNED_BYTE&&(j=i.R8),O===i.UNSIGNED_SHORT&&de&&(j=de.R16_EXT),O===i.SHORT&&de&&(j=de.R16_SNORM_EXT)),g===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(j=i.R8UI),O===i.UNSIGNED_SHORT&&(j=i.R16UI),O===i.UNSIGNED_INT&&(j=i.R32UI),O===i.BYTE&&(j=i.R8I),O===i.SHORT&&(j=i.R16I),O===i.INT&&(j=i.R32I)),g===i.RG&&(O===i.FLOAT&&(j=i.RG32F),O===i.HALF_FLOAT&&(j=i.RG16F),O===i.UNSIGNED_BYTE&&(j=i.RG8),O===i.UNSIGNED_SHORT&&de&&(j=de.RG16_EXT),O===i.SHORT&&de&&(j=de.RG16_SNORM_EXT)),g===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(j=i.RG8UI),O===i.UNSIGNED_SHORT&&(j=i.RG16UI),O===i.UNSIGNED_INT&&(j=i.RG32UI),O===i.BYTE&&(j=i.RG8I),O===i.SHORT&&(j=i.RG16I),O===i.INT&&(j=i.RG32I)),g===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(j=i.RGB8UI),O===i.UNSIGNED_SHORT&&(j=i.RGB16UI),O===i.UNSIGNED_INT&&(j=i.RGB32UI),O===i.BYTE&&(j=i.RGB8I),O===i.SHORT&&(j=i.RGB16I),O===i.INT&&(j=i.RGB32I)),g===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),O===i.UNSIGNED_INT&&(j=i.RGBA32UI),O===i.BYTE&&(j=i.RGBA8I),O===i.SHORT&&(j=i.RGBA16I),O===i.INT&&(j=i.RGBA32I)),g===i.RGB&&(O===i.UNSIGNED_SHORT&&de&&(j=de.RGB16_EXT),O===i.SHORT&&de&&(j=de.RGB16_SNORM_EXT),O===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),O===i.UNSIGNED_INT_10F_11F_11F_REV&&(j=i.R11F_G11F_B10F)),g===i.RGBA){const se=ue?ir:tt.getTransfer($);O===i.FLOAT&&(j=i.RGBA32F),O===i.HALF_FLOAT&&(j=i.RGBA16F),O===i.UNSIGNED_BYTE&&(j=se===ot?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT&&de&&(j=de.RGBA16_EXT),O===i.SHORT&&de&&(j=de.RGBA16_SNORM_EXT),O===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function y(T,g){let O;return T?g===null||g===1014||g===1020?O=i.DEPTH24_STENCIL8:g===1015?O=i.DEPTH32F_STENCIL8:g===1012&&(O=i.DEPTH24_STENCIL8,He("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===1014||g===1020?O=i.DEPTH_COMPONENT24:g===1015?O=i.DEPTH_COMPONENT32F:g===1012&&(O=i.DEPTH_COMPONENT16),O}function E(T,g){return d(T)===!0||T.isFramebufferTexture&&T.minFilter!==1003&&T.minFilter!==1006?Math.log2(Math.max(g.width,g.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?g.mipmaps.length:1}function R(T){const g=T.target;g.removeEventListener("dispose",R),A(g),g.isVideoTexture&&u.delete(g),g.isHTMLTexture&&f.delete(g)}function x(T){const g=T.target;g.removeEventListener("dispose",x),D(g)}function A(T){const g=n.get(T);if(g.__webglInit===void 0)return;const O=T.source,W=p.get(O);if(W){const $=W[g.__cacheKey];$.usedTimes--,$.usedTimes===0&&P(T),Object.keys(W).length===0&&p.delete(O)}n.remove(T)}function P(T){const g=n.get(T);i.deleteTexture(g.__webglTexture);const O=T.source,W=p.get(O);delete W[g.__cacheKey],a.memory.textures--}function D(T){const g=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(g.__webglFramebuffer[W]))for(let $=0;$<g.__webglFramebuffer[W].length;$++)i.deleteFramebuffer(g.__webglFramebuffer[W][$]);else i.deleteFramebuffer(g.__webglFramebuffer[W]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[W])}else{if(Array.isArray(g.__webglFramebuffer))for(let W=0;W<g.__webglFramebuffer.length;W++)i.deleteFramebuffer(g.__webglFramebuffer[W]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let W=0;W<g.__webglColorRenderbuffer.length;W++)g.__webglColorRenderbuffer[W]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[W]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const O=T.textures;for(let W=0,$=O.length;W<$;W++){const ue=n.get(O[W]);ue.__webglTexture&&(i.deleteTexture(ue.__webglTexture),a.memory.textures--),n.remove(O[W])}n.remove(T)}let F=0;function B(){F=0}function N(){return F}function G(T){F=T}function Q(){const T=F;return T>=r.maxTextures&&He("WebGLTextures: Trying to use "+(T+1)+" texture units while this GPU supports only "+r.maxTextures),F+=1,T}function X(T){const g=[];return g.push(T.wrapS),g.push(T.wrapT),g.push(T.wrapR||0),g.push(T.magFilter),g.push(T.minFilter),g.push(T.anisotropy),g.push(T.internalFormat),g.push(T.format),g.push(T.type),g.push(T.generateMipmaps),g.push(T.premultiplyAlpha),g.push(T.flipY),g.push(T.unpackAlignment),g.push(T.colorSpace),g.join()}function oe(T,g){const O=n.get(T);if(T.isVideoTexture&&C(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&O.__version!==T.version){const W=T.image;if(W===null)He("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)He("WebGLRenderer: Texture marked for update but image is incomplete");else{V(O,T,g);return}}else T.isExternalTexture&&(O.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+g)}function Y(T,g){const O=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&O.__version!==T.version){V(O,T,g);return}else T.isExternalTexture&&(O.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+g)}function ie(T,g){const O=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&O.__version!==T.version){V(O,T,g);return}t.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+g)}function ne(T,g){const O=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&O.__version!==T.version){z(O,T,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+g)}const Le={1e3:i.REPEAT,1001:i.CLAMP_TO_EDGE,1002:i.MIRRORED_REPEAT},be={1003:i.NEAREST,1004:i.NEAREST_MIPMAP_NEAREST,1005:i.NEAREST_MIPMAP_LINEAR,1006:i.LINEAR,1007:i.LINEAR_MIPMAP_NEAREST,1008:i.LINEAR_MIPMAP_LINEAR},nt={512:i.NEVER,519:i.ALWAYS,513:i.LESS,515:i.LEQUAL,514:i.EQUAL,518:i.GEQUAL,516:i.GREATER,517:i.NOTEQUAL};function Ye(T,g){if(g.type===1015&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===1006||g.magFilter===1007||g.magFilter===1005||g.magFilter===1008||g.minFilter===1006||g.minFilter===1007||g.minFilter===1005||g.minFilter===1008)&&He("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,Le[g.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,Le[g.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,Le[g.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,be[g.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,be[g.minFilter]),g.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,nt[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===1003||g.minFilter!==1005&&g.minFilter!==1008||g.type===1015&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function et(T,g){let O=!1;T.__webglInit===void 0&&(T.__webglInit=!0,g.addEventListener("dispose",R));const W=g.source;let $=p.get(W);$===void 0&&($={},p.set(W,$));const ue=X(g);if(ue!==T.__cacheKey){$[ue]===void 0&&($[ue]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,O=!0),$[ue].usedTimes++;const de=$[T.__cacheKey];de!==void 0&&($[T.__cacheKey].usedTimes--,de.usedTimes===0&&P(g)),T.__cacheKey=ue,T.__webglTexture=$[ue].texture}return O}function K(T,g,O){return Math.floor(Math.floor(T/O)/g)}function re(T,g,O,W){const ue=T.updateRanges;if(ue.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,O,W,g.data);else{ue.sort((Ue,ve)=>Ue.start-ve.start);let de=0;for(let Ue=1;Ue<ue.length;Ue++){const ve=ue[de],ge=ue[Ue],Fe=ve.start+ve.count,Ge=K(ge.start,g.width,4),Xe=K(ve.start,g.width,4);ge.start<=Fe+1&&Ge===Xe&&K(ge.start+ge.count-1,g.width,4)===Ge?ve.count=Math.max(ve.count,ge.start+ge.count-ve.start):(++de,ue[de]=ge)}ue.length=de+1;const j=t.getParameter(i.UNPACK_ROW_LENGTH),se=t.getParameter(i.UNPACK_SKIP_PIXELS),me=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let Ue=0,ve=ue.length;Ue<ve;Ue++){const ge=ue[Ue],Fe=Math.floor(ge.start/4),Ge=Math.ceil(ge.count/4),Xe=Fe%g.width,I=Math.floor(Fe/g.width),_e=Ge,te=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Xe),t.pixelStorei(i.UNPACK_SKIP_ROWS,I),t.texSubImage2D(i.TEXTURE_2D,0,Xe,I,_e,te,O,W,g.data)}T.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,j),t.pixelStorei(i.UNPACK_SKIP_PIXELS,se),t.pixelStorei(i.UNPACK_SKIP_ROWS,me)}}function V(T,g,O){let W=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(W=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(W=i.TEXTURE_3D);const $=et(T,g),ue=g.source;t.bindTexture(W,T.__webglTexture,i.TEXTURE0+O);const de=n.get(ue);if(ue.version!==de.__version||$===!0){if(t.activeTexture(i.TEXTURE0+O),(typeof ImageBitmap<"u"&&g.image instanceof ImageBitmap)===!1){const te=tt.getPrimaries(tt.workingColorSpace),xe=g.colorSpace===""?null:tt.getPrimaries(g.colorSpace),Ee=g.colorSpace===""||te===xe?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee)}t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment);let se=m(g.image,!1,r.maxTextureSize);se=$e(g,se);const me=s.convert(g.format,g.colorSpace),Ue=s.convert(g.type);let ve=M(g.internalFormat,me,Ue,g.normalized,g.colorSpace,g.isVideoTexture);Ye(W,g);let ge;const Fe=g.mipmaps,Ge=g.isVideoTexture!==!0,Xe=de.__version===void 0||$===!0,I=ue.dataReady,_e=E(g,se);if(g.isDepthTexture)ve=y(g.format===1027,g.type),Xe&&(Ge?t.texStorage2D(i.TEXTURE_2D,1,ve,se.width,se.height):t.texImage2D(i.TEXTURE_2D,0,ve,se.width,se.height,0,me,Ue,null));else if(g.isDataTexture)if(Fe.length>0){Ge&&Xe&&t.texStorage2D(i.TEXTURE_2D,_e,ve,Fe[0].width,Fe[0].height);for(let te=0,xe=Fe.length;te<xe;te++)ge=Fe[te],Ge?I&&t.texSubImage2D(i.TEXTURE_2D,te,0,0,ge.width,ge.height,me,Ue,ge.data):t.texImage2D(i.TEXTURE_2D,te,ve,ge.width,ge.height,0,me,Ue,ge.data);g.generateMipmaps=!1}else Ge?(Xe&&t.texStorage2D(i.TEXTURE_2D,_e,ve,se.width,se.height),I&&re(g,se,me,Ue)):t.texImage2D(i.TEXTURE_2D,0,ve,se.width,se.height,0,me,Ue,se.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Ge&&Xe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,_e,ve,Fe[0].width,Fe[0].height,se.depth);for(let te=0,xe=Fe.length;te<xe;te++)if(ge=Fe[te],g.format!==1023)if(me!==null)if(Ge){if(I)if(g.layerUpdates.size>0){const Ee=Zs(ge.width,ge.height,g.format,g.type);for(const ce of g.layerUpdates){const Oe=ge.data.subarray(ce*Ee/ge.data.BYTES_PER_ELEMENT,(ce+1)*Ee/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,te,0,0,ce,ge.width,ge.height,1,me,Oe)}}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,te,0,0,0,ge.width,ge.height,se.depth,me,ge.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,te,ve,ge.width,ge.height,se.depth,0,ge.data,0,0);else He("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ge?I&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,te,0,0,0,ge.width,ge.height,se.depth,me,Ue,ge.data):t.texImage3D(i.TEXTURE_2D_ARRAY,te,ve,ge.width,ge.height,se.depth,0,me,Ue,ge.data);g.layerUpdates.size>0&&g.clearLayerUpdates()}else{Ge&&Xe&&t.texStorage2D(i.TEXTURE_2D,_e,ve,Fe[0].width,Fe[0].height);for(let te=0,xe=Fe.length;te<xe;te++)ge=Fe[te],g.format!==1023?me!==null?Ge?I&&t.compressedTexSubImage2D(i.TEXTURE_2D,te,0,0,ge.width,ge.height,me,ge.data):t.compressedTexImage2D(i.TEXTURE_2D,te,ve,ge.width,ge.height,0,ge.data):He("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ge?I&&t.texSubImage2D(i.TEXTURE_2D,te,0,0,ge.width,ge.height,me,Ue,ge.data):t.texImage2D(i.TEXTURE_2D,te,ve,ge.width,ge.height,0,me,Ue,ge.data)}else if(g.isDataArrayTexture)if(Ge){if(Xe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,_e,ve,se.width,se.height,se.depth),I)if(g.layerUpdates.size>0){const te=Zs(se.width,se.height,g.format,g.type);for(const xe of g.layerUpdates){const Ee=se.data.subarray(xe*te/se.data.BYTES_PER_ELEMENT,(xe+1)*te/se.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,xe,se.width,se.height,1,me,Ue,Ee)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,se.width,se.height,se.depth,me,Ue,se.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ve,se.width,se.height,se.depth,0,me,Ue,se.data);else if(g.isData3DTexture)Ge?(Xe&&t.texStorage3D(i.TEXTURE_3D,_e,ve,se.width,se.height,se.depth),I&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,se.width,se.height,se.depth,me,Ue,se.data)):t.texImage3D(i.TEXTURE_3D,0,ve,se.width,se.height,se.depth,0,me,Ue,se.data);else if(g.isFramebufferTexture){if(Xe)if(Ge)t.texStorage2D(i.TEXTURE_2D,_e,ve,se.width,se.height);else{let te=se.width,xe=se.height;for(let Ee=0;Ee<_e;Ee++)t.texImage2D(i.TEXTURE_2D,Ee,ve,te,xe,0,me,Ue,null),te>>=1,xe>>=1}}else if(g.isHTMLTexture){if("texElementImage2D"in i){const te=i.canvas;if(te.hasAttribute("layoutsubtree")||te.setAttribute("layoutsubtree","true"),se.parentNode!==te){te.appendChild(se),f.add(g),te.onpaint=xe=>{const Ee=xe.changedElements;for(const ce of f)Ee.includes(ce.image)&&(ce.needsUpdate=!0)},te.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,se);else{const Ee=i.RGBA,ce=i.RGBA,Oe=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,Ee,ce,Oe,se)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Fe.length>0){if(Ge&&Xe){const te=qe(Fe[0]);t.texStorage2D(i.TEXTURE_2D,_e,ve,te.width,te.height)}for(let te=0,xe=Fe.length;te<xe;te++)ge=Fe[te],Ge?I&&t.texSubImage2D(i.TEXTURE_2D,te,0,0,me,Ue,ge):t.texImage2D(i.TEXTURE_2D,te,ve,me,Ue,ge);g.generateMipmaps=!1}else if(Ge){if(Xe){const te=qe(se);t.texStorage2D(i.TEXTURE_2D,_e,ve,te.width,te.height)}I&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,me,Ue,se)}else t.texImage2D(i.TEXTURE_2D,0,ve,me,Ue,se);d(g)&&b(W),de.__version=ue.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function z(T,g,O){if(g.image.length!==6)return;const W=et(T,g),$=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+O);const ue=n.get($);if($.version!==ue.__version||W===!0){t.activeTexture(i.TEXTURE0+O);const de=tt.getPrimaries(tt.workingColorSpace),j=g.colorSpace===""?null:tt.getPrimaries(g.colorSpace),se=g.colorSpace===""||de===j?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,se);const me=g.isCompressedTexture||g.image[0].isCompressedTexture,Ue=g.image[0]&&g.image[0].isDataTexture,ve=[];for(let ce=0;ce<6;ce++)!me&&!Ue?ve[ce]=m(g.image[ce],!0,r.maxCubemapSize):ve[ce]=Ue?g.image[ce].image:g.image[ce],ve[ce]=$e(g,ve[ce]);const ge=ve[0],Fe=s.convert(g.format,g.colorSpace),Ge=s.convert(g.type),Xe=M(g.internalFormat,Fe,Ge,g.normalized,g.colorSpace),I=g.isVideoTexture!==!0,_e=ue.__version===void 0||W===!0,te=$.dataReady;let xe=E(g,ge);Ye(i.TEXTURE_CUBE_MAP,g);let Ee;if(me){I&&_e&&t.texStorage2D(i.TEXTURE_CUBE_MAP,xe,Xe,ge.width,ge.height);for(let ce=0;ce<6;ce++){Ee=ve[ce].mipmaps;for(let Oe=0;Oe<Ee.length;Oe++){const Ie=Ee[Oe];g.format!==1023?Fe!==null?I?te&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe,0,0,Ie.width,Ie.height,Fe,Ie.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe,Xe,Ie.width,Ie.height,0,Ie.data):He("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe,0,0,Ie.width,Ie.height,Fe,Ge,Ie.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe,Xe,Ie.width,Ie.height,0,Fe,Ge,Ie.data)}}}else{if(Ee=g.mipmaps,I&&_e){Ee.length>0&&xe++;const ce=qe(ve[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,xe,Xe,ce.width,ce.height)}for(let ce=0;ce<6;ce++)if(Ue){I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,0,0,ve[ce].width,ve[ce].height,Fe,Ge,ve[ce].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,Xe,ve[ce].width,ve[ce].height,0,Fe,Ge,ve[ce].data);for(let Oe=0;Oe<Ee.length;Oe++){const ut=Ee[Oe].image[ce].image;I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe+1,0,0,ut.width,ut.height,Fe,Ge,ut.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe+1,Xe,ut.width,ut.height,0,Fe,Ge,ut.data)}}else{I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,0,0,Fe,Ge,ve[ce]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,Xe,Fe,Ge,ve[ce]);for(let Oe=0;Oe<Ee.length;Oe++){const Ie=Ee[Oe];I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe+1,0,0,Fe,Ge,Ie.image[ce]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe+1,Xe,Fe,Ge,Ie.image[ce])}}}d(g)&&b(i.TEXTURE_CUBE_MAP),ue.__version=$.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function ee(T,g,O,W,$,ue){const de=s.convert(O.format,O.colorSpace),j=s.convert(O.type),se=M(O.internalFormat,de,j,O.normalized,O.colorSpace),me=n.get(g),Ue=n.get(O);if(Ue.__renderTarget=g,!me.__hasExternalTextures){const ve=Math.max(1,g.width>>ue),ge=Math.max(1,g.height>>ue);$===i.TEXTURE_3D||$===i.TEXTURE_2D_ARRAY?t.texImage3D($,ue,se,ve,ge,g.depth,0,de,j,null):t.texImage2D($,ue,se,ve,ge,0,de,j,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),ze(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,W,$,Ue.__webglTexture,0,Be(g)):($===i.TEXTURE_2D||$>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,W,$,Ue.__webglTexture,ue),t.bindFramebuffer(i.FRAMEBUFFER,null)}function pe(T,g,O){if(i.bindRenderbuffer(i.RENDERBUFFER,T),g.depthBuffer){const W=g.depthTexture,$=W&&W.isDepthTexture?W.type:null,ue=y(g.stencilBuffer,$),de=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;ze(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Be(g),ue,g.width,g.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,Be(g),ue,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ue,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,de,i.RENDERBUFFER,T)}else{const W=g.textures;for(let $=0;$<W.length;$++){const ue=W[$],de=s.convert(ue.format,ue.colorSpace),j=s.convert(ue.type),se=M(ue.internalFormat,de,j,ue.normalized,ue.colorSpace);ze(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Be(g),se,g.width,g.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,Be(g),se,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,se,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ke(T,g,O){const W=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const $=n.get(g.depthTexture);if($.__renderTarget=g,(!$.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),W){if($.__webglInit===void 0&&($.__webglInit=!0,g.depthTexture.addEventListener("dispose",R)),$.__webglTexture===void 0){$.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,$.__webglTexture),Ye(i.TEXTURE_CUBE_MAP,g.depthTexture);const me=s.convert(g.depthTexture.format),Ue=s.convert(g.depthTexture.type);let ve;g.depthTexture.format===1026?ve=i.DEPTH_COMPONENT24:g.depthTexture.format===1027&&(ve=i.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,ve,g.width,g.height,0,me,Ue,null)}}else oe(g.depthTexture,0);const ue=$.__webglTexture,de=Be(g),j=W?i.TEXTURE_CUBE_MAP_POSITIVE_X+O:i.TEXTURE_2D,se=g.depthTexture.format===1027?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===1026)ze(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,se,j,ue,0,de):i.framebufferTexture2D(i.FRAMEBUFFER,se,j,ue,0);else if(g.depthTexture.format===1027)ze(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,se,j,ue,0,de):i.framebufferTexture2D(i.FRAMEBUFFER,se,j,ue,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Z(T){const g=n.get(T),O=T.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==T.depthTexture){const W=T.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),W){const $=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,W.removeEventListener("dispose",$)};W.addEventListener("dispose",$),g.__depthDisposeCallback=$}g.__boundDepthTexture=W}if(T.depthTexture&&!g.__autoAllocateDepthBuffer)if(O)for(let W=0;W<6;W++)ke(g.__webglFramebuffer[W],T,W);else{const W=T.texture.mipmaps;W&&W.length>0?ke(g.__webglFramebuffer[0],T,0):ke(g.__webglFramebuffer,T,0)}else if(O){g.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[W]),g.__webglDepthbuffer[W]===void 0)g.__webglDepthbuffer[W]=i.createRenderbuffer(),pe(g.__webglDepthbuffer[W],T,!1);else{const $=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ue=g.__webglDepthbuffer[W];i.bindRenderbuffer(i.RENDERBUFFER,ue),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,ue)}}else{const W=T.texture.mipmaps;if(W&&W.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),pe(g.__webglDepthbuffer,T,!1);else{const $=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ue=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ue),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,ue)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function J(T,g,O){const W=n.get(T);g!==void 0&&ee(W.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&Z(T)}function he(T){const g=T.texture,O=n.get(T),W=n.get(g);T.addEventListener("dispose",x);const $=T.textures,ue=T.isWebGLCubeRenderTarget===!0,de=$.length>1;if(de||(W.__webglTexture===void 0&&(W.__webglTexture=i.createTexture()),W.__version=g.version,a.memory.textures++),ue){O.__webglFramebuffer=[];for(let j=0;j<6;j++)if(g.mipmaps&&g.mipmaps.length>0){O.__webglFramebuffer[j]=[];for(let se=0;se<g.mipmaps.length;se++)O.__webglFramebuffer[j][se]=i.createFramebuffer()}else O.__webglFramebuffer[j]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){O.__webglFramebuffer=[];for(let j=0;j<g.mipmaps.length;j++)O.__webglFramebuffer[j]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(de)for(let j=0,se=$.length;j<se;j++){const me=n.get($[j]);me.__webglTexture===void 0&&(me.__webglTexture=i.createTexture(),a.memory.textures++)}if(T.samples>0&&ze(T)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let j=0;j<$.length;j++){const se=$[j];O.__webglColorRenderbuffer[j]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[j]);const me=s.convert(se.format,se.colorSpace),Ue=s.convert(se.type),ve=M(se.internalFormat,me,Ue,se.normalized,se.colorSpace,T.isXRRenderTarget===!0),ge=Be(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,ge,ve,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+j,i.RENDERBUFFER,O.__webglColorRenderbuffer[j])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),pe(O.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ue){t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture),Ye(i.TEXTURE_CUBE_MAP,g);for(let j=0;j<6;j++)if(g.mipmaps&&g.mipmaps.length>0)for(let se=0;se<g.mipmaps.length;se++)ee(O.__webglFramebuffer[j][se],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,se);else ee(O.__webglFramebuffer[j],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);d(g)&&b(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(de){for(let j=0,se=$.length;j<se;j++){const me=$[j],Ue=n.get(me);let ve=i.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ve=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ve,Ue.__webglTexture),Ye(ve,me),ee(O.__webglFramebuffer,T,me,i.COLOR_ATTACHMENT0+j,ve,0),d(me)&&b(ve)}t.unbindTexture()}else{let j=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(j=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(j,W.__webglTexture),Ye(j,g),g.mipmaps&&g.mipmaps.length>0)for(let se=0;se<g.mipmaps.length;se++)ee(O.__webglFramebuffer[se],T,g,i.COLOR_ATTACHMENT0,j,se);else ee(O.__webglFramebuffer,T,g,i.COLOR_ATTACHMENT0,j,0);d(g)&&b(j),t.unbindTexture()}T.depthBuffer&&Z(T)}function ae(T){const g=T.textures;for(let O=0,W=g.length;O<W;O++){const $=g[O];if(d($)){const ue=w(T),de=n.get($).__webglTexture;t.bindTexture(ue,de),b(ue),t.unbindTexture()}}}const le=[],De=[];function Te(T){if(T.samples>0){if(ze(T)===!1){const g=T.textures,O=T.width,W=T.height;let $=i.COLOR_BUFFER_BIT;const ue=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,de=n.get(T),j=g.length>1;if(j)for(let me=0;me<g.length;me++)t.bindFramebuffer(i.FRAMEBUFFER,de.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,de.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,de.__webglMultisampledFramebuffer);const se=T.texture.mipmaps;se&&se.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,de.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,de.__webglFramebuffer);for(let me=0;me<g.length;me++){if(T.resolveDepthBuffer&&(T.depthBuffer&&($|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&($|=i.STENCIL_BUFFER_BIT)),j){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,de.__webglColorRenderbuffer[me]);const Ue=n.get(g[me]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ue,0)}i.blitFramebuffer(0,0,O,W,0,0,O,W,$,i.NEAREST),l===!0&&(le.length=0,De.length=0,le.push(i.COLOR_ATTACHMENT0+me),T.depthBuffer&&T.storeMultisampledDepthBuffer===!1&&(le.push(ue),De.push(ue),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,De)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,le))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),j)for(let me=0;me<g.length;me++){t.bindFramebuffer(i.FRAMEBUFFER,de.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.RENDERBUFFER,de.__webglColorRenderbuffer[me]);const Ue=n.get(g[me]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,de.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.TEXTURE_2D,Ue,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,de.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.storeMultisampledDepthBuffer===!1&&l){const g=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function Be(T){return Math.min(r.maxSamples,T.samples)}function ze(T){const g=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function C(T){const g=a.render.frame;u.get(T)!==g&&(u.set(T,g),T.update())}function $e(T,g){const O=T.colorSpace,W=T.format,$=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||O!==nr&&O!==""&&(tt.getTransfer(O)===ot?(W!==1023||$!==1009)&&He("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):rt("WebGLTextures: Unsupported texture color space:",O)),g}function qe(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=Q,this.resetTextureUnits=B,this.getTextureUnits=N,this.setTextureUnits=G,this.setTexture2D=oe,this.setTexture2DArray=Y,this.setTexture3D=ie,this.setTextureCube=ne,this.rebindTextures=J,this.setupRenderTarget=he,this.updateRenderTargetMipmap=ae,this.updateMultisampleRenderTarget=Te,this.setupDepthRenderbuffer=Z,this.setupFrameBufferTexture=ee,this.useMultisampledRTT=ze,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function xd(i,e){function t(n,r=""){let s;const a=tt.getTransfer(r);if(n===1009)return i.UNSIGNED_BYTE;if(n===1017)return i.UNSIGNED_SHORT_4_4_4_4;if(n===1018)return i.UNSIGNED_SHORT_5_5_5_1;if(n===35902)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===35899)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===1010)return i.BYTE;if(n===1011)return i.SHORT;if(n===1012)return i.UNSIGNED_SHORT;if(n===1013)return i.INT;if(n===1014)return i.UNSIGNED_INT;if(n===1015)return i.FLOAT;if(n===1016)return i.HALF_FLOAT;if(n===1021)return i.ALPHA;if(n===1022)return i.RGB;if(n===1023)return i.RGBA;if(n===1026)return i.DEPTH_COMPONENT;if(n===1027)return i.DEPTH_STENCIL;if(n===1028)return i.RED;if(n===1029)return i.RED_INTEGER;if(n===1030)return i.RG;if(n===1031)return i.RG_INTEGER;if(n===1033)return i.RGBA_INTEGER;if(n===33776||n===33777||n===33778||n===33779)if(a===ot)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===33776)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===33777)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===33778)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===33779)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===33776)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===33777)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===33778)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===33779)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===35840||n===35841||n===35842||n===35843)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===35840)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===35841)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===35842)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===35843)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===36196||n===37492||n===37496||n===37488||n===37489||n===37490||n===37491)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===36196||n===37492)return a===ot?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===37496)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===37488)return s.COMPRESSED_R11_EAC;if(n===37489)return s.COMPRESSED_SIGNED_R11_EAC;if(n===37490)return s.COMPRESSED_RG11_EAC;if(n===37491)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===37808||n===37809||n===37810||n===37811||n===37812||n===37813||n===37814||n===37815||n===37816||n===37817||n===37818||n===37819||n===37820||n===37821)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===37808)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===37809)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===37810)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===37811)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===37812)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===37813)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===37814)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===37815)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===37816)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===37817)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===37818)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===37819)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===37820)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===37821)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===36492||n===36494||n===36495)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===36492)return a===ot?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===36494)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===36495)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===36283||n===36284||n===36285||n===36286)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===36283)return s.COMPRESSED_RED_RGTC1_EXT;if(n===36284)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===36285)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===36286)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===1020?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const vd=`
void main() {
...
}`;class Sd{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new Ra(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new en({vertexShader:vd,fragmentShader:Md,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new xt(new Ri(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class yd extends Pn{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,f=null,h=null,p=null,_=null;const S=typeof XRWebGLBinding<"u",m=new Sd,d={},b=t.getContextAttributes();let w=null,M=null;const y=[],E=[],R=new fe;let x=null,A=null;const P=new Gt;P.viewport=new pt;const D=new Gt;D.viewport=new pt;const F=[P,D],B=new Cl;let N=null,G=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let re=y[K];return re===void 0&&(re=new xr,y[K]=re),re.getTargetRaySpace()},this.getControllerGrip=function(K){let re=y[K];return re===void 0&&(re=new xr,y[K]=re),re.getGripSpace()},this.getHand=function(K){let re=y[K];return re===void 0&&(re=new xr,y[K]=re),re.getHandSpace()};function Q(K){const re=E.indexOf(K.inputSource);if(re===-1)return;const V=y[re];V!==void 0&&(V.update(K.inputSource,K.frame,c||a),V.dispatchEvent({type:K.type,data:K.inputSource}))}function X(){r.removeEventListener("select",Q),r.removeEventListener("selectstart",Q),r.removeEventListener("selectend",Q),r.removeEventListener("squeeze",Q),r.removeEventListener("squeezestart",Q),r.removeEventListener("squeezeend",Q),r.removeEventListener("end",X),r.removeEventListener("inputsourceschange",oe);for(let K=0;K<y.length;K++){const re=E[K];re!==null&&(E[K]=null,y[K].disconnect(re))}N=null,G=null,m.reset();for(const K in d)delete d[K];if(e.setRenderTarget(w),p=null,h=null,f=null,r=null,M=null,et.stop(),n.isPresenting=!1,e.setPixelRatio(x),e.setSize(R.width,R.height,!1),A!==null){const K=A.camera;K.fov=A.fov,K.zoom=A.zoom,K.updateProjectionMatrix(),A=null}n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){s=K,n.isPresenting===!0&&He("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){o=K,n.isPresenting===!0&&He("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return f===null&&S&&(f=new XRWebGLBinding(r,t)),f},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(K){if(r=K,r!==null){if(w=e.getRenderTarget(),r.addEventListener("select",Q),r.addEventListener("selectstart",Q),r.addEventListener("selectend",Q),r.addEventListener("squeeze",Q),r.addEventListener("squeezestart",Q),r.addEventListener("squeezeend",Q),r.addEventListener("end",X),r.addEventListener("inputsourceschange",oe),b.xrCompatible!==!0&&await t.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(R),S&&"createProjectionLayer"in XRWebGLBinding.prototype){let V=null,z=null,ee=null;b.depth&&(ee=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,V=b.stencil?1027:1026,z=b.stencil?1020:1014);const pe={colorFormat:t.RGBA8,depthFormat:ee,scaleFactor:s};f=this.getBinding(),h=f.createProjectionLayer(pe),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),M=new qt(h.textureWidth,h.textureHeight,{format:1023,type:1009,depthTexture:new Si(h.textureWidth,h.textureHeight,z,void 0,void 0,void 0,void 0,void 0,void 0,V),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1,storeMultisampledDepthBuffer:h.ignoreDepthValues===!1,storeMultisampledStencilBuffer:h.ignoreDepthValues===!1})}else{const V={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,V),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),M=new qt(p.framebufferWidth,p.framebufferHeight,{format:1023,type:1009,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1,storeMultisampledDepthBuffer:p.ignoreDepthValues===!1,storeMultisampledStencilBuffer:p.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),et.setContext(r),et.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function oe(K){for(let re=0;re<K.removed.length;re++){const V=K.removed[re],z=E.indexOf(V);z>=0&&(E[z]=null,y[z].disconnect(V))}for(let re=0;re<K.added.length;re++){const V=K.added[re];let z=E.indexOf(V);if(z===-1){for(let pe=0;pe<y.length;pe++)if(pe>=E.length){E.push(V),z=pe;break}else if(E[pe]===null){E[pe]=V,z=pe;break}if(z===-1)break}const ee=y[z];ee&&ee.connect(V)}}const Y=new U,ie=new U;function ne(K,re,V){Y.setFromMatrixPosition(re.matrixWorld),ie.setFromMatrixPosition(V.matrixWorld);const z=Y.distanceTo(ie),ee=re.projectionMatrix.elements,pe=V.projectionMatrix.elements,ke=ee[14]/(ee[10]-1),Z=ee[14]/(ee[10]+1),J=(ee[9]+1)/ee[5],he=(ee[9]-1)/ee[5],ae=(ee[8]-1)/ee[0],le=(pe[8]+1)/pe[0],De=ke*ae,Te=ke*le,Be=z/(-ae+le),ze=Be*-ae;if(re.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(ze),K.translateZ(Be),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),ee[10]===-1)K.projectionMatrix.copy(re.projectionMatrix),K.projectionMatrixInverse.copy(re.projectionMatrixInverse);else{const C=ke+Be,$e=Z+Be,qe=De-ze,T=Te+(z-ze),g=J*Z/$e*C,O=he*Z/$e*C;K.projectionMatrix.makePerspective(qe,T,g,O,C,$e),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function Le(K,re){re===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(re.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(r===null)return;let re=K.near,V=K.far;m.texture!==null&&(m.depthNear>0&&(re=m.depthNear),m.depthFar>0&&(V=m.depthFar)),B.near=D.near=P.near=re,B.far=D.far=P.far=V,(N!==B.near||G!==B.far)&&(r.updateRenderState({depthNear:B.near,depthFar:B.far}),N=B.near,G=B.far),B.layers.mask=K.layers.mask|6,P.layers.mask=B.layers.mask&-5,D.layers.mask=B.layers.mask&-3;const z=K.parent,ee=B.cameras;Le(B,z);for(let pe=0;pe<ee.length;pe++)Le(ee[pe],z);ee.length===2?ne(B,P,D):B.projectionMatrix.copy(P.projectionMatrix),A===null&&K.isPerspectiveCamera&&(A={camera:K,fov:K.fov,zoom:K.zoom}),be(K,B,z)};function be(K,re,V){V===null?K.matrix.copy(re.matrixWorld):(K.matrix.copy(V.matrixWorld),K.matrix.invert(),K.matrix.multiply(re.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(re.projectionMatrix),K.projectionMatrixInverse.copy(re.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=Wr*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return B},this.getFoveation=function(){if(!(h===null&&p===null))return l},this.setFoveation=function(K){l=K,h!==null&&(h.fixedFoveation=K),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=K)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(B)},this.getCameraTexture=function(K){return d[K]};let nt=null;function Ye(K,re){if(u=re.getViewerPose(c||a),_=re,u!==null){const V=u.views;p!==null&&(e.setRenderTargetFramebuffer(M,p.framebuffer),e.setRenderTarget(M));let z=!1;V.length!==B.cameras.length&&(B.cameras.length=0,z=!0);for(let Z=0;Z<V.length;Z++){const J=V[Z];let he=null;if(p!==null)he=p.getViewport(J);else{const le=f.getViewSubImage(h,J);he=le.viewport,Z===0&&(e.setRenderTargetTextures(M,le.colorTexture,le.depthStencilTexture),e.setRenderTarget(M))}let ae=F[Z];ae===void 0&&(ae=new Gt,ae.layers.enable(Z),ae.viewport=new pt,F[Z]=ae),ae.matrix.fromArray(J.transform.matrix),ae.matrix.decompose(ae.position,ae.quaternion,ae.scale),ae.projectionMatrix.fromArray(J.projectionMatrix),ae.projectionMatrixInverse.copy(ae.projectionMatrix).invert(),ae.viewport.set(he.x,he.y,he.width,he.height),Z===0&&(B.matrix.copy(ae.matrix),B.matrix.decompose(B.position,B.quaternion,B.scale)),z===!0&&B.cameras.push(ae)}const ee=r.enabledFeatures;if(ee&&ee.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&S){f=n.getBinding();const Z=f.getDepthInformation(V[0]);Z&&Z.isValid&&Z.texture&&m.init(Z,r.renderState)}if(ee&&ee.includes("camera-access")&&S){e.state.unbindTexture(),f=n.getBinding();for(let Z=0;Z<V.length;Z++){const J=V[Z].camera;if(J){let he=d[J];he||(he=new Ra,d[J]=he);const ae=f.getCameraImage(J);he.sourceTexture=ae}}}}for(let V=0;V<y.length;V++){const z=E[V],ee=y[V];z!==null&&ee!==void 0&&ee.update(z,re,c||a)}nt&&nt(K,re),re.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:re}),_=null}const et=new Va;et.setAnimationLoop(Ye),this.setAnimationLoop=function(K){nt=K},this.dispose=function(){}}}const Ed=new ht,Za=new We;Za.set(-1,0,0,0,1,0,0,0,1);function Td(i,e){function t(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function n(m,d){d.color.getRGB(m.fogColor.value,Oa(i)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function r(m,d,b,w,M){d.isNodeMaterial?d.uniformsNeedUpdate=!1:d.isMeshBasicMaterial?s(m,d):d.isMeshLambertMaterial?(s(m,d),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)):d.isMeshToonMaterial?(s(m,d),f(m,d)):d.isMeshPhongMaterial?(s(m,d),u(m,d),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)):d.isMeshStandardMaterial?(s(m,d),h(m,d),d.isMeshPhysicalMaterial&&p(m,d,M)):d.isMeshMatcapMaterial?(s(m,d),_(m,d)):d.isMeshDepthMaterial?s(m,d):d.isMeshDistanceMaterial?(s(m,d),S(m,d)):d.isMeshNormalMaterial?s(m,d):d.isLineBasicMaterial?(a(m,d),d.isLineDashedMaterial&&o(m,d)):d.isPointsMaterial?l(m,d,b,w):d.isSpriteMaterial?c(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,t(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===1&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,t(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===1&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,t(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,t(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const b=e.get(d),w=b.envMap,M=b.envMapRotation;w&&(m.envMap.value=w,m.envMapRotation.value.setFromMatrix4(Ed.makeRotationFromEuler(M)).transpose(),w.isCubeTexture&&w.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(Za),m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,m.aoMapTransform))}function a(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform))}function o(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function l(m,d,b,w){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*b,m.scale.value=w*.5,d.map&&(m.map.value=d.map,t(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function c(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function u(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function f(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function h(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,b){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===1&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.retroreflectivity>0&&(m.retroreflectivity.value=d.retroreflectivity),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=b.texture,m.transmissionSamplerSize.value.set(b.width,b.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,d){d.matcap&&(m.matcap.value=d.matcap)}function S(m,d){const b=e.get(d).light;m.referencePosition.value.setFromMatrixPosition(b.matrixWorld),m.nearDistance.value=b.shadow.camera.near,m.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function bd(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(M,y){const E=y.program;n.uniformBlockBinding(M,E)}function c(M,y){let E=r[M.id];E===void 0&&(m(M),E=u(M),r[M.id]=E,M.addEventListener("dispose",b));const R=y.program;n.updateUBOMapping(M,R);const x=e.render.frame;s[M.id]!==x&&(h(M),s[M.id]=x)}function u(M){const y=f();M.__bindingPointIndex=y;const E=i.createBuffer(),R=M.__size,x=M.usage;return i.bindBuffer(i.UNIFORM_BUFFER,E),i.bufferData(i.UNIFORM_BUFFER,R,x),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,y,E),E}function f(){for(let M=0;M<o;M++)if(a.indexOf(M)===-1)return a.push(M),M;return rt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(M){const y=r[M.id],E=M.uniforms,R=M.__cache;i.bindBuffer(i.UNIFORM_BUFFER,y);for(let x=0,A=E.length;x<A;x++){const P=E[x];if(Array.isArray(P))for(let D=0,F=P.length;D<F;D++)p(P[D],x,D,R);else p(P,x,0,R)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(M,y,E,R){if(S(M,y,E,R)===!0){const x=M.__offset,A=M.value;if(Array.isArray(A)){let P=0;for(let D=0;D<A.length;D++){const F=A[D],B=d(F);_(F,M.__data,P),typeof F!="number"&&typeof F!="boolean"&&!F.isMatrix3&&!ArrayBuffer.isView(F)&&(P+=B.storage/Float32Array.BYTES_PER_ELEMENT)}}else _(A,M.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,x,M.__data)}}function _(M,y,E){typeof M=="number"||typeof M=="boolean"?y[0]=M:M.isMatrix3?(y[0]=M.elements[0],y[1]=M.elements[1],y[2]=M.elements[2],y[3]=0,y[4]=M.elements[3],y[5]=M.elements[4],y[6]=M.elements[5],y[7]=0,y[8]=M.elements[6],y[9]=M.elements[7],y[10]=M.elements[8],y[11]=0):ArrayBuffer.isView(M)?y.set(new M.constructor(M.buffer,M.byteOffset,y.length)):M.toArray(y,E)}function S(M,y,E,R){const x=M.value,A=y+"_"+E;if(R[A]===void 0)return typeof x=="number"||typeof x=="boolean"?R[A]=x:ArrayBuffer.isView(x)?R[A]=x.slice():R[A]=x.clone(),!0;{const P=R[A];if(typeof x=="number"||typeof x=="boolean"){if(P!==x)return R[A]=x,!0}else{if(ArrayBuffer.isView(x))return!0;if(P.equals(x)===!1)return P.copy(x),!0}}return!1}function m(M){const y=M.uniforms;let E=0;const R=16;for(let A=0,P=y.length;A<P;A++){const D=Array.isArray(y[A])?y[A]:[y[A]];for(let F=0,B=D.length;F<B;F++){const N=D[F],G=Array.isArray(N.value)?N.value:[N.value];for(let Q=0,X=G.length;Q<X;Q++){const oe=G[Q],Y=d(oe),ie=E%R,ne=ie%Y.boundary,Le=ie+ne;E+=ne,Le!==0&&R-Le<Y.storage&&(E+=R-Le),N.__data=new Float32Array(Y.storage/Float32Array.BYTES_PER_ELEMENT),N.__offset=E,E+=Y.storage}}}const x=E%R;return x>0&&(E+=R-x),M.__size=E,M.__cache={},this}function d(M){const y={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(y.boundary=4,y.storage=4):M.isVector2?(y.boundary=8,y.storage=8):M.isVector3||M.isColor?(y.boundary=16,y.storage=12):M.isVector4?(y.boundary=16,y.storage=16):M.isMatrix3?(y.boundary=48,y.storage=48):M.isMatrix4?(y.boundary=64,y.storage=64):M.isTexture?He("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(M)?(y.boundary=16,y.storage=M.byteLength):He("WebGLRenderer: Unsupported uniform value type.",M),y}function b(M){const y=M.target;y.removeEventListener("dispose",b);const E=a.indexOf(y.__bindingPointIndex);a.splice(E,1),i.deleteBuffer(r[y.id]),delete r[y.id],delete s[y.id]}function w(){for(const M in r)i.deleteBuffer(r[M]);a=[],r={},s={}}return{bind:l,update:c,dispose:w}}const Ad=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Kt=null;function Rd(){return Kt===null&&(Kt=new ba(Ad,16,16,1030,1016),Kt.name="DFG_LUT",Kt.minFilter=1006,Kt.magFilter=1006,Kt.wrapS=1001,Kt.wrapT=1001,Kt.generateMipmaps=!1,Kt.needsUpdate=!0),Kt}class wd{constructor(e={}){const{canvas:t=so(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:h=!1,outputBufferType:p=1009}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=a;const S=p,m=new Set([1033,1031,1029]),d=new Set([1009,1014,1012,1020,1017,1018]),b=new Uint32Array(4),w=new Int32Array(4),M=new U;let y=null,E=null;const R=[],x=[];let A=null;this.domElement=t,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const P=this;let D=!1,F=null,B=null,N=null,G=null;this._outputColorSpace=Bt;let Q=0,X=0,oe=null,Y=-1,ie=null;const ne=new pt,Le=new pt;let be=null;const nt=new je(0);let Ye=0,et=t.width,K=t.height,re=1,V=null,z=null;const ee=new pt(0,0,et,K),pe=new pt(0,0,et,K);let ke=!1;const Z=new jr;let J=!1,he=!1;const ae=new ht,le=new U,De=new pt,Te={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Be=!1;function ze(){return oe===null?re:1}let C=n;function $e(v,L){return t.getContext(v,L)}let qe,T,g,O,W,$,ue,de,j,se,me,Ue,ve,ge,Fe,Ge,Xe,I,_e,te,xe,Ee,ce;try{const v={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine","three.js r186"),t.addEventListener("webglcontextlost",ut,!1),t.addEventListener("webglcontextrestored",st,!1),t.addEventListener("webglcontextcreationerror",zt,!1),C===null){const L="webgl2";if(C=$e(L,v),C===null)throw $e(L)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}Oe()}catch(v){throw t.removeEventListener("webglcontextlost",ut,!1),t.removeEventListener("webglcontextrestored",st,!1),t.removeEventListener("webglcontextcreationerror",zt,!1),rt("WebGLRenderer: "+v.message),v}function Oe(){qe=new Au(C),qe.init(),xe=new xd(C,qe),T=new gu(C,qe,e,xe),g=new gd(C,qe),T.reversedDepthBuffer&&h&&g.buffers.depth.setReversed(!0),B=C.createFramebuffer(),N=C.createFramebuffer(),G=C.createFramebuffer(),O=new Cu(C),W=new nd,$=new _d(C,qe,g,W,T,xe,O),ue=new bu(P),de=new Ll(C),Ee=new pu(C,de),j=new Ru(C,de,O,Ee),se=new Lu(C,j,de,Ee,O),I=new Pu(C,T,$),Fe=new _u(W),me=new td(P,ue,qe,T,Ee,Fe),Ue=new Td(P,W),ve=new rd,ge=new hd(qe),Xe=new du(P,ue,g,se,_,l),Ge=new md(P,se,T),ce=new bd(C,O,T,g),_e=new mu(C,qe,O),te=new wu(C,qe,O),O.programs=me.programs,P.capabilities=T,P.extensions=qe,P.properties=W,P.renderLists=ve,P.shadowMap=Ge,P.state=g,P.info=O}S!==1009&&(A=new Iu(S,t.width,t.height,o,r,s));const Ie=new yd(P,C);this.xr=Ie,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){const v=qe.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=qe.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return re},this.setPixelRatio=function(v){v!==void 0&&(re=v,this.setSize(et,K,!1))},this.getSize=function(v){return v.set(et,K)},this.setSize=function(v,L,q=!0){if(Ie.isPresenting){He("WebGLRenderer: Can't change size while VR device is presenting.");return}et=v,K=L,t.width=Math.floor(v*re),t.height=Math.floor(L*re),q===!0&&(t.style.width=v+"px",t.style.height=L+"px"),A!==null&&A.setSize(t.width,t.height),this.setViewport(0,0,v,L)},this.getDrawingBufferSize=function(v){return v.set(et*re,K*re).floor()},this.setDrawingBufferSize=function(v,L,q){et=v,K=L,re=q,t.width=Math.floor(v*q),t.height=Math.floor(L*q),this.setViewport(0,0,v,L)},this.setEffects=function(v){if(S===1009){rt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(v){for(let L=0;L<v.length;L++)if(v[L].isOutputPass===!0){He("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}A.setEffects(v||[])},this.getCurrentViewport=function(v){return v.copy(ne)},this.getViewport=function(v){return v.copy(ee)},this.setViewport=function(v,L,q,H){v.isVector4?ee.set(v.x,v.y,v.z,v.w):ee.set(v,L,q,H),g.viewport(ne.copy(ee).multiplyScalar(re).round())},this.getScissor=function(v){return v.copy(pe)},this.setScissor=function(v,L,q,H){v.isVector4?pe.set(v.x,v.y,v.z,v.w):pe.set(v,L,q,H),g.scissor(Le.copy(pe).multiplyScalar(re).round())},this.getScissorTest=function(){return ke},this.setScissorTest=function(v){g.setScissorTest(ke=v)},this.setOpaqueSort=function(v){V=v},this.setTransparentSort=function(v){z=v},this.getClearColor=function(v){return v.copy(Xe.getClearColor())},this.setClearColor=function(){Xe.setClearColor(...arguments)},this.getClearAlpha=function(){return Xe.getClearAlpha()},this.setClearAlpha=function(){Xe.setClearAlpha(...arguments)},this.clear=function(v=!0,L=!0,q=!0){let H=0;if(v){let k=!1;if(oe!==null){const ye=oe.texture.format;k=m.has(ye)}if(k){const ye=oe.texture.type,we=d.has(ye),Se=Xe.getClearColor(),Ce=Xe.getClearAlpha(),Ne=Se.r,Ze=Se.g,Qe=Se.b;we?(b[0]=Ne,b[1]=Ze,b[2]=Qe,b[3]=Ce,C.clearBufferuiv(C.COLOR,0,b)):(w[0]=Ne,w[1]=Ze,w[2]=Qe,w[3]=Ce,C.clearBufferiv(C.COLOR,0,w))}else H|=C.COLOR_BUFFER_BIT}L&&(H|=C.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),q&&(H|=C.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),H!==0&&C.clear(H)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(v){v.setRenderer(this),F=v},this.dispose=function(){t.removeEventListener("webglcontextlost",ut,!1),t.removeEventListener("webglcontextrestored",st,!1),t.removeEventListener("webglcontextcreationerror",zt,!1),Xe.dispose(),ve.dispose(),ge.dispose(),W.dispose(),ue.dispose(),se.dispose(),Ee.dispose(),ce.dispose(),me.dispose(),Ie.dispose(),Ie.removeEventListener("sessionstart",os),Ie.removeEventListener("sessionend",ls),Mn.stop()};function ut(v){v.preventDefault(),xs("WebGLRenderer: Context Lost."),D=!0}function st(){xs("WebGLRenderer: Context Restored."),D=!1;const v=O.autoReset,L=Ge.enabled,q=Ge.autoUpdate,H=Ge.needsUpdate,k=Ge.type;Oe(),O.autoReset=v,Ge.enabled=L,Ge.autoUpdate=q,Ge.needsUpdate=H,Ge.type=k}function zt(v){rt("WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function Yt(v){const L=v.target;L.removeEventListener("dispose",Yt),$a(L)}function $a(v){Qa(v),W.remove(v)}function Qa(v){const L=W.get(v).programs;L!==void 0&&(L.forEach(function(q){me.releaseProgram(q)}),v.isShaderMaterial&&me.releaseShaderCache(v))}this.renderBufferDirect=function(v,L,q,H,k,ye){L===null&&(L=Te);const we=k.isMesh&&k.matrixWorld.determinantAffine()<0,Se=to(v,L,q,H,k);g.setMaterial(H,we);let Ce=q.index,Ne=1;if(H.wireframe===!0){if(Ce=j.getWireframeAttribute(q),Ce===void 0)return;Ne=2}const Ze=q.drawRange,Qe=q.attributes.position;let Pe=Ze.start*Ne,at=(Ze.start+Ze.count)*Ne;ye!==null&&(Pe=Math.max(Pe,ye.start*Ne),at=Math.min(at,(ye.start+ye.count)*Ne)),Ce!==null?(Pe=Math.max(Pe,0),at=Math.min(at,Ce.count)):Qe!=null&&(Pe=Math.max(Pe,0),at=Math.min(at,Qe.count));const vt=at-Pe;if(vt<0||vt===1/0)return;Ee.setup(k,H,Se,q,Ce);let dt,ct=_e;if(Ce!==null&&(dt=de.get(Ce),ct=te,ct.setIndex(dt)),k.isMesh)H.wireframe===!0?(g.setLineWidth(H.wireframeLinewidth*ze()),ct.setMode(C.LINES)):ct.setMode(C.TRIANGLES);else if(k.isLine){let At=H.linewidth;At===void 0&&(At=1),g.setLineWidth(At*ze()),k.isLineSegments?ct.setMode(C.LINES):k.isLineLoop?ct.setMode(C.LINE_LOOP):ct.setMode(C.LINE_STRIP)}else k.isPoints?ct.setMode(C.POINTS):k.isSprite&&ct.setMode(C.TRIANGLES);if(k.isBatchedMesh)if(qe.get("WEBGL_multi_draw"))ct.renderMultiDraw(k._multiDrawStarts,k._multiDrawCounts,k._multiDrawCount);else{const At=k._multiDrawStarts,Re=k._multiDrawCounts,Ct=k._multiDrawCount,it=Ce?de.get(Ce).bytesPerElement:1,Ft=W.get(H).currentProgram.getUniforms();for(let Zt=0;Zt<Ct;Zt++)Ft.setValue(C,"_gl_DrawID",Zt),ct.render(At[Zt]/it,Re[Zt])}else if(k.isInstancedMesh)ct.renderInstances(Pe,vt,k.count);else if(q.isInstancedBufferGeometry){const At=q._maxInstanceCount!==void 0?q._maxInstanceCount:1/0,Re=Math.min(q.instanceCount,At);ct.renderInstances(Pe,vt,Re)}else ct.render(Pe,vt)};function as(v,L,q,H){F!==null&&v.isNodeMaterial&&F.setObject(H,v),J===!0&&Fe.setState(v,q,!1),v.transparent===!0&&v.side===2&&v.forceSinglePass===!1?(v.side=1,v.needsUpdate=!0,Ci(v,L,H),v.side=0,v.needsUpdate=!0,Ci(v,L,H),v.side=2):Ci(v,L,H)}this.compile=function(v,L,q=null){q===null&&(q=v),F!==null&&F.renderStart(v,L,q),E=ge.get(q),E.init(L),x.push(E),q.traverseVisible(function(k){k.isLight&&k.layers.test(L.layers)&&(E.pushLight(k),k.castShadow&&E.pushShadow(k))}),v!==q&&v.traverseVisible(function(k){k.isLight&&k.layers.test(L.layers)&&(E.pushLight(k),k.castShadow&&E.pushShadow(k))}),E.setupLights(),F!==null&&F.updateLights(E.state.lightsArray),he=this.localClippingEnabled,J=Fe.init(this.clippingPlanes,he),J===!0&&Fe.setGlobalState(this.clippingPlanes,L),F!==null&&Ge.render(E.state.shadowsArray,q,L);const H=new Set;return v.traverse(function(k){if(!(k.isMesh||k.isPoints||k.isLine||k.isSprite))return;const ye=k.material;if(ye)if(Array.isArray(ye))for(let we=0;we<ye.length;we++){const Se=ye[we];as(Se,q,L,k),H.add(Se)}else as(ye,q,L,k),H.add(ye)}),E=x.pop(),F!==null&&F.renderEnd(),H},this.compileAsync=function(v,L,q=null){const H=this.compile(v,L,q);return new Promise(k=>{function ye(){if(H.forEach(function(we){const Ce=W.get(we).currentProgram;(Ce===void 0||Ce.isReady())&&H.delete(we)}),H.size===0){k(v);return}setTimeout(ye,10)}qe.get("KHR_parallel_shader_compile")!==null?ye():setTimeout(ye,10)})};let cr=null;function ja(v){cr&&cr(v)}function os(){Mn.stop()}function ls(){Mn.start()}const Mn=new Va;Mn.setAnimationLoop(ja),typeof self<"u"&&Mn.setContext(self),this.setAnimationLoop=function(v){cr=v,Ie.setAnimationLoop(v),v===null?Mn.stop():Mn.start()},Ie.addEventListener("sessionstart",os),Ie.addEventListener("sessionend",ls),this.render=function(v,L){if(L!==void 0&&L.isCamera!==!0){rt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;F!==null&&F.renderStart(v,L);const q=Ie.enabled===!0&&Ie.isPresenting===!0,H=A!==null&&(oe===null||q)&&A.begin(P,oe);if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),Ie.enabled===!0&&Ie.isPresenting===!0&&(A===null||A.isCompositing()===!1)&&(Ie.cameraAutoUpdate===!0&&Ie.updateCamera(L),L=Ie.getCamera()),v.isScene===!0&&v.onBeforeRender(P,v,L,oe),E=ge.get(v,x.length),E.init(L),E.state.textureUnits=$.getTextureUnits(),x.push(E),ae.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),Z.setFromProjectionMatrix(ae,2e3,L.reversedDepth),he=this.localClippingEnabled,J=Fe.init(this.clippingPlanes,he),y=ve.get(v,R.length),y.init(),R.push(y),Ie.enabled===!0&&Ie.isPresenting===!0){const we=P.xr.getDepthSensingMesh();we!==null&&hr(we,L,-1/0,P.sortObjects)}hr(v,L,0,P.sortObjects),y.finish(),F!==null&&F.updateLights(E.state.lightsArray),P.sortObjects===!0&&y.sort(V,z),Be=Ie.enabled===!1||Ie.isPresenting===!1||Ie.hasDepthSensing()===!1,Be&&Xe.addToRenderList(y,v),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),J===!0&&Fe.beginShadows();const k=E.state.shadowsArray;if(Ge.render(k,v,L),J===!0&&Fe.endShadows(),(H&&A.hasRenderPass())===!1){const we=y.opaque,Se=y.transmissive;if(E.setupLights(),L.isArrayCamera){const Ce=L.cameras;if(Se.length>0)for(let Ne=0,Ze=Ce.length;Ne<Ze;Ne++){const Qe=Ce[Ne];hs(we,Se,v,Qe)}Be&&Xe.render(v);for(let Ne=0,Ze=Ce.length;Ne<Ze;Ne++){const Qe=Ce[Ne];cs(y,v,Qe,Qe.viewport)}}else Se.length>0&&hs(we,Se,v,L),Be&&Xe.render(v),cs(y,v,L)}oe!==null&&X===0&&($.updateMultisampleRenderTarget(oe),$.updateRenderTargetMipmap(oe)),H&&A.end(P),v.isScene===!0&&v.onAfterRender(P,v,L),Ee.resetDefaultState(),Y=-1,ie=null,x.pop(),x.length>0?(E=x[x.length-1],$.setTextureUnits(E.state.textureUnits),J===!0&&Fe.setGlobalState(P.clippingPlanes,E.state.camera)):E=null,R.pop(),R.length>0?y=R[R.length-1]:y=null,F!==null&&F.renderEnd()};function hr(v,L,q,H){if(v.visible===!1)return;if(v.layers.test(L.layers)){if(v.isGroup)q=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(L);else if(v.isLightProbeGrid)E.pushLightProbeGrid(v);else if(v.isLight)E.pushLight(v),v.castShadow&&E.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||v.intersectsFrustum(Z)){H&&De.setFromMatrixPosition(v.matrixWorld).applyMatrix4(ae);const we=se.update(v),Se=v.material;Se.visible&&y.push(v,we,Se,q,De.z,null,L)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||v.intersectsFrustum(Z))){const we=se.update(v),Se=v.material;if(H&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),De.copy(v.boundingSphere.center)):(we.boundingSphere===null&&we.computeBoundingSphere(),De.copy(we.boundingSphere.center)),De.applyMatrix4(v.matrixWorld).applyMatrix4(ae)),Array.isArray(Se)){const Ce=we.groups;for(let Ne=0,Ze=Ce.length;Ne<Ze;Ne++){const Qe=Ce[Ne],Pe=Se[Qe.materialIndex];Pe&&Pe.visible&&y.push(v,we,Pe,q,De.z,Qe,L)}}else Se.visible&&y.push(v,we,Se,q,De.z,null,L)}}const ye=v.children;for(let we=0,Se=ye.length;we<Se;we++)hr(ye[we],L,q,H)}function cs(v,L,q,H){const{opaque:k,transmissive:ye,transparent:we}=v;E.setupLightsView(q),J===!0&&Fe.setGlobalState(P.clippingPlanes,q),H&&g.viewport(ne.copy(H)),k.length>0&&wi(k,L,q),ye.length>0&&wi(ye,L,q),we.length>0&&wi(we,L,q),g.buffers.depth.setTest(!0),g.buffers.depth.setMask(!0),g.buffers.color.setMask(!0),g.setPolygonOffset(!1)}function hs(v,L,q,H){if((q.isScene===!0?q.overrideMaterial:null)!==null)return;if(E.state.transmissionRenderTarget[H.id]===void 0){const Pe=qe.has("EXT_color_buffer_half_float")||qe.has("EXT_color_buffer_float");E.state.transmissionRenderTarget[H.id]=new qt(1,1,{generateMipmaps:!0,type:Pe?1016:1009,minFilter:1008,samples:Math.max(4,T.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:tt.workingColorSpace})}const ye=E.state.transmissionRenderTarget[H.id],we=H.viewport||ne;ye.setSize(we.z*P.transmissionResolutionScale,we.w*P.transmissionResolutionScale);const Se=P.getRenderTarget(),Ce=P.getActiveCubeFace(),Ne=P.getActiveMipmapLevel();P.setRenderTarget(ye),P.getClearColor(nt),Ye=P.getClearAlpha(),Ye<1&&P.setClearColor(16777215,.5),P.clear(),Be&&Xe.render(q);const Ze=P.toneMapping;P.toneMapping=0;const Qe=H.viewport;if(H.viewport!==void 0&&(H.viewport=void 0),E.setupLightsView(H),J===!0&&Fe.setGlobalState(P.clippingPlanes,H),wi(v,q,H),$.updateMultisampleRenderTarget(ye),$.updateRenderTargetMipmap(ye),qe.has("WEBGL_multisampled_render_to_texture")===!1){let Pe=!1;for(let at=0,vt=L.length;at<vt;at++){const dt=L[at],{object:ct,geometry:At,material:Re,group:Ct}=dt;if(Re.side===2&&ct.layers.test(H.layers)){const it=Re.side;Re.side=1,Re.needsUpdate=!0,us(ct,q,H,At,Re,Ct),Re.side=it,Re.needsUpdate=!0,Pe=!0}}Pe===!0&&($.updateMultisampleRenderTarget(ye),$.updateRenderTargetMipmap(ye))}P.setRenderTarget(Se,Ce,Ne),P.setClearColor(nt,Ye),Qe!==void 0&&(H.viewport=Qe),P.toneMapping=Ze}function wi(v,L,q){const H=L.isScene===!0?L.overrideMaterial:null;for(let k=0,ye=v.length;k<ye;k++){const we=v[k],{object:Se,geometry:Ce,group:Ne}=we;let Ze=we.material;Ze.allowOverride===!0&&H!==null&&(Ze=H),Se.layers.test(q.layers)&&us(Se,L,q,Ce,Ze,Ne)}}function us(v,L,q,H,k,ye){F!==null&&k.isNodeMaterial&&F.setObject(v,k),v.onBeforeRender(P,L,q,H,k,ye),v.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),k.onBeforeRender(P,L,q,H,v,ye),k.transparent===!0&&k.side===2&&k.forceSinglePass===!1?(k.side=1,k.needsUpdate=!0,P.renderBufferDirect(q,L,H,k,v,ye),k.side=0,k.needsUpdate=!0,P.renderBufferDirect(q,L,H,k,v,ye),k.side=2):P.renderBufferDirect(q,L,H,k,v,ye),v.onAfterRender(P,L,q,H,k,ye)}function Ci(v,L,q){L.isScene!==!0&&(L=Te);const H=W.get(v),k=E.state.lights,ye=E.state.shadowsArray,we=k.state.version,Se=me.getParameters(v,k.state,ye,L,q,E.state.lightProbeGridArray),Ce=me.getProgramCacheKey(Se);let Ne=H.programs;H.environment=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?L.environment:null,H.fog=L.fog;const Ze=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap;H.envMap=ue.get(v.envMap||H.environment,Ze),H.envMapRotation=H.environment!==null&&v.envMap===null?L.environmentRotation:v.envMapRotation,Ne===void 0&&(v.addEventListener("dispose",Yt),Ne=new Map,H.programs=Ne);let Qe=Ne.get(Ce);if(Qe!==void 0){if(H.currentProgram===Qe&&H.lightsStateVersion===we)return ds(v,Se),Qe}else Se.uniforms=me.getUniforms(v),F!==null&&v.isNodeMaterial&&F.build(v,q,Se),v.onBeforeCompile(Se,P),Qe=me.acquireProgram(Se,Ce),Ne.set(Ce,Qe),H.uniforms=Se.uniforms;const Pe=H.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(Pe.clippingPlanes=Fe.uniform),ds(v,Se),H.needsLights=io(v),H.lightsStateVersion=we,H.needsLights&&(Pe.ambientLightColor.value=k.state.ambient,Pe.lightProbe.value=k.state.probe,Pe.sunLights.value=k.state.sun,Pe.sunLightShadows.value=k.state.sunShadow,Pe.directionalLights.value=k.state.directional,Pe.directionalLightShadows.value=k.state.directionalShadow,Pe.spotLights.value=k.state.spot,Pe.spotLightShadows.value=k.state.spotShadow,Pe.rectAreaLights.value=k.state.rectArea,Pe.ltc_1.value=k.state.rectAreaLTC1,Pe.ltc_2.value=k.state.rectAreaLTC2,Pe.pointLights.value=k.state.point,Pe.pointLightShadows.value=k.state.pointShadow,Pe.hemisphereLights.value=k.state.hemi,Pe.sunShadowMatrix.value=k.state.sunShadowMatrix,Pe.sunShadowCascade.value=k.state.sunShadowCascade,Pe.directionalShadowMatrix.value=k.state.directionalShadowMatrix,Pe.spotLightMatrix.value=k.state.spotLightMatrix,Pe.spotLightMap.value=k.state.spotLightMap,Pe.pointShadowMatrix.value=k.state.pointShadowMatrix),H.lightProbeGrid=E.state.lightProbeGridArray.length>0,H.currentProgram=Qe,H.uniformsList=null,Qe}function fs(v){if(v.uniformsList===null){const L=v.currentProgram.getUniforms();v.uniformsList=er.seqWithValue(L.seq,v.uniforms)}return v.uniformsList}function ds(v,L){const q=W.get(v);q.outputColorSpace=L.outputColorSpace,q.batching=L.batching,q.batchingColor=L.batchingColor,q.instancing=L.instancing,q.instancingColor=L.instancingColor,q.instancingMorph=L.instancingMorph,q.skinning=L.skinning,q.morphTargets=L.morphTargets,q.morphNormals=L.morphNormals,q.morphColors=L.morphColors,q.morphTargetsCount=L.morphTargetsCount,q.numClippingPlanes=L.numClippingPlanes,q.numIntersection=L.numClipIntersection,q.vertexAlphas=L.vertexAlphas,q.vertexTangents=L.vertexTangents,q.toneMapping=L.toneMapping}function eo(v,L){if(v.length===0)return null;if(v.length===1)return v[0].texture!==null?v[0]:null;M.setFromMatrixPosition(L.matrixWorld);for(let q=0,H=v.length;q<H;q++){const k=v[q];if(k.texture!==null&&k.boundingBox.containsPoint(M))return k}return null}function to(v,L,q,H,k){L.isScene!==!0&&(L=Te),$.resetTextureUnits();const ye=L.fog,we=H.isMeshStandardMaterial||H.isMeshLambertMaterial||H.isMeshPhongMaterial?L.environment:null,Se=oe===null?P.outputColorSpace:oe.isXRRenderTarget===!0?oe.texture.colorSpace:tt.workingColorSpace,Ce=H.isMeshStandardMaterial||H.isMeshLambertMaterial&&!H.envMap||H.isMeshPhongMaterial&&!H.envMap,Ne=ue.get(H.envMap||we,Ce),Ze=H.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,Qe=!!q.attributes.tangent&&(!!H.normalMap||H.anisotropy>0),Pe=!!q.morphAttributes.position,at=!!q.morphAttributes.normal,vt=!!q.morphAttributes.color;let dt=0;H.toneMapped&&(oe===null||oe.isXRRenderTarget===!0)&&(dt=P.toneMapping);const ct=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,At=ct!==void 0?ct.length:0,Re=W.get(H),Ct=E.state.lights;if(J===!0&&(he===!0||v!==ie)){const ft=v===ie&&H.id===Y;Fe.setState(H,v,ft)}let it=!1;H.version===Re.__version?(Re.needsLights&&Re.lightsStateVersion!==Ct.state.version||Re.outputColorSpace!==Se||k.isBatchedMesh&&Re.batching===!1||!k.isBatchedMesh&&Re.batching===!0||k.isBatchedMesh&&Re.batchingColor===!0&&k._colorsTexture===null||k.isBatchedMesh&&Re.batchingColor===!1&&k._colorsTexture!==null||k.isInstancedMesh&&Re.instancing===!1||!k.isInstancedMesh&&Re.instancing===!0||k.isSkinnedMesh&&Re.skinning===!1||!k.isSkinnedMesh&&Re.skinning===!0||k.isInstancedMesh&&Re.instancingColor===!0&&k.instanceColor===null||k.isInstancedMesh&&Re.instancingColor===!1&&k.instanceColor!==null||k.isInstancedMesh&&Re.instancingMorph===!0&&k.morphTexture===null||k.isInstancedMesh&&Re.instancingMorph===!1&&k.morphTexture!==null||Re.envMap!==Ne||H.fog===!0&&Re.fog!==ye||Re.numClippingPlanes!==void 0&&(Re.numClippingPlanes!==Fe.numPlanes||Re.numIntersection!==Fe.numIntersection)||Re.vertexAlphas!==Ze||Re.vertexTangents!==Qe||Re.morphTargets!==Pe||Re.morphNormals!==at||Re.morphColors!==vt||Re.toneMapping!==dt||Re.morphTargetsCount!==At||!!Re.lightProbeGrid!=E.state.lightProbeGridArray.length>0)&&(it=!0):(it=!0,Re.__version=H.version);let Ft=Re.currentProgram;it===!0&&(Ft=Ci(H,L,k),F&&H.isNodeMaterial&&F.onUpdateProgram(H,Ft,Re));let Zt=!1,hn=!1,Dn=!1;const lt=Ft.getUniforms(),_t=Re.uniforms;if(g.useProgram(Ft.program)&&(Zt=!0,hn=!0,Dn=!0),H.id!==Y&&(Y=H.id,hn=!0),Re.needsLights){const ft=eo(E.state.lightProbeGridArray,k);Re.lightProbeGrid!==ft&&(Re.lightProbeGrid=ft,hn=!0)}if(Zt||ie!==v){g.buffers.depth.getReversed()&&v.reversedDepth!==!0&&(v._reversedDepth=!0,v.updateProjectionMatrix()),lt.setValue(C,"projectionMatrix",v.projectionMatrix),lt.setValue(C,"viewMatrix",v.matrixWorldInverse);const fn=lt.map.cameraPosition;fn!==void 0&&fn.setValue(C,le.setFromMatrixPosition(v.matrixWorld)),T.logarithmicDepthBuffer&&lt.setValue(C,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(H.isMeshPhongMaterial||H.isMeshToonMaterial||H.isMeshLambertMaterial||H.isMeshBasicMaterial||H.isMeshStandardMaterial||H.isShaderMaterial)&&lt.setValue(C,"isOrthographic",v.isOrthographicCamera===!0),ie!==v&&(ie=v,hn=!0,Dn=!0)}if(Re.needsLights&&(Ct.state.sunShadowMap.length>0&&lt.setValue(C,"sunShadowMap",Ct.state.sunShadowMap,$),Ct.state.directionalShadowMap.length>0&&lt.setValue(C,"directionalShadowMap",Ct.state.directionalShadowMap,$),Ct.state.spotShadowMap.length>0&&lt.setValue(C,"spotShadowMap",Ct.state.spotShadowMap,$),Ct.state.pointShadowMap.length>0&&lt.setValue(C,"pointShadowMap",Ct.state.pointShadowMap,$)),k.isSkinnedMesh){lt.setOptional(C,k,"bindMatrix"),lt.setOptional(C,k,"bindMatrixInverse");const ft=k.skeleton;ft&&(ft.boneTexture===null&&ft.computeBoneTexture(),lt.setValue(C,"boneTexture",ft.boneTexture,$))}k.isBatchedMesh&&(lt.setOptional(C,k,"batchingTexture"),lt.setValue(C,"batchingTexture",k._matricesTexture,$),lt.setOptional(C,k,"batchingIdTexture"),lt.setValue(C,"batchingIdTexture",k._indirectTexture,$),lt.setOptional(C,k,"batchingColorTexture"),k._colorsTexture!==null&&lt.setValue(C,"batchingColorTexture",k._colorsTexture,$));const un=q.morphAttributes;if((un.position!==void 0||un.normal!==void 0||un.color!==void 0)&&I.update(k,q,Ft),(hn||Re.receiveShadow!==k.receiveShadow)&&(Re.receiveShadow=k.receiveShadow,lt.setValue(C,"receiveShadow",k.receiveShadow)),(H.isMeshStandardMaterial||H.isMeshLambertMaterial||H.isMeshPhongMaterial)&&H.envMap===null&&L.environment!==null&&(_t.envMapIntensity.value=L.environmentIntensity),_t.dfgLUT!==void 0&&(_t.dfgLUT.value=Rd()),hn){if(lt.setValue(C,"toneMappingExposure",P.toneMappingExposure),Re.needsLights&&no(_t,Dn),ye&&H.fog===!0&&Ue.refreshFogUniforms(_t,ye),Ue.refreshMaterialUniforms(_t,H,re,K,E.state.transmissionRenderTarget[v.id]),Re.needsLights&&Re.lightProbeGrid){const ft=Re.lightProbeGrid;_t.probesSH.value=ft.texture,_t.probesMin.value.copy(ft.boundingBox.min),_t.probesMax.value.copy(ft.boundingBox.max),_t.probesResolution.value.copy(ft.resolution)}er.upload(C,fs(Re),_t,$)}if(H.isShaderMaterial&&H.uniformsNeedUpdate===!0&&(er.upload(C,fs(Re),_t,$),H.uniformsNeedUpdate=!1),H.isSpriteMaterial&&lt.setValue(C,"center",k.center),lt.setValue(C,"modelViewMatrix",k.modelViewMatrix),lt.setValue(C,"normalMatrix",k.normalMatrix),lt.setValue(C,"modelMatrix",k.matrixWorld),H.uniformsGroups!==void 0){const ft=H.uniformsGroups;for(let fn=0,In=ft.length;fn<In;fn++){const ms=ft[fn];ce.update(ms,Ft),ce.bind(ms,Ft)}}return Ft}function no(v,L){v.ambientLightColor.needsUpdate=L,v.lightProbe.needsUpdate=L,v.sunLights.needsUpdate=L,v.sunLightShadows.needsUpdate=L,v.directionalLights.needsUpdate=L,v.directionalLightShadows.needsUpdate=L,v.pointLights.needsUpdate=L,v.pointLightShadows.needsUpdate=L,v.spotLights.needsUpdate=L,v.spotLightShadows.needsUpdate=L,v.rectAreaLights.needsUpdate=L,v.hemisphereLights.needsUpdate=L}function io(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return Q},this.getActiveMipmapLevel=function(){return X},this.getRenderTarget=function(){return oe},this.setRenderTargetTextures=function(v,L,q){const H=W.get(v);H.__autoAllocateDepthBuffer=v.resolveDepthBuffer===!1,H.__autoAllocateDepthBuffer===!1&&(H.__useRenderToTexture=!1),W.get(v.texture).__webglTexture=L,W.get(v.depthTexture).__webglTexture=H.__autoAllocateDepthBuffer?void 0:q,H.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(v,L){const q=W.get(v);q.__webglFramebuffer=L,q.__useDefaultFramebuffer=L===void 0},this.setRenderTarget=function(v,L=0,q=0){oe=v,Q=L,X=q;let H=null,k=!1,ye=!1;if(v){const Se=W.get(v);if(Se.__useDefaultFramebuffer!==void 0){g.bindFramebuffer(C.FRAMEBUFFER,Se.__webglFramebuffer),ne.copy(v.viewport),Le.copy(v.scissor),be=v.scissorTest,g.viewport(ne),g.scissor(Le),g.setScissorTest(be),Y=-1;return}else if(Se.__webglFramebuffer===void 0)$.setupRenderTarget(v);else if(Se.__hasExternalTextures)$.rebindTextures(v,W.get(v.texture).__webglTexture,W.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const Ze=v.depthTexture;if(Se.__boundDepthTexture!==Ze){if(Ze!==null&&W.has(Ze)&&(v.width!==Ze.image.width||v.height!==Ze.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");$.setupDepthRenderbuffer(v)}}const Ce=v.texture;(Ce.isData3DTexture||Ce.isDataArrayTexture||Ce.isCompressedArrayTexture)&&(ye=!0);const Ne=W.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(Ne[L])?H=Ne[L][q]:H=Ne[L],k=!0):v.samples>0&&$.useMultisampledRTT(v)===!1?H=W.get(v).__webglMultisampledFramebuffer:Array.isArray(Ne)?H=Ne[q]:H=Ne,ne.copy(v.viewport),Le.copy(v.scissor),be=v.scissorTest}else ne.copy(ee).multiplyScalar(re).floor(),Le.copy(pe).multiplyScalar(re).floor(),be=ke;if(q!==0&&(H=B),g.bindFramebuffer(C.FRAMEBUFFER,H)&&g.drawBuffers(v,H),g.viewport(ne),g.scissor(Le),g.setScissorTest(be),k){const Se=W.get(v.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+L,Se.__webglTexture,q)}else if(ye){const Se=L;for(let Ce=0;Ce<v.textures.length;Ce++){const Ne=W.get(v.textures[Ce]);C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0+Ce,Ne.__webglTexture,q,Se)}}else if(v!==null&&q!==0){const Se=W.get(v.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Se.__webglTexture,q)}Y=-1};function ps(v){const L=W.get(v);return(L.__readFormat!==v.format||L.__readType!==v.type)&&(L.__readFormat=v.format,L.__readType=v.type,L.__formatReadable=T.textureFormatReadable(v.format),L.__typeReadable=T.textureTypeReadable(v.type)),L}this.readRenderTargetPixels=function(v,L,q,H,k,ye,we,Se=0){if(!(v&&v.isWebGLRenderTarget)){rt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ce=W.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&we!==void 0&&(Ce=Ce[we]),Ce){g.bindFramebuffer(C.FRAMEBUFFER,Ce);try{const Ne=v.textures[Se],Ze=Ne.format,Qe=Ne.type;v.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+Se);const Pe=ps(Ne);if(Pe.__formatReadable===!1){rt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(Pe.__typeReadable===!1){rt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=v.width-H&&q>=0&&q<=v.height-k&&C.readPixels(L,q,H,k,xe.convert(Ze),xe.convert(Qe),ye)}finally{const Ne=oe!==null?W.get(oe).__webglFramebuffer:null;g.bindFramebuffer(C.FRAMEBUFFER,Ne)}}},this.readRenderTargetPixelsAsync=async function(v,L,q,H,k,ye,we,Se=0){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ce=W.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&we!==void 0&&(Ce=Ce[we]),Ce)if(L>=0&&L<=v.width-H&&q>=0&&q<=v.height-k){g.bindFramebuffer(C.FRAMEBUFFER,Ce);const Ne=v.textures[Se],Ze=Ne.format,Qe=Ne.type;v.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+Se);const Pe=ps(Ne);if(Pe.__formatReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(Pe.__typeReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const at=C.createBuffer();C.bindBuffer(C.PIXEL_PACK_BUFFER,at),C.bufferData(C.PIXEL_PACK_BUFFER,ye.byteLength,C.STREAM_READ),C.readPixels(L,q,H,k,xe.convert(Ze),xe.convert(Qe),0),C.bindBuffer(C.PIXEL_PACK_BUFFER,null);const vt=oe!==null?W.get(oe).__webglFramebuffer:null;g.bindFramebuffer(C.FRAMEBUFFER,vt);const dt=C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE,0);return C.flush(),await ao(C,dt,4),C.bindBuffer(C.PIXEL_PACK_BUFFER,at),C.getBufferSubData(C.PIXEL_PACK_BUFFER,0,ye),C.bindBuffer(C.PIXEL_PACK_BUFFER,null),C.deleteBuffer(at),C.deleteSync(dt),ye}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(v,L=null,q=0){const H=Math.pow(2,-q),k=Math.floor(v.image.width*H),ye=Math.floor(v.image.height*H),we=L!==null?L.x:0,Se=L!==null?L.y:0;$.setTexture2D(v,0),C.copyTexSubImage2D(C.TEXTURE_2D,q,0,0,we,Se,k,ye),g.unbindTexture()},this.copyTextureToTexture=function(v,L,q=null,H=null,k=0,ye=0){let we,Se,Ce,Ne,Ze,Qe,Pe,at,vt;const dt=v.isCompressedTexture?v.mipmaps[ye]:v.image;if(q!==null)we=q.max.x-q.min.x,Se=q.max.y-q.min.y,Ce=q.isBox3?q.max.z-q.min.z:1,Ne=q.min.x,Ze=q.min.y,Qe=q.isBox3?q.min.z:0;else{const _t=Math.pow(2,-k);we=Math.floor(dt.width*_t),Se=Math.floor(dt.height*_t),v.isDataArrayTexture?Ce=dt.depth:v.isData3DTexture?Ce=Math.floor(dt.depth*_t):Ce=1,Ne=0,Ze=0,Qe=0}H!==null?(Pe=H.x,at=H.y,vt=H.z):(Pe=0,at=0,vt=0);const ct=xe.convert(L.format),At=xe.convert(L.type);let Re;L.isData3DTexture?($.setTexture3D(L,0),Re=C.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?($.setTexture2DArray(L,0),Re=C.TEXTURE_2D_ARRAY):($.setTexture2D(L,0),Re=C.TEXTURE_2D),g.activeTexture(C.TEXTURE0),g.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,L.flipY),g.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),g.pixelStorei(C.UNPACK_ALIGNMENT,L.unpackAlignment);const Ct=g.getParameter(C.UNPACK_ROW_LENGTH),it=g.getParameter(C.UNPACK_IMAGE_HEIGHT),Ft=g.getParameter(C.UNPACK_SKIP_PIXELS),Zt=g.getParameter(C.UNPACK_SKIP_ROWS),hn=g.getParameter(C.UNPACK_SKIP_IMAGES);g.pixelStorei(C.UNPACK_ROW_LENGTH,dt.width),g.pixelStorei(C.UNPACK_IMAGE_HEIGHT,dt.height),g.pixelStorei(C.UNPACK_SKIP_PIXELS,Ne),g.pixelStorei(C.UNPACK_SKIP_ROWS,Ze),g.pixelStorei(C.UNPACK_SKIP_IMAGES,Qe);const Dn=v.isDataArrayTexture||v.isData3DTexture,lt=L.isDataArrayTexture||L.isData3DTexture;if(v.isDepthTexture){const _t=W.get(v),un=W.get(L),ft=W.get(_t.__renderTarget),fn=W.get(un.__renderTarget);g.bindFramebuffer(C.READ_FRAMEBUFFER,ft.__webglFramebuffer),g.bindFramebuffer(C.DRAW_FRAMEBUFFER,fn.__webglFramebuffer);for(let In=0;In<Ce;In++)Dn&&(C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,W.get(v).__webglTexture,k,Qe+In),C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,W.get(L).__webglTexture,ye,vt+In)),C.blitFramebuffer(Ne,Ze,we,Se,Pe,at,we,Se,C.DEPTH_BUFFER_BIT,C.NEAREST);g.bindFramebuffer(C.READ_FRAMEBUFFER,null),g.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else if(k!==0||v.isRenderTargetTexture||W.has(v)){const _t=W.get(v),un=W.get(L);g.bindFramebuffer(C.READ_FRAMEBUFFER,N),g.bindFramebuffer(C.DRAW_FRAMEBUFFER,G);for(let ft=0;ft<Ce;ft++)Dn?C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,_t.__webglTexture,k,Qe+ft):C.framebufferTexture2D(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,_t.__webglTexture,k),lt?C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,un.__webglTexture,ye,vt+ft):C.framebufferTexture2D(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,un.__webglTexture,ye),k!==0?C.blitFramebuffer(Ne,Ze,we,Se,Pe,at,we,Se,C.COLOR_BUFFER_BIT,C.NEAREST):lt?C.copyTexSubImage3D(Re,ye,Pe,at,vt+ft,Ne,Ze,we,Se):C.copyTexSubImage2D(Re,ye,Pe,at,Ne,Ze,we,Se);g.bindFramebuffer(C.READ_FRAMEBUFFER,null),g.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else lt?v.isDataTexture||v.isData3DTexture?C.texSubImage3D(Re,ye,Pe,at,vt,we,Se,Ce,ct,At,dt.data):L.isCompressedArrayTexture?C.compressedTexSubImage3D(Re,ye,Pe,at,vt,we,Se,Ce,ct,dt.data):C.texSubImage3D(Re,ye,Pe,at,vt,we,Se,Ce,ct,At,dt):v.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,ye,Pe,at,we,Se,ct,At,dt.data):v.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,ye,Pe,at,dt.width,dt.height,ct,dt.data):C.texSubImage2D(C.TEXTURE_2D,ye,Pe,at,we,Se,ct,At,dt);g.pixelStorei(C.UNPACK_ROW_LENGTH,Ct),g.pixelStorei(C.UNPACK_IMAGE_HEIGHT,it),g.pixelStorei(C.UNPACK_SKIP_PIXELS,Ft),g.pixelStorei(C.UNPACK_SKIP_ROWS,Zt),g.pixelStorei(C.UNPACK_SKIP_IMAGES,hn),ye===0&&L.generateMipmaps&&C.generateMipmap(Re),g.unbindTexture()},this.initRenderTarget=function(v){W.get(v).__webglFramebuffer===void 0&&$.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?$.setTextureCube(v,0):v.isData3DTexture?$.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?$.setTexture2DArray(v,0):$.setTexture2D(v,0),g.unbindTexture()},this.resetState=function(){Q=0,X=0,oe=null,g.reset(),Ee.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return 2e3}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=tt._getDrawingBufferColorSpace(e),t.unpackColorSpace=tt._getUnpackColorSpace()}}class Cd extends ya{constructor(){super(),this.name="RoomEnvironment",this.position.y=-3.5;const e=new ai;e.deleteAttribute("uv");const t=new Qn({side:1}),n=new Qn,r=new bl(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);const s=new xt(e,t);s.position.set(-.757,13.219,.717),s.scale.set(31.713,28.305,28.591),this.add(s);const a=new Do(e,n,6),o=new Tt;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);const l=new xt(e,Zn(50));l.position.set(-16.116,14.37,8.208),l.scale.set(.1,2.428,2.739),this.add(l);const c=new xt(e,Zn(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);const u=new xt(e,Zn(17));u.position.set(14.904,12.198,-1.832),u.scale.set(.15,4.265,6.331),this.add(u);const f=new xt(e,Zn(43));f.position.set(-.462,8.89,14.52),f.scale.set(4.38,5.441,.088),this.add(f);const h=new xt(e,Zn(20));h.position.set(3.235,11.486,-12.541),h.scale.set(2.5,2,.1),this.add(h);const p=new xt(e,Zn(100));p.position.set(0,20,0),p.scale.set(1,.1,1),this.add(p)}dispose(){const e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(const t of e)t.dispose()}}function Zn(i){return new Ml({color:0,emissive:16777215,emissiveIntensity:i})}function Pd(i,e){let t;try{t=new wd({alpha:!0,antialias:!0})}catch{return()=>{}}i.replaceChildren(t.domElement),t.setPixelRatio(Math.min(devicePixelRatio,1.5)),t.shadowMap.enabled=!0,t.shadowMap.type=2,t.toneMapping=4,t.toneMappingExposure=1.25;const n=new ya,r=new Zr(t),s=new Cd,a=r.fromScene(s,.04);n.environment=a.texture,s.dispose(),r.dispose();const o=new ar,l=.68,c=Math.sin(l);n.add(new El(16777215,9273717,2.3));const u=new Rl(16774110,3.2);u.position.set(-250,650,200),u.castShadow=!0,u.shadow.mapSize.set(1024,1024),u.shadow.bias=-1e-4,u.shadow.normalBias=.3,n.add(u,u.target);const f=new xt(new Ri(6e3,6e3),new pl({opacity:.2}));f.rotation.x=-Math.PI/2,f.receiveShadow=!0,n.add(f);const h=new Qn({color:12239820,metalness:.88,roughness:.25}),p=new Qn({color:2107187,metalness:.5,roughness:.34}),_=new Qn({color:14134614,metalness:.75,roughness:.27}),S=[2579150,13124145,14068006,3120496,9067765,15235125,2002838,13978499,7445301].map((V,z)=>{const ee=new Kn,pe=new Kn;ee.add(pe),n.add(ee);const ke=new Qn({color:V,metalness:.35,roughness:.23}),Z=(ae,le,De)=>{const Te=new xt(ae,le);return Te.position.y=De,Te.castShadow=!0,Te.receiveShadow=!0,pe.add(Te),Te},J=[[.06,0],[.13,.08],[.16,.24],[.27,.3],[.42,.39],[.58,.48],[.72,.56],[.76,.65],[.63,.72]];Z(new is(J.map(([ae,le])=>new fe(ae,le)),48),p,0),Z(new wn(.84,.77,.13,64),h,.66),Z(new wn(.68,.79,.15,48),ke,.79),Z(new wn(.36,.43,.13,48),h,.91),Z(new wn(.29,.34,.09,6),_,1.01),Z(new sr(.22,24,12,0,Math.PI*2,0,Math.PI/2),ke,1.045);const he=Z(new rs(.58,.065,10,64),h,.9);he.rotation.x=Math.PI/2;for(let ae=0;ae<6;ae++){const le=new Da;le.moveTo(.42,-.13),le.lineTo(.8,-.26),le.lineTo(1.02,-.1),le.lineTo(.9,.17),le.lineTo(.64,.24),le.lineTo(.48,.1),le.closePath(),Z(new ns(le,{depth:.13,bevelEnabled:!0,bevelSegments:2,steps:1,bevelSize:.035,bevelThickness:.025}),ae%2?ke:h,.81).rotation.set(-Math.PI/2,0,ae*Math.PI/3);const Te=Z(new wn(.042,.042,.025,12),p,.98);Te.position.x=Math.cos(ae*Math.PI/3)*.48,Te.position.z=Math.sin(ae*Math.PI/3)*.48}return{pivot:ee,model:pe,index:z,x:0,y:0,vx:0,vy:0,spin:0,angle:0,age:0,life:0,tilt:0,precession:0,phase:"spinning",rest:0,radius:40,mass:1+z*.12,roamX:0,roamY:0,roamIn:0}});let m=window.innerWidth>1200?9:7;const d=[],b=new sr(1.3,4,3),w=new Qr({color:16759370});let M=1,y=1,E=null,R=0,x=0,A=0,P=0,D=!1;const F=matchMedia("(prefers-reduced-motion: reduce)"),B=(V,z)=>V+Math.random()*(z-V),N=(V,z)=>[V-M/2,(z-y/2)/c];function G(V){m=V,S.forEach((z,ee)=>{z.active=ee<m,z.pivot.visible=z.active}),i.dataset.topCount=String(m)}function Q(){P=0,i.dataset.hitCount="0",S.forEach((V,z)=>{if(!V.active){V.phase="resting",V.rest=0,V.vx=0,V.vy=0;return}const ee=V.radius+12,pe=(z+B(.2,.8))/m;V.roamX=ee+pe*Math.max(0,M-ee*2),V.roamY=ee+B(0,1)*Math.max(0,y-ee*2),V.roamIn=B(2,6),V.x=Math.max(ee,Math.min(M-ee,V.roamX+B(-Math.min(M*.07,56),Math.min(M*.07,56)))),V.y=Math.max(ee,Math.min(y-ee,V.roamY+B(-Math.min(y*.12,70),Math.min(y*.12,70)))),V.vx=B(-145,145),V.vy=B(-145,145),V.spin=B(64,84),V.angle=B(0,6),V.age=0,V.life=85+B(-1.5,1.5),V.tilt=.03,V.precession=B(0,Math.PI*2),V.phase="spinning",V.rest=0})}function X(){const V=i.getBoundingClientRect();M=V.width,y=V.height,G(window.innerWidth>1200?9:7),t.setSize(M,y),o.left=-M/2,o.right=M/2,o.top=y/2,o.bottom=-y/2,o.near=1,o.far=5e3,o.position.set(0,Math.sin(l)*1800,Math.cos(l)*1800),o.lookAt(0,0,0),o.updateProjectionMatrix();const z=Math.max(M,y);u.shadow.camera.left=-z,u.shadow.camera.right=z,u.shadow.camera.top=z,u.shadow.camera.bottom=-z,u.shadow.camera.far=3e3,u.shadow.camera.updateProjectionMatrix(),S.forEach(ee=>{ee.radius=M<620?26:43,ee.model.scale.setScalar(ee.radius)}),Q(),be(),t.render(n,o)}function oe(V,z,ee){if(ee<45||d.length>36)return;const[pe,ke]=N(V,z);for(let Z=0;Z<6;Z++){const J=new xt(b,w);J.position.set(pe,22,ke),n.add(J),d.push({mesh:J,vx:B(-75,75),vy:B(30,100),vz:B(-75,75),life:.3})}}let Y=window.scrollY;function ie(){const V=window.scrollY-Y;Y=window.scrollY;const z=Math.max(-6,Math.min(6,-V*.035));Math.abs(z)<.15||S.slice(0,m).forEach(ee=>{ee.phase!=="resting"&&(ee.vy=Math.max(-165,Math.min(165,ee.vy+z)))})}function ne(V,z,ee,pe,ke,Z){V.x+=z*pe,V.y+=ee*pe;const J=V.vx*z+V.vy*ee;J<0&&(V.vx-=1.82*J*z,V.vy-=1.82*J*ee,oe(ke,Z,-J))}function Le(V){S.forEach(z=>{if(z.phase==="resting")return;z.age+=V;const ee=Math.max(0,1-z.age/z.life);z.spin=Math.max(0,65*Math.pow(ee,.75));const pe=Math.max(0,1-z.spin/24);z.phase=ee===0?"tumbling":pe>.05?"wobbling":"spinning",z.precession+=V*(2+pe*9);const ke=ee===0?1.43:.025+pe*.48;z.tilt+=(ke-z.tilt)*(1-Math.exp(-V*(ee===0?2.4:5))),ee===0&&(z.rest+=V,z.spin=5*Math.exp(-z.rest*2),z.rest>3&&(z.phase="resting",z.spin=0,z.vx=0,z.vy=0)),z.angle+=z.spin*V;const Z=z.phase==="tumbling"?2.5:.12;z.phase==="spinning"&&(z.roamIn-=V,z.roamIn<=0&&(z.roamX=Math.max(z.radius+12,Math.min(M-z.radius-12,z.x+B(-M*.22,M*.22))),z.roamY=Math.max(z.radius+12,Math.min(y-z.radius-12,z.y+B(-y*.22,y*.22))),z.roamIn=B(3,7)),z.vx+=(z.roamX-z.x)*.24*V,z.vy+=(z.roamY-z.y)*.24*V),z.vx*=Math.exp(-Z*V),z.vy*=Math.exp(-Z*V),z.x+=z.vx*V,z.y+=z.vy*V;const J=z.radius+5;if(z.x<J&&ne(z,1,0,J-z.x,J,z.y),z.x>M-J&&ne(z,-1,0,z.x-M+J,M-J,z.y),z.y<J&&ne(z,0,1,J-z.y,z.x,J),z.y>y-J&&ne(z,0,-1,z.y-y+J,z.x,y-J),E){const he=z.x-E.x,ae=z.y-E.y,le=Math.hypot(he,ae);le>0&&le<J+12&&ne(z,he/le,ae/le,J+12-le,E.x,E.y)}}),S.slice(0,m).forEach((z,ee)=>S.slice(ee+1,m).forEach(pe=>{const ke=pe.x-z.x,Z=pe.y-z.y,J=Math.hypot(ke,Z),he=z.radius+pe.radius;if(J>=he||J<.001)return;const ae=ke/J,le=Z/J,De=z.phase==="resting"?0:1/z.mass,Te=pe.phase==="resting"?0:1/pe.mass,Be=De+Te;if(!Be)return;z.x-=ae*(he-J)*De/Be,z.y-=le*(he-J)*De/Be,pe.x+=ae*(he-J)*Te/Be,pe.y+=le*(he-J)*Te/Be;const ze=(pe.vx-z.vx)*ae+(pe.vy-z.vy)*le;if(ze>=0)return;const C=-2.55*B(.92,1.12)*ze/Be;z.vx-=C*ae*De,z.vy-=C*le*De,pe.vx+=C*ae*Te,pe.vy+=C*le*Te;for(const $e of[z,pe]){const qe=Math.hypot($e.vx,$e.vy),T=360;qe>T&&($e.vx=$e.vx/qe*T,$e.vy=$e.vy/qe*T)}oe((z.x+pe.x)/2,(z.y+pe.y)/2,-ze),i.dataset.hitCount=String(Number(i.dataset.hitCount||0)+1)}));for(let z=d.length-1;z>=0;z--){const ee=d[z];ee.life-=V,ee.vy-=240*V,ee.mesh.position.x+=ee.vx*V,ee.mesh.position.y+=ee.vy*V,ee.mesh.position.z+=ee.vz*V,ee.mesh.scale.setScalar(Math.max(0,ee.life/.3)),ee.life<=0&&(n.remove(ee.mesh),d.splice(z,1))}S.every(z=>z.phase==="resting")&&(P+=V,P>3&&Q())}function be(){for(const V of S){const[z,ee]=N(V.x,V.y);if(V.phase!=="resting"){const ke=new U(Math.cos(V.precession),0,Math.sin(V.precession));V.pivot.quaternion.setFromAxisAngle(ke,V.tilt),V.model.rotation.y=V.angle}V.pivot.position.set(z,0,ee),V.pivot.updateMatrixWorld(!0);const pe=new vn().setFromObject(V.pivot);V.pivot.position.y=-pe.min.y+.4}i.dataset.phases=S.map(V=>V.phase).join(",")}function nt(V){if(D)return;const z=Math.min(.05,(V-x)/1e3||0);if(x=V,!document.hidden&&!F.matches){for(A+=z;A>=1/120;)Le(1/120),A-=1/120;be(),t.render(n,o)}R=requestAnimationFrame(nt)}const Ye=V=>{if(V.pointerType==="touch")return;const z=i.getBoundingClientRect();E={x:V.clientX-z.left,y:V.clientY-z.top}},et=()=>{E=null};e.addEventListener("pointermove",Ye),e.addEventListener("pointerleave",et),window.addEventListener("scroll",ie,{passive:!0});const K=new ResizeObserver(X);K.observe(i);const re=()=>{Q(),be(),t.render(n,o)};return F.addEventListener("change",re),X(),R=requestAnimationFrame(nt),()=>{D=!0,cancelAnimationFrame(R),K.disconnect(),window.removeEventListener("scroll",ie),e.removeEventListener("pointermove",Ye),e.removeEventListener("pointerleave",et),F.removeEventListener("change",re),n.traverse(V=>{V.geometry&&V.geometry.dispose(),V.material&&V.material.dispose()}),a.dispose(),t.dispose(),t.domElement.remove()}}const Ae=(...i)=>i,bt=(...i)=>[...i,i[0]],Ve=(i,e,t,n=0,r=Math.PI*2,s=30)=>Array.from({length:s+1},(a,o)=>{const l=n+(r-n)*o/s;return[i+Math.cos(l)*t,e+Math.sin(l)*t]}),kr=[{name:"portrait",paths:[Ve(50,48,25),Ve(50,37,26,Math.PI,Math.PI*2),Ae([40,47],[45,47]),Ae([55,47],[60,47]),Ve(50,56,7,.1,Math.PI-.1),Ae([35,78],[42,66],[58,66],[66,78])]},{name:"cat",paths:[bt([30,38],[39,23],[48,31],[58,23],[70,38],[67,65],[50,72],[33,65]),Ae([39,49],[45,49]),Ae([55,49],[61,49]),Ae([50,53],[50,59]),Ae([50,59],[39,62]),Ae([50,59],[61,62]),Ae([34,42],[18,37]),Ae([34,49],[16,50]),Ae([66,42],[82,37]),Ae([66,49],[84,50])]},{name:"dinosaur",paths:[bt([18,59],[30,44],[47,42],[58,31],[68,41],[82,43],[72,51],[77,62],[62,67],[58,80],[51,80],[49,67],[39,66],[35,78],[28,78],[29,62]),Ae([61,45],[64,45]),Ae([20,59],[10,51]),Ae([45,42],[41,30]),Ae([52,40],[49,28])]},{name:"landscape",paths:[Ae([8,71],[26,48],[39,65],[57,34],[82,71]),Ae([8,71],[92,71]),Ae([18,71],[31,57],[41,71]),Ve(75,30,9),Ae([12,82],[36,77],[57,82],[88,76])]},{name:"rocket",paths:[bt([48,19],[61,36],[59,61],[50,75],[41,61],[39,36]),Ve(50,42,7),Ae([41,57],[28,65],[41,67]),Ae([59,57],[72,65],[59,67]),Ae([46,75],[42,88],[50,82],[57,88],[54,75])]},{name:"house",paths:[bt([25,48],[50,25],[75,48],[75,76],[25,76]),bt([44,76],[44,58],[57,58],[57,76]),bt([31,53],[40,53],[40,62],[31,62]),Ae([65,33],[65,22],[72,22],[72,39])]},{name:"flower",paths:[Ve(50,50,8),Ve(50,35,13),Ve(64,45,13),Ve(60,61,13),Ve(40,61,13),Ve(36,45,13),Ae([50,58],[50,82]),Ve(43,72,10,.2,2.5),Ve(57,67,10,.6,2.9)]},{name:"robot",paths:[bt([27,32],[73,32],[73,71],[27,71]),Ve(50,51,4),bt([35,43],[44,43],[44,52],[35,52]),bt([56,43],[65,43],[65,52],[56,52]),Ae([50,32],[50,20]),Ve(50,17,3),Ae([27,58],[17,58]),Ae([73,58],[83,58]),Ae([39,80],[39,71]),Ae([61,80],[61,71])]},{name:"fish",paths:[Ve(47,51,22),bt([65,51],[84,33],[84,69]),Ve(39,47,3),Ae([28,56],[44,62],[57,58]),Ae([19,44],[9,36]),Ae([19,56],[9,64])]},{name:"whale",paths:[bt([19,60],[29,43],[57,40],[73,51],[84,38],[82,57],[90,64],[72,67],[56,77],[32,75]),Ve(44,57,3),Ae([55,75],[58,86]),Ae([58,86],[61,75])]},{name:"mountains",paths:[Ae([10,76],[33,31],[51,65],[69,24],[92,76]),Ae([10,76],[92,76]),Ae([28,40],[33,31],[39,44]),Ae([64,34],[69,24],[75,42]),Ae([15,87],[35,82],[56,88],[85,82])]},{name:"coffee",paths:[bt([27,39],[65,39],[65,69],[27,69]),Ve(66,53,11,-1.3,1.3),Ve(46,79,20,.1,Math.PI-.1),Ve(39,29,8,-.2,2.3),Ve(53,29,8,-.2,2.3)]},{name:"guitar",paths:[Ve(43,60,16),Ve(57,43,16),Ae([52,34],[69,17]),bt([68,14],[76,18],[72,25]),Ve(43,60,5),Ae([47,55],[71,19])]},{name:"light bulb",paths:[Ve(50,43,20,Math.PI*1.08,Math.PI*2.92),Ae([39,61],[43,73],[57,73],[61,61]),Ae([43,78],[57,78]),Ae([46,83],[54,83]),Ae([50,12],[50,4]),Ae([25,22],[18,16]),Ae([75,22],[82,16])]},{name:"planet",paths:[Ve(50,50,23),Ve(50,50,34,.2,Math.PI-.2),Ve(50,50,34,Math.PI+.2,Math.PI*2-.2),Ve(43,42,4),Ve(61,57,3)]},{name:"tree",paths:[Ae([50,83],[50,54]),Ae([50,65],[35,52]),Ae([50,65],[64,48]),Ve(50,42,22),Ve(33,52,14),Ve(67,52,14),Ae([24,84],[76,84])]},{name:"bicycle",paths:[Ve(31,66,15),Ve(70,66,15),Ae([31,66],[43,43],[57,66],[31,66]),Ae([43,43],[61,43]),Ae([57,66],[67,35]),Ae([61,43],[68,35]),Ae([41,43],[36,35]),Ae([67,35],[76,35])]},{name:"cassette",paths:[bt([18,32],[82,32],[82,70],[18,70]),Ve(37,51,9),Ve(63,51,9),Ae([46,51],[54,51]),bt([34,37],[66,37],[66,43],[34,43]),Ae([40,66],[60,66])]},{name:"snail",paths:[Ve(42,58,20),Ve(42,58,10),Ae([60,68],[80,68],[85,60]),Ae([80,68],[85,78]),Ae([77,58],[79,48]),Ae([84,58],[88,48]),Ve(79,48,2),Ve(88,48,2)]},{name:"hero insignia",paths:[Ve(50,50,29),bt([33,67],[51,27],[68,67],[57,58],[50,70],[43,58]),Ae([41,54],[59,54]),Ve(50,50,21)]}],Jn=5200,tr=11e3,Ja=2600,Ld=900,ga=Jn+tr+Ja,Dd=i=>i.slice(1).reduce((e,t,n)=>e+Math.hypot(t[0]-i[n][0],t[1]-i[n][1]),0),bi=i=>Dd(i);function Ka(i,e,t,n,r){if(t<=0)return;let s=bi(e)*Math.min(t,1);i.beginPath(),i.moveTo(e[0][0]*n/100,e[0][1]*r/100);for(let a=1;a<e.length&&s>0;a+=1){const o=e[a-1],l=e[a],c=Math.hypot(l[0]-o[0],l[1]-o[1]),u=Math.min(1,s/c);i.lineTo((o[0]+(l[0]-o[0])*u)*n/100,(o[1]+(l[1]-o[1])*u)*r/100),s-=c}i.stroke()}function _a(i,e,t,n,r){let a=e.reduce((o,l)=>o+bi(l),0)*Math.min(1,Math.max(0,t));e.forEach(o=>{const l=bi(o);Ka(i,o,Math.min(1,a/l),n,r),a-=l})}function Id(i,e,t,n,r){let s=e.reduce((a,o)=>a+bi(o),0)*Math.max(0,1-t);e.forEach(a=>{const o=bi(a),l=Math.min(o,Math.max(0,s));Ka(i,a,l/o,n,r),s-=o})}const An=(i,e,t)=>i.map(([n,r])=>[n+e,r+t]),Wt=(i,e,t,n)=>i.map(([r,s])=>[e+(r-e)*Math.cos(n)-(s-t)*Math.sin(n),t+(r-e)*Math.sin(n)+(s-t)*Math.cos(n)]),Rn=(i,e,t,n)=>Array.from({length:t+1},(r,s)=>n(s/t,i,e));function Nd(i,e,t){const n=Math.min(1,t/.45),r=e.map(a=>a.map(([o,l])=>[o,l])),s=Math.sin(t*2.2)*n;if(i==="portrait"){const a=Math.max(0,Math.cos(t*1.5))**28*n;[2,3].forEach(o=>{const l=(r[o][0][0]+r[o][1][0])/2;r[o]=r[o].map(([c,u])=>[l+(c-l)*(1-a),u+a*1.4])})}else if(i==="cat"){r[0]=Wt(r[0],50,65,s*.035);const a=Math.sin(t*2.7)*8*n;r.push(Rn(0,1,14,o=>[66+o*15,63+Math.sin(o*Math.PI)*(4+a)+o*4]))}else if(i==="dinosaur"){const a=Math.sin(t*2.5)*1.4*n;r[0]=An(r[0],0,Math.abs(a)),r[0]=r[0].map(([o,l])=>[o,l+(o<43&&l>63?a:0)]),r[2]=Wt(r[2],20,58,s*.12)}else if(i==="landscape"){r[3]=An(r[3],0,Math.sin(t*1.3)*2*n);const a=t*8%120-12;r.push(Rn(0,1,20,o=>[a+o*13,22+Math.sin(o*Math.PI*2)*1.8]))}else if(i==="rocket"){const a=(1-Math.cos(t*2.1))*1.5*n;r.forEach((l,c)=>{r[c]=An(l,0,-a)});const o=Math.sin(t*16)*2.5*n;r[4]=r[4].map(([l,c],u)=>[l,c+(u>0&&u<4?o:0)])}else if(i==="house"){const a=t*2;r.push(Rn(0,1,16,l=>[68+Math.sin(a+l*3)*(1+l*2),22-l*13]));const o=.5+Math.sin(t*2.8)*.5;r.push(o>.62?bt([32,54],[39,54],[39,61],[32,61]):Ae([35,54],[35,61]))}else if(i==="flower"){const a=Math.sin(t*1.8)*6*n;r[6]=r[6].map(([o,l])=>[o+(l-58)/24*a,l]),r.slice(0,6).forEach((o,l)=>{r[l]=An(o,a,0)}),r[7]=Wt(r[7],50,72,s*.08),r[8]=Wt(r[8],50,67,-s*.08)}else if(i==="robot"){const a=Math.max(0,Math.cos(t*1.25))**24*n;[2,3].forEach(o=>{const l=(r[o][0][1]+r[o][2][1])/2;r[o]=r[o].map(([c,u])=>[c,l+(u-l)*(1-a)])}),r[6]=Wt(r[6],27,58,s*.13),r[7]=Wt(r[7],73,58,-s*.13)}else if(i==="fish"){r[1]=Wt(r[1],65,51,Math.sin(t*5)*.25*n),r[0]=An(r[0],Math.sin(t*2.5)*1.2*n,0);const a=t*10%28;r.push(Ve(24,52-a,1.4,0,Math.PI*2,12))}else if(i==="whale"){const a=Math.sin(t*2.1)*2.5*n;r[0]=r[0].map(([l,c])=>[l>78?l+a:l,c]);const o=Math.max(0,Math.sin(t*1.8))*n;r.push(Rn(0,1,10,l=>[51+Math.sin(l*Math.PI*2)*2,41-l*(4+o*8)]))}else if(i==="mountains"){const a=t*7%120-12;r.push(Rn(0,1,20,o=>[a+o*13,22+Math.sin(o*Math.PI*2)*1.8])),r.push(Ve(77,34+Math.sin(t)*1.5,6,Math.PI,Math.PI*2,16))}else if(i==="coffee")[0,1].forEach(a=>{const o=a?53:39,l=t*2+a*Math.PI;r.push(Rn(0,1,16,c=>[o+Math.sin(l+c*4)*(1+c*2),34-c*19]))});else if(i==="guitar"){const a=Math.sin(t*24)*1.8*n;r[5]=Rn(0,1,14,o=>[47+o*24+Math.sin(o*Math.PI*5)*a,55-o*36])}else if(i==="light bulb"){const a=(Math.sin(t*3)+1)*.5*n;[[4,[50,12]],[5,[25,22]],[6,[75,22]]].forEach(([o,[l,c]])=>{r[o]=r[o].map(([u,f])=>[l+(u-l)*(1+a*.24),c+(f-c)*(1+a*.24)])})}else if(i==="planet"){const a=t*1.2;r.push(Ve(50+Math.cos(a)*34,50+Math.sin(a)*19,2.2,0,Math.PI*2,12))}else if(i==="bicycle")[31,70].forEach((a,o)=>{const l=t*3.3*(o?-1:1);for(let c=0;c<4;c+=1){const u=l+c*Math.PI/2;r.push(Ae([a,66],[a+Math.cos(u)*13,66+Math.sin(u)*13]))}});else if(i==="cassette")[37,63].forEach((a,o)=>{const l=t*(o?-2.8:2.8);for(let c=0;c<3;c+=1){const u=l+c*Math.PI*2/3;r.push(Ae([a,51],[a+Math.cos(u)*7,51+Math.sin(u)*7]))}});else if(i==="tree")r[1]=Wt(r[1],50,65,s*.1),r[2]=Wt(r[2],50,65,-s*.1),[3,4,5].forEach(a=>{r[a]=An(r[a],Math.sin(t*2.2+a)*1.5*n,0)});else if(i==="snail"){const a=(1-Math.cos(t*.7))*1.1*n;r.slice(0,4).forEach((l,c)=>{r[c]=An(l,a,0)});const o=Math.sin(t*1.6)*.13*n;[4,5,6,7].forEach(l=>{r[l]=Wt(r[l],80,60,o)})}else i==="hero insignia"&&r.forEach((a,o)=>{r[o]=Wt(a,50,50,s*.08)});return r}function Ud(i){const e=[...i.querySelectorAll("[data-doodle]")].map((l,c)=>({drawing:l,canvas:l.querySelector("[data-doodle-canvas]"),sketch:c%kr.length,phase:"drawing",started:performance.now()+c*Ld})).filter(l=>l.canvas instanceof HTMLCanvasElement),t=window.matchMedia("(prefers-reduced-motion: reduce)");let n=0;const r=(l,c)=>{const u=l.canvas,f=u.getContext("2d");if(!f)return;const h=u.width,p=u.height,S=(t.matches?8e3:c-l.started)%ga;S<Jn?l.phase="drawing":S<Jn+tr?l.phase="complete":l.phase="reversing",l.drawing.dataset.doodleState=l.phase,f.clearRect(0,0,h,p),f.strokeStyle="rgba(48, 49, 43, .76)",f.lineWidth=Math.max(1.2,h/155),f.lineJoin="round",f.lineCap="round",f.globalCompositeOperation="multiply";const m=kr[l.sketch],d=(S-Jn)/1e3,b=l.phase!=="drawing"&&!t.matches?Nd(m.name,m.paths,l.phase==="complete"?d:tr/1e3):m.paths;if(l.phase==="drawing"&&_a(f,b,S/Jn,h,p),l.phase==="complete"&&_a(f,b,1,h,p),l.phase==="reversing"){const w=(S-Jn-tr)/Ja;Id(f,b,w,h,p)}l.phase==="reversing"&&S>=ga-20&&(l.sketch=(l.sketch+1+s(l))%kr.length,l.started=c)},s=l=>e.indexOf(l),a=l=>{e.forEach(c=>r(c,l)),t.matches||(n=requestAnimationFrame(a))},o=()=>{cancelAnimationFrame(n),n=requestAnimationFrame(a)};return t.addEventListener("change",o),n=requestAnimationFrame(a),()=>{cancelAnimationFrame(n),t.removeEventListener("change",o)}}const $t=document.querySelector("[data-play-root]");if($t instanceof HTMLElement){const i=window.matchMedia("(prefers-reduced-motion: reduce)"),e=$t.querySelector("[data-shuffle]"),t=[...$t.querySelectorAll("[data-play-tile]")],n=$t.querySelector("[data-play-status]"),r=[...$t.querySelectorAll("[data-play-reveal]")],s=$t.querySelector("[data-battlefield]"),a=$t.querySelector(".play-hero"),o=Ud($t);if(document.addEventListener("astro:before-swap",o,{once:!0}),i.matches)r.forEach(l=>l.setAttribute("data-visible",""));else{$t.dataset.motion="ready";const l=c=>c.setAttribute("data-visible","");if("IntersectionObserver"in window){const c=new IntersectionObserver(u=>{u.forEach(f=>{f.isIntersecting&&(l(f.target),c.unobserve(f.target))})},{threshold:.12,rootMargin:"0px 0px -8% 0px"});r.forEach(u=>c.observe(u))}else r.forEach(l)}if(e?.addEventListener("click",()=>{if(window.matchMedia("(max-width: 620px)").matches)return;const l=$t.querySelector("[data-play-grid]");if(!(l instanceof HTMLElement))return;const c=window.matchMedia("(max-width: 980px)").matches?[[0,2],[42,54],[442,5],[482,53],[900,2],[932,54]]:[[0,2],[42,35],[4,68],[500,8],[475,39],[520,68]],u=[...t].sort(()=>Math.random()-.5),f=new Map(u.map(h=>[h,h.getBoundingClientRect()]));l.append(...u),u.forEach((h,p)=>{const[_,S]=c[p],m=(Math.random()*7-3.5).toFixed(2);h.style.top=`${_}px`,h.style.left=`${S}%`,h.style.right="auto",h.style.zIndex=String(p+1),h.style.setProperty("--play-desk-rotation",`${m}deg`),h.style.transform=`translate3d(0, 0, 0) rotate(${m}deg)`}),i.matches||u.forEach(h=>{const p=f.get(h),_=h.getBoundingClientRect();if(!p)return;const S=h.style.getPropertyValue("--play-desk-rotation");h.style.transform=`translate3d(${p.left-_.left}px, ${p.top-_.top}px, 0) rotate(${S})`,requestAnimationFrame(()=>{h.style.transform=`translate3d(0, 0, 0) rotate(${S})`})}),e.textContent="Shuffle again",n&&(n.textContent="The project desk has been rearranged into a new order.")}),s instanceof HTMLElement&&a instanceof HTMLElement){const l=Pd(s,a);document.addEventListener("astro:before-swap",l,{once:!0})}}
