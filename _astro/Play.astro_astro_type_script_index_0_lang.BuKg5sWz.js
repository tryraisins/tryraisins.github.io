...
`)+`
`+d);const w=b+m+a,M=b+d+o,E=sa(r,r.VERTEX_SHADER,w),y=sa(r,r.FRAGMENT_SHADER,M);r.attachShader(S,E),r.attachShader(S,y),t.index0AttributeName!==void 0?r.bindAttribLocation(S,0,t.index0AttributeName):t.hasPositionAttribute===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function R(D){if(i.debug.checkShaderErrors){const F=r.getProgramInfoLog(S)||"",G=r.getShaderInfoLog(E)||"",N=r.getShaderInfoLog(y)||"",B=F.trim(),Q=G.trim(),X=N.trim();let oe=!0,Y=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(oe=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,S,E,y);else{const ne=oa(r,E,"vertex"),te=oa(r,y,"fragment");rt("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
...
}`,dd=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],pd=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)],ma=new ht,gi=new U,Hr=new U;function md(i,e,t){let n=new jr;const r=new fe,s=new fe,a=new pt,o=new Sl,l=new yl,c={},u=t.maxTextureSize,f={0:1,1:0,2:2},h=new en({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new fe},radius:{value:4}},vertexShader:ud,fragmentShader:fd}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const _=new It;_.setAttribute("position",new jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new xt(_,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=1;let d=this.type;this.render=function(y,R,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||y.length===0)return;this.type===2&&(He("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=1);const A=i.getRenderTarget(),P=i.getActiveCubeFace(),D=i.getActiveMipmapLevel(),F=i.state;F.setBlending(0),F.buffers.depth.getReversed()===!0?F.buffers.color.setClear(0,0,0,0):F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const G=d!==this.type;G&&R.traverse(function(N){N.material&&(Array.isArray(N.material)?N.material.forEach(B=>B.needsUpdate=!0):N.material.needsUpdate=!0)});for(let N=0,B=y.length;N<B;N++){const Q=y[N],X=Q.shadow;if(X===void 0){He("WebGLShadowMap:",Q,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;r.copy(X.mapSize);const oe=X.getFrameExtents();r.multiply(oe),s.copy(X.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/oe.x),r.x=s.x*oe.x,X.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/oe.y),r.y=s.y*oe.y,X.mapSize.y=s.y));const Y=i.state.buffers.depth.getReversed();if(X.camera._reversedDepth=Y,X.map===null||G===!0){if(X.map!==null&&(X.map.depthTexture!==null&&(X.map.depthTexture.dispose(),X.map.depthTexture=null),X.map.dispose()),this.type===3){if(Q.isPointLight){He("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}X.map=new qt(r.x,r.y,{format:1030,type:1016,minFilter:1006,magFilter:1006,generateMipmaps:!1}),X.map.texture.name=Q.name+".shadowMap",X.map.depthTexture=new Si(r.x,r.y,1015),X.map.depthTexture.name=Q.name+".shadowMapDepth",X.map.depthTexture.format=1026,X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=1003,X.map.depthTexture.magFilter=1003}else Q.isPointLight?(X.map=new ka(r.x),X.map.depthTexture=new No(r.x,1014)):(X.map=new qt(r.x,r.y),X.map.depthTexture=new Si(r.x,r.y,1014)),X.map.depthTexture.name=Q.name+".shadowMap",X.map.depthTexture.format=1026,this.type===1?(X.map.depthTexture.compareFunction=Y?518:515,X.map.depthTexture.minFilter=1006,X.map.depthTexture.magFilter=1006):(X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=1003,X.map.depthTexture.magFilter=1003);X.camera.updateProjectionMatrix()}X.map.isWebGLCubeRenderTarget!==!0&&(X.map.width!==r.x||X.map.height!==r.y)&&X.map.setSize(r.x,r.y);const ne=X.map.isWebGLCubeRenderTarget?6:X.getViewportCount();Q.isPointLight!==!0&&X.updateMatrices(Q,x);for(let te=0;te<ne;te++){const Le=X.getCamera(te);if(Q.isPointLight){const be=X.camera,nt=X.matrix,Ye=Q.distance||be.far;Ye!==be.far&&(be.far=Ye,be.updateProjectionMatrix()),gi.setFromMatrixPosition(Q.matrixWorld),be.position.copy(gi),Hr.copy(be.position),Hr.add(dd[te]),be.up.copy(pd[te]),be.lookAt(Hr),be.updateMatrixWorld(),nt.makeTranslation(-gi.x,-gi.y,-gi.z),ma.multiplyMatrices(be.projectionMatrix,be.matrixWorldInverse),X._frustum.setFromProjectionMatrix(ma,be.coordinateSystem,be.reversedDepth)}if(X.map.isWebGLCubeRenderTarget)i.setRenderTarget(X.map,te),i.clear();else{te===0&&(i.setRenderTarget(X.map),i.clear());const be=X.getViewport(te);a.set(s.x*be.x,s.y*be.y,s.x*be.z,s.y*be.w),F.viewport(a)}n=X.getFrustum(te),M(R,x,Le,Q,this.type)}X.isPointLightShadow!==!0&&this.type===3&&b(X,x),X.needsUpdate=!1}d=this.type,m.needsUpdate=!1,i.setRenderTarget(A,P,D)};function b(y,R){const x=e.update(S);h.defines.VSM_SAMPLES!==y.blurSamples&&(h.defines.VSM_SAMPLES=y.blurSamples,p.defines.VSM_SAMPLES=y.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),y.mapPass===null?y.mapPass=new qt(r.x,r.y,{format:1030,type:1016}):(y.mapPass.width!==y.map.width||y.mapPass.height!==y.map.height)&&y.mapPass.setSize(y.map.width,y.map.height),h.uniforms.shadow_pass.value=y.map.depthTexture,h.uniforms.resolution.value.set(y.map.width,y.map.height),h.uniforms.radius.value=y.radius,i.setRenderTarget(y.mapPass),i.clear(),i.renderBufferDirect(R,null,x,h,S,null),p.uniforms.shadow_pass.value=y.mapPass.texture,p.uniforms.resolution.value.set(y.map.width,y.map.height),p.uniforms.radius.value=y.radius,i.setRenderTarget(y.map),i.clear(),i.renderBufferDirect(R,null,x,p,S,null)}function w(y,R,x,A){let P=null;const D=x.isPointLight===!0?y.customDistanceMaterial:y.customDepthMaterial;if(D!==void 0)P=D;else if(P=x.isPointLight===!0?l:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const F=P.uuid,G=R.uuid;let N=c[F];N===void 0&&(N={},c[F]=N);let B=N[G];B===void 0&&(B=P.clone(),N[G]=B,R.addEventListener("dispose",E)),P=B}if(P.visible=R.visible,P.wireframe=R.wireframe,A===3?P.side=R.shadowSide!==null?R.shadowSide:R.side:P.side=R.shadowSide!==null?R.shadowSide:f[R.side],P.alphaMap=R.alphaMap,P.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,P.map=R.map,P.clipShadows=R.clipShadows,P.clippingPlanes=R.clippingPlanes,P.clipIntersection=R.clipIntersection,P.displacementMap=R.displacementMap,P.displacementScale=R.displacementScale,P.displacementBias=R.displacementBias,P.wireframeLinewidth=R.wireframeLinewidth,P.linewidth=R.linewidth,x.isPointLight===!0&&P.isMeshDistanceMaterial===!0){const F=i.properties.get(P);F.light=x}return P}function M(y,R,x,A,P){if(y.visible===!1)return;if(y.layers.test(R.layers)&&(y.isMesh||y.isLine||y.isPoints)&&(y.castShadow||y.receiveShadow&&P===3)&&(!y.frustumCulled||y.intersectsFrustum(n))){y.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,y.matrixWorld);const G=e.update(y),N=y.material;if(Array.isArray(N)){const B=G.groups;for(let Q=0,X=B.length;Q<X;Q++){const oe=B[Q],Y=N[oe.materialIndex];if(Y&&Y.visible){const ne=w(y,Y,A,P);y.onBeforeShadow(i,y,R,x,G,ne,oe),i.renderBufferDirect(x,null,G,ne,y,oe),y.onAfterShadow(i,y,R,x,G,ne,oe)}}}else if(N.visible){const B=w(y,N,A,P);y.onBeforeShadow(i,y,R,x,G,B,null),i.renderBufferDirect(x,null,G,B,y,null),y.onAfterShadow(i,y,R,x,G,B,null)}}const F=y.children;for(let G=0,N=F.length;G<N;G++)M(F[G],R,x,A,P)}function E(y){y.target.removeEventListener("dispose",E);for(const x in c){const A=c[x],P=y.target.uuid;P in A&&(A[P].dispose(),delete A[P])}}}function gd(i,e){function t(){let I=!1;const _e=new pt;let ee=null;const xe=new pt(0,0,0,0);return{setMask:function(Ee){ee!==Ee&&!I&&(i.colorMask(Ee,Ee,Ee,Ee),ee=Ee)},setLocked:function(Ee){I=Ee},setClear:function(Ee,ce,Oe,Ie,ut){ut===!0&&(Ee*=Ie,ce*=Ie,Oe*=Ie),_e.set(Ee,ce,Oe,Ie),xe.equals(_e)===!1&&(i.clearColor(Ee,ce,Oe,Ie),xe.copy(_e))},reset:function(){I=!1,ee=null,xe.set(-1,0,0,0)}}}function n(){let I=!1,_e=!1,ee=null,xe=null,Ee=null;return{setReversed:function(ce){if(_e!==ce){const Oe=e.get("EXT_clip_control");ce?Oe.clipControlEXT(Oe.LOWER_LEFT_EXT,Oe.ZERO_TO_ONE_EXT):Oe.clipControlEXT(Oe.LOWER_LEFT_EXT,Oe.NEGATIVE_ONE_TO_ONE_EXT),_e=ce;const Ie=Ee;Ee=null,this.setClear(Ie)}},getReversed:function(){return _e},setTest:function(ce){ce?ie(i.DEPTH_TEST):z(i.DEPTH_TEST)},setMask:function(ce){ee!==ce&&!I&&(i.depthMask(ce),ee=ce)},setFunc:function(ce){if(_e&&(ce=oo[ce]),xe!==ce){switch(ce){case 0:i.depthFunc(i.NEVER);break;case 1:i.depthFunc(i.ALWAYS);break;case 2:i.depthFunc(i.LESS);break;case 3:i.depthFunc(i.LEQUAL);break;case 4:i.depthFunc(i.EQUAL);break;case 5:i.depthFunc(i.GEQUAL);break;case 6:i.depthFunc(i.GREATER);break;case 7:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}xe=ce}},setLocked:function(ce){I=ce},setClear:function(ce){Ee!==ce&&(Ee=ce,_e&&(ce=1-ce),i.clearDepth(ce))},reset:function(){I=!1,ee=null,xe=null,Ee=null,_e=!1}}}function r(){let I=!1,_e=null,ee=null,xe=null,Ee=null,ce=null,Oe=null,Ie=null,ut=null;return{setTest:function(st){I||(st?ie(i.STENCIL_TEST):z(i.STENCIL_TEST))},setMask:function(st){_e!==st&&!I&&(i.stencilMask(st),_e=st)},setFunc:function(st,zt,Yt){(ee!==st||xe!==zt||Ee!==Yt)&&(i.stencilFunc(st,zt,Yt),ee=st,xe=zt,Ee=Yt)},setOp:function(st,zt,Yt){(ce!==st||Oe!==zt||Ie!==Yt)&&(i.stencilOp(st,zt,Yt),ce=st,Oe=zt,Ie=Yt)},setLocked:function(st){I=st},setClear:function(st){ut!==st&&(i.clearStencil(st),ut=st)},reset:function(){I=!1,_e=null,ee=null,xe=null,Ee=null,ce=null,Oe=null,Ie=null,ut=null}}}const s=new t,a=new n,o=new r,l=new WeakMap,c=new WeakMap;let u={},f={},h={},p=new WeakMap,_=[],S=null,m=!1,d=null,b=null,w=null,M=null,E=null,y=null,R=null,x=new je(0,0,0),A=0,P=!1,D=null,F=null,G=null,N=null,B=null;const Q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,oe=0;const Y=i.getParameter(i.VERSION);Y.indexOf("WebGL")!==-1?(oe=parseFloat(/^WebGL (\d)/.exec(Y)[1]),X=oe>=1):Y.indexOf("OpenGL ES")!==-1&&(oe=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),X=oe>=2);let ne=null,te={};const Le=i.getParameter(i.SCISSOR_BOX),be=i.getParameter(i.VIEWPORT),nt=new pt().fromArray(Le),Ye=new pt().fromArray(be);function et(I,_e,ee,xe){const Ee=new Uint8Array(4),ce=i.createTexture();i.bindTexture(I,ce),i.texParameteri(I,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(I,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Oe=0;Oe<ee;Oe++)I===i.TEXTURE_3D||I===i.TEXTURE_2D_ARRAY?i.texImage3D(_e,0,i.RGBA,1,1,xe,0,i.RGBA,i.UNSIGNED_BYTE,Ee):i.texImage2D(_e+Oe,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Ee);return ce}const K={};K[i.TEXTURE_2D]=et(i.TEXTURE_2D,i.TEXTURE_2D,1),K[i.TEXTURE_CUBE_MAP]=et(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),K[i.TEXTURE_2D_ARRAY]=et(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),K[i.TEXTURE_3D]=et(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ie(i.DEPTH_TEST),a.setFunc(3),ae(!1),le(1),ie(i.CULL_FACE),J(0);function ie(I){u[I]!==!0&&(i.enable(I),u[I]=!0)}function z(I){u[I]!==!1&&(i.disable(I),u[I]=!1)}function k(I,_e){return h[I]!==_e?(i.bindFramebuffer(I,_e),h[I]=_e,I===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=_e),I===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=_e),!0):!1}function se(I,_e){let ee=_,xe=!1;if(I){ee=p.get(_e),ee===void 0&&(ee=[],p.set(_e,ee));const Ee=I.textures;if(ee.length!==Ee.length||ee[0]!==i.COLOR_ATTACHMENT0){for(let ce=0,Oe=Ee.length;ce<Oe;ce++)ee[ce]=i.COLOR_ATTACHMENT0+ce;ee.length=Ee.length,xe=!0}}else ee[0]!==i.BACK&&(ee[0]=i.BACK,xe=!0);xe&&i.drawBuffers(ee)}function de(I){return S!==I?(i.useProgram(I),S=I,!0):!1}const ke={100:i.FUNC_ADD,101:i.FUNC_SUBTRACT,102:i.FUNC_REVERSE_SUBTRACT};ke[103]=i.MIN,ke[104]=i.MAX;const Z={200:i.ZERO,201:i.ONE,202:i.SRC_COLOR,204:i.SRC_ALPHA,210:i.SRC_ALPHA_SATURATE,208:i.DST_COLOR,206:i.DST_ALPHA,203:i.ONE_MINUS_SRC_COLOR,205:i.ONE_MINUS_SRC_ALPHA,209:i.ONE_MINUS_DST_COLOR,207:i.ONE_MINUS_DST_ALPHA,211:i.CONSTANT_COLOR,212:i.ONE_MINUS_CONSTANT_COLOR,213:i.CONSTANT_ALPHA,214:i.ONE_MINUS_CONSTANT_ALPHA};function J(I,_e,ee,xe,Ee,ce,Oe,Ie,ut,st){if(I===0){m===!0&&(z(i.BLEND),m=!1);return}if(m===!1&&(ie(i.BLEND),m=!0),I!==5){if(I!==d||st!==P){if((b!==100||E!==100)&&(i.blendEquation(i.FUNC_ADD),b=100,E=100),st)switch(I){case 1:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case 2:i.blendFunc(i.ONE,i.ONE);break;case 3:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case 4:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:rt("WebGLState: Invalid blending: ",I);break}else switch(I){case 1:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case 2:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case 3:rt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case 4:rt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:rt("WebGLState: Invalid blending: ",I);break}w=null,M=null,y=null,R=null,x.set(0,0,0),A=0,d=I,P=st}return}Ee=Ee||_e,ce=ce||ee,Oe=Oe||xe,(_e!==b||Ee!==E)&&(i.blendEquationSeparate(ke[_e],ke[Ee]),b=_e,E=Ee),(ee!==w||xe!==M||ce!==y||Oe!==R)&&(i.blendFuncSeparate(Z[ee],Z[xe],Z[ce],Z[Oe]),w=ee,M=xe,y=ce,R=Oe),(Ie.equals(x)===!1||ut!==A)&&(i.blendColor(Ie.r,Ie.g,Ie.b,ut),x.copy(Ie),A=ut),d=I,P=!1}function he(I,_e){I.side===2?z(i.CULL_FACE):ie(i.CULL_FACE);let ee=I.side===1;_e&&(ee=!ee),ae(ee),I.blending===1&&I.transparent===!1?J(0):J(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),a.setFunc(I.depthFunc),a.setTest(I.depthTest),a.setMask(I.depthWrite),s.setMask(I.colorWrite);const xe=I.stencilWrite;o.setTest(xe),xe&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),Te(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?ie(i.SAMPLE_ALPHA_TO_COVERAGE):z(i.SAMPLE_ALPHA_TO_COVERAGE)}function ae(I){D!==I&&(I?i.frontFace(i.CW):i.frontFace(i.CCW),D=I)}function le(I){I!==0?(ie(i.CULL_FACE),I!==F&&(I===1?i.cullFace(i.BACK):I===2?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):z(i.CULL_FACE),F=I}function De(I){I!==G&&(X&&i.lineWidth(I),G=I)}function Te(I,_e,ee){I?(ie(i.POLYGON_OFFSET_FILL),(N!==_e||B!==ee)&&(N=_e,B=ee,a.getReversed()&&(_e=-_e),i.polygonOffset(_e,ee))):z(i.POLYGON_OFFSET_FILL)}function Be(I){I?ie(i.SCISSOR_TEST):z(i.SCISSOR_TEST)}function ze(I){I===void 0&&(I=i.TEXTURE0+Q-1),ne!==I&&(i.activeTexture(I),ne=I)}function C(I,_e,ee){ee===void 0&&(ne===null?ee=i.TEXTURE0+Q-1:ee=ne);let xe=te[ee];xe===void 0&&(xe={type:void 0,texture:void 0},te[ee]=xe),(xe.type!==I||xe.texture!==_e)&&(ne!==ee&&(i.activeTexture(ee),ne=ee),i.bindTexture(I,_e||K[I]),xe.type=I,xe.texture=_e)}function $e(){const I=te[ne];I!==void 0&&I.type!==void 0&&(i.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function qe(){try{i.compressedTexImage2D(...arguments)}catch(I){rt("WebGLState:",I)}}function T(){try{i.compressedTexImage3D(...arguments)}catch(I){rt("WebGLState:",I)}}function g(){try{i.texSubImage2D(...arguments)}catch(I){rt("WebGLState:",I)}}function O(){try{i.texSubImage3D(...arguments)}catch(I){rt("WebGLState:",I)}}function W(){try{i.compressedTexSubImage2D(...arguments)}catch(I){rt("WebGLState:",I)}}function $(){try{i.compressedTexSubImage3D(...arguments)}catch(I){rt("WebGLState:",I)}}function ue(){try{i.texStorage2D(...arguments)}catch(I){rt("WebGLState:",I)}}function pe(){try{i.texStorage3D(...arguments)}catch(I){rt("WebGLState:",I)}}function j(){try{i.texImage2D(...arguments)}catch(I){rt("WebGLState:",I)}}function re(){try{i.texImage3D(...arguments)}catch(I){rt("WebGLState:",I)}}function me(I){return f[I]!==void 0?f[I]:i.getParameter(I)}function Ue(I,_e){f[I]!==_e&&(i.pixelStorei(I,_e),f[I]=_e)}function ve(I){nt.equals(I)===!1&&(i.scissor(I.x,I.y,I.z,I.w),nt.copy(I))}function ge(I){Ye.equals(I)===!1&&(i.viewport(I.x,I.y,I.z,I.w),Ye.copy(I))}function Fe(I,_e){let ee=c.get(_e);ee===void 0&&(ee=new WeakMap,c.set(_e,ee));let xe=ee.get(I);xe===void 0&&(xe=i.getUniformBlockIndex(_e,I.name),ee.set(I,xe))}function Ge(I,_e){const xe=c.get(_e).get(I);l.get(_e)!==xe&&(i.uniformBlockBinding(_e,xe,I.__bindingPointIndex),l.set(_e,xe))}function Xe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),u={},f={},ne=null,te={},h={},p=new WeakMap,_=[],S=null,m=!1,d=null,b=null,w=null,M=null,E=null,y=null,R=null,x=new je(0,0,0),A=0,P=!1,D=null,F=null,G=null,N=null,B=null,nt.set(0,0,i.canvas.width,i.canvas.height),Ye.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ie,disable:z,bindFramebuffer:k,drawBuffers:se,useProgram:de,setBlending:J,setMaterial:he,setFlipSided:ae,setCullFace:le,setLineWidth:De,setPolygonOffset:Te,setScissorTest:Be,activeTexture:ze,bindTexture:C,unbindTexture:$e,compressedTexImage2D:qe,compressedTexImage3D:T,texImage2D:j,texImage3D:re,pixelStorei:Ue,getParameter:me,updateUBOMapping:Fe,uniformBlockBinding:Ge,texStorage2D:ue,texStorage3D:pe,texSubImage2D:g,texSubImage3D:O,compressedTexSubImage2D:W,compressedTexSubImage3D:$,scissor:ve,viewport:ge,reset:Xe}}function _d(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new fe,u=new WeakMap,f=new Set;let h;const p=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(T,g){return _?new OffscreenCanvas(T,g):rr("canvas")}function m(T,g,O){let W=1;const $=qe(T);if(($.width>O||$.height>O)&&(W=O/Math.max($.width,$.height)),W<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const ue=Math.floor(W*$.width),pe=Math.floor(W*$.height);h===void 0&&(h=S(ue,pe));const j=g?S(ue,pe):h;return j.width=ue,j.height=pe,j.getContext("2d").drawImage(T,0,0,ue,pe),He("WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+ue+"x"+pe+")."),j}else return"data"in T&&He("WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),T;return T}function d(T){return T.generateMipmaps}function b(T){i.generateMipmap(T)}function w(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function M(T,g,O,W,$,ue=!1){if(T!==null){if(i[T]!==void 0)return i[T];He("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let pe;W&&(pe=e.get("EXT_texture_norm16"),pe||He("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=g;if(g===i.RED&&(O===i.FLOAT&&(j=i.R32F),O===i.HALF_FLOAT&&(j=i.R16F),O===i.UNSIGNED_BYTE&&(j=i.R8),O===i.UNSIGNED_SHORT&&pe&&(j=pe.R16_EXT),O===i.SHORT&&pe&&(j=pe.R16_SNORM_EXT)),g===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(j=i.R8UI),O===i.UNSIGNED_SHORT&&(j=i.R16UI),O===i.UNSIGNED_INT&&(j=i.R32UI),O===i.BYTE&&(j=i.R8I),O===i.SHORT&&(j=i.R16I),O===i.INT&&(j=i.R32I)),g===i.RG&&(O===i.FLOAT&&(j=i.RG32F),O===i.HALF_FLOAT&&(j=i.RG16F),O===i.UNSIGNED_BYTE&&(j=i.RG8),O===i.UNSIGNED_SHORT&&pe&&(j=pe.RG16_EXT),O===i.SHORT&&pe&&(j=pe.RG16_SNORM_EXT)),g===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(j=i.RG8UI),O===i.UNSIGNED_SHORT&&(j=i.RG16UI),O===i.UNSIGNED_INT&&(j=i.RG32UI),O===i.BYTE&&(j=i.RG8I),O===i.SHORT&&(j=i.RG16I),O===i.INT&&(j=i.RG32I)),g===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(j=i.RGB8UI),O===i.UNSIGNED_SHORT&&(j=i.RGB16UI),O===i.UNSIGNED_INT&&(j=i.RGB32UI),O===i.BYTE&&(j=i.RGB8I),O===i.SHORT&&(j=i.RGB16I),O===i.INT&&(j=i.RGB32I)),g===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),O===i.UNSIGNED_INT&&(j=i.RGBA32UI),O===i.BYTE&&(j=i.RGBA8I),O===i.SHORT&&(j=i.RGBA16I),O===i.INT&&(j=i.RGBA32I)),g===i.RGB&&(O===i.UNSIGNED_SHORT&&pe&&(j=pe.RGB16_EXT),O===i.SHORT&&pe&&(j=pe.RGB16_SNORM_EXT),O===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),O===i.UNSIGNED_INT_10F_11F_11F_REV&&(j=i.R11F_G11F_B10F)),g===i.RGBA){const re=ue?ir:tt.getTransfer($);O===i.FLOAT&&(j=i.RGBA32F),O===i.HALF_FLOAT&&(j=i.RGBA16F),O===i.UNSIGNED_BYTE&&(j=re===ot?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT&&pe&&(j=pe.RGBA16_EXT),O===i.SHORT&&pe&&(j=pe.RGBA16_SNORM_EXT),O===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function E(T,g){let O;return T?g===null||g===1014||g===1020?O=i.DEPTH24_STENCIL8:g===1015?O=i.DEPTH32F_STENCIL8:g===1012&&(O=i.DEPTH24_STENCIL8,He("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===1014||g===1020?O=i.DEPTH_COMPONENT24:g===1015?O=i.DEPTH_COMPONENT32F:g===1012&&(O=i.DEPTH_COMPONENT16),O}function y(T,g){return d(T)===!0||T.isFramebufferTexture&&T.minFilter!==1003&&T.minFilter!==1006?Math.log2(Math.max(g.width,g.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?g.mipmaps.length:1}function R(T){const g=T.target;g.removeEventListener("dispose",R),A(g),g.isVideoTexture&&u.delete(g),g.isHTMLTexture&&f.delete(g)}function x(T){const g=T.target;g.removeEventListener("dispose",x),D(g)}function A(T){const g=n.get(T);if(g.__webglInit===void 0)return;const O=T.source,W=p.get(O);if(W){const $=W[g.__cacheKey];$.usedTimes--,$.usedTimes===0&&P(T),Object.keys(W).length===0&&p.delete(O)}n.remove(T)}function P(T){const g=n.get(T);i.deleteTexture(g.__webglTexture);const O=T.source,W=p.get(O);delete W[g.__cacheKey],a.memory.textures--}function D(T){const g=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(g.__webglFramebuffer[W]))for(let $=0;$<g.__webglFramebuffer[W].length;$++)i.deleteFramebuffer(g.__webglFramebuffer[W][$]);else i.deleteFramebuffer(g.__webglFramebuffer[W]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[W])}else{if(Array.isArray(g.__webglFramebuffer))for(let W=0;W<g.__webglFramebuffer.length;W++)i.deleteFramebuffer(g.__webglFramebuffer[W]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let W=0;W<g.__webglColorRenderbuffer.length;W++)g.__webglColorRenderbuffer[W]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[W]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const O=T.textures;for(let W=0,$=O.length;W<$;W++){const ue=n.get(O[W]);ue.__webglTexture&&(i.deleteTexture(ue.__webglTexture),a.memory.textures--),n.remove(O[W])}n.remove(T)}let F=0;function G(){F=0}function N(){return F}function B(T){F=T}function Q(){const T=F;return T>=r.maxTextures&&He("WebGLTextures: Trying to use "+(T+1)+" texture units while this GPU supports only "+r.maxTextures),F+=1,T}function X(T){const g=[];return g.push(T.wrapS),g.push(T.wrapT),g.push(T.wrapR||0),g.push(T.magFilter),g.push(T.minFilter),g.push(T.anisotropy),g.push(T.internalFormat),g.push(T.format),g.push(T.type),g.push(T.generateMipmaps),g.push(T.premultiplyAlpha),g.push(T.flipY),g.push(T.unpackAlignment),g.push(T.colorSpace),g.join()}function oe(T,g){const O=n.get(T);if(T.isVideoTexture&&C(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&O.__version!==T.version){const W=T.image;if(W===null)He("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)He("WebGLRenderer: Texture marked for update but image is incomplete");else{z(O,T,g);return}}else T.isExternalTexture&&(O.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+g)}function Y(T,g){const O=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&O.__version!==T.version){z(O,T,g);return}else T.isExternalTexture&&(O.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+g)}function ne(T,g){const O=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&O.__version!==T.version){z(O,T,g);return}t.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+g)}function te(T,g){const O=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&O.__version!==T.version){k(O,T,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+g)}const Le={1e3:i.REPEAT,1001:i.CLAMP_TO_EDGE,1002:i.MIRRORED_REPEAT},be={1003:i.NEAREST,1004:i.NEAREST_MIPMAP_NEAREST,1005:i.NEAREST_MIPMAP_LINEAR,1006:i.LINEAR,1007:i.LINEAR_MIPMAP_NEAREST,1008:i.LINEAR_MIPMAP_LINEAR},nt={512:i.NEVER,519:i.ALWAYS,513:i.LESS,515:i.LEQUAL,514:i.EQUAL,518:i.GEQUAL,516:i.GREATER,517:i.NOTEQUAL};function Ye(T,g){if(g.type===1015&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===1006||g.magFilter===1007||g.magFilter===1005||g.magFilter===1008||g.minFilter===1006||g.minFilter===1007||g.minFilter===1005||g.minFilter===1008)&&He("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,Le[g.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,Le[g.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,Le[g.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,be[g.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,be[g.minFilter]),g.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,nt[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===1003||g.minFilter!==1005&&g.minFilter!==1008||g.type===1015&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function et(T,g){let O=!1;T.__webglInit===void 0&&(T.__webglInit=!0,g.addEventListener("dispose",R));const W=g.source;let $=p.get(W);$===void 0&&($={},p.set(W,$));const ue=X(g);if(ue!==T.__cacheKey){$[ue]===void 0&&($[ue]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,O=!0),$[ue].usedTimes++;const pe=$[T.__cacheKey];pe!==void 0&&($[T.__cacheKey].usedTimes--,pe.usedTimes===0&&P(g)),T.__cacheKey=ue,T.__webglTexture=$[ue].texture}return O}function K(T,g,O){return Math.floor(Math.floor(T/O)/g)}function ie(T,g,O,W){const ue=T.updateRanges;if(ue.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,O,W,g.data);else{ue.sort((Ue,ve)=>Ue.start-ve.start);let pe=0;for(let Ue=1;Ue<ue.length;Ue++){const ve=ue[pe],ge=ue[Ue],Fe=ve.start+ve.count,Ge=K(ge.start,g.width,4),Xe=K(ve.start,g.width,4);ge.start<=Fe+1&&Ge===Xe&&K(ge.start+ge.count-1,g.width,4)===Ge?ve.count=Math.max(ve.count,ge.start+ge.count-ve.start):(++pe,ue[pe]=ge)}ue.length=pe+1;const j=t.getParameter(i.UNPACK_ROW_LENGTH),re=t.getParameter(i.UNPACK_SKIP_PIXELS),me=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let Ue=0,ve=ue.length;Ue<ve;Ue++){const ge=ue[Ue],Fe=Math.floor(ge.start/4),Ge=Math.ceil(ge.count/4),Xe=Fe%g.width,I=Math.floor(Fe/g.width),_e=Ge,ee=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Xe),t.pixelStorei(i.UNPACK_SKIP_ROWS,I),t.texSubImage2D(i.TEXTURE_2D,0,Xe,I,_e,ee,O,W,g.data)}T.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,j),t.pixelStorei(i.UNPACK_SKIP_PIXELS,re),t.pixelStorei(i.UNPACK_SKIP_ROWS,me)}}function z(T,g,O){let W=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(W=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(W=i.TEXTURE_3D);const $=et(T,g),ue=g.source;t.bindTexture(W,T.__webglTexture,i.TEXTURE0+O);const pe=n.get(ue);if(ue.version!==pe.__version||$===!0){if(t.activeTexture(i.TEXTURE0+O),(typeof ImageBitmap<"u"&&g.image instanceof ImageBitmap)===!1){const ee=tt.getPrimaries(tt.workingColorSpace),xe=g.colorSpace===""?null:tt.getPrimaries(g.colorSpace),Ee=g.colorSpace===""||ee===xe?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee)}t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment);let re=m(g.image,!1,r.maxTextureSize);re=$e(g,re);const me=s.convert(g.format,g.colorSpace),Ue=s.convert(g.type);let ve=M(g.internalFormat,me,Ue,g.normalized,g.colorSpace,g.isVideoTexture);Ye(W,g);let ge;const Fe=g.mipmaps,Ge=g.isVideoTexture!==!0,Xe=pe.__version===void 0||$===!0,I=ue.dataReady,_e=y(g,re);if(g.isDepthTexture)ve=E(g.format===1027,g.type),Xe&&(Ge?t.texStorage2D(i.TEXTURE_2D,1,ve,re.width,re.height):t.texImage2D(i.TEXTURE_2D,0,ve,re.width,re.height,0,me,Ue,null));else if(g.isDataTexture)if(Fe.length>0){Ge&&Xe&&t.texStorage2D(i.TEXTURE_2D,_e,ve,Fe[0].width,Fe[0].height);for(let ee=0,xe=Fe.length;ee<xe;ee++)ge=Fe[ee],Ge?I&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,ge.width,ge.height,me,Ue,ge.data):t.texImage2D(i.TEXTURE_2D,ee,ve,ge.width,ge.height,0,me,Ue,ge.data);g.generateMipmaps=!1}else Ge?(Xe&&t.texStorage2D(i.TEXTURE_2D,_e,ve,re.width,re.height),I&&ie(g,re,me,Ue)):t.texImage2D(i.TEXTURE_2D,0,ve,re.width,re.height,0,me,Ue,re.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Ge&&Xe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,_e,ve,Fe[0].width,Fe[0].height,re.depth);for(let ee=0,xe=Fe.length;ee<xe;ee++)if(ge=Fe[ee],g.format!==1023)if(me!==null)if(Ge){if(I)if(g.layerUpdates.size>0){const Ee=Zs(ge.width,ge.height,g.format,g.type);for(const ce of g.layerUpdates){const Oe=ge.data.subarray(ce*Ee/ge.data.BYTES_PER_ELEMENT,(ce+1)*Ee/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,ce,ge.width,ge.height,1,me,Oe)}}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,0,ge.width,ge.height,re.depth,me,ge.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,ee,ve,ge.width,ge.height,re.depth,0,ge.data,0,0);else He("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ge?I&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,0,ge.width,ge.height,re.depth,me,Ue,ge.data):t.texImage3D(i.TEXTURE_2D_ARRAY,ee,ve,ge.width,ge.height,re.depth,0,me,Ue,ge.data);g.layerUpdates.size>0&&g.clearLayerUpdates()}else{Ge&&Xe&&t.texStorage2D(i.TEXTURE_2D,_e,ve,Fe[0].width,Fe[0].height);for(let ee=0,xe=Fe.length;ee<xe;ee++)ge=Fe[ee],g.format!==1023?me!==null?Ge?I&&t.compressedTexSubImage2D(i.TEXTURE_2D,ee,0,0,ge.width,ge.height,me,ge.data):t.compressedTexImage2D(i.TEXTURE_2D,ee,ve,ge.width,ge.height,0,ge.data):He("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ge?I&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,ge.width,ge.height,me,Ue,ge.data):t.texImage2D(i.TEXTURE_2D,ee,ve,ge.width,ge.height,0,me,Ue,ge.data)}else if(g.isDataArrayTexture)if(Ge){if(Xe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,_e,ve,re.width,re.height,re.depth),I)if(g.layerUpdates.size>0){const ee=Zs(re.width,re.height,g.format,g.type);for(const xe of g.layerUpdates){const Ee=re.data.subarray(xe*ee/re.data.BYTES_PER_ELEMENT,(xe+1)*ee/re.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,xe,re.width,re.height,1,me,Ue,Ee)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,re.width,re.height,re.depth,me,Ue,re.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ve,re.width,re.height,re.depth,0,me,Ue,re.data);else if(g.isData3DTexture)Ge?(Xe&&t.texStorage3D(i.TEXTURE_3D,_e,ve,re.width,re.height,re.depth),I&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,re.width,re.height,re.depth,me,Ue,re.data)):t.texImage3D(i.TEXTURE_3D,0,ve,re.width,re.height,re.depth,0,me,Ue,re.data);else if(g.isFramebufferTexture){if(Xe)if(Ge)t.texStorage2D(i.TEXTURE_2D,_e,ve,re.width,re.height);else{let ee=re.width,xe=re.height;for(let Ee=0;Ee<_e;Ee++)t.texImage2D(i.TEXTURE_2D,Ee,ve,ee,xe,0,me,Ue,null),ee>>=1,xe>>=1}}else if(g.isHTMLTexture){if("texElementImage2D"in i){const ee=i.canvas;if(ee.hasAttribute("layoutsubtree")||ee.setAttribute("layoutsubtree","true"),re.parentNode!==ee){ee.appendChild(re),f.add(g),ee.onpaint=xe=>{const Ee=xe.changedElements;for(const ce of f)Ee.includes(ce.image)&&(ce.needsUpdate=!0)},ee.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,re);else{const Ee=i.RGBA,ce=i.RGBA,Oe=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,Ee,ce,Oe,re)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Fe.length>0){if(Ge&&Xe){const ee=qe(Fe[0]);t.texStorage2D(i.TEXTURE_2D,_e,ve,ee.width,ee.height)}for(let ee=0,xe=Fe.length;ee<xe;ee++)ge=Fe[ee],Ge?I&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,me,Ue,ge):t.texImage2D(i.TEXTURE_2D,ee,ve,me,Ue,ge);g.generateMipmaps=!1}else if(Ge){if(Xe){const ee=qe(re);t.texStorage2D(i.TEXTURE_2D,_e,ve,ee.width,ee.height)}I&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,me,Ue,re)}else t.texImage2D(i.TEXTURE_2D,0,ve,me,Ue,re);d(g)&&b(W),pe.__version=ue.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function k(T,g,O){if(g.image.length!==6)return;const W=et(T,g),$=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+O);const ue=n.get($);if($.version!==ue.__version||W===!0){t.activeTexture(i.TEXTURE0+O);const pe=tt.getPrimaries(tt.workingColorSpace),j=g.colorSpace===""?null:tt.getPrimaries(g.colorSpace),re=g.colorSpace===""||pe===j?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,re);const me=g.isCompressedTexture||g.image[0].isCompressedTexture,Ue=g.image[0]&&g.image[0].isDataTexture,ve=[];for(let ce=0;ce<6;ce++)!me&&!Ue?ve[ce]=m(g.image[ce],!0,r.maxCubemapSize):ve[ce]=Ue?g.image[ce].image:g.image[ce],ve[ce]=$e(g,ve[ce]);const ge=ve[0],Fe=s.convert(g.format,g.colorSpace),Ge=s.convert(g.type),Xe=M(g.internalFormat,Fe,Ge,g.normalized,g.colorSpace),I=g.isVideoTexture!==!0,_e=ue.__version===void 0||W===!0,ee=$.dataReady;let xe=y(g,ge);Ye(i.TEXTURE_CUBE_MAP,g);let Ee;if(me){I&&_e&&t.texStorage2D(i.TEXTURE_CUBE_MAP,xe,Xe,ge.width,ge.height);for(let ce=0;ce<6;ce++){Ee=ve[ce].mipmaps;for(let Oe=0;Oe<Ee.length;Oe++){const Ie=Ee[Oe];g.format!==1023?Fe!==null?I?ee&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe,0,0,Ie.width,Ie.height,Fe,Ie.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe,Xe,Ie.width,Ie.height,0,Ie.data):He("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe,0,0,Ie.width,Ie.height,Fe,Ge,Ie.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe,Xe,Ie.width,Ie.height,0,Fe,Ge,Ie.data)}}}else{if(Ee=g.mipmaps,I&&_e){Ee.length>0&&xe++;const ce=qe(ve[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,xe,Xe,ce.width,ce.height)}for(let ce=0;ce<6;ce++)if(Ue){I?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,0,0,ve[ce].width,ve[ce].height,Fe,Ge,ve[ce].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,Xe,ve[ce].width,ve[ce].height,0,Fe,Ge,ve[ce].data);for(let Oe=0;Oe<Ee.length;Oe++){const ut=Ee[Oe].image[ce].image;I?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe+1,0,0,ut.width,ut.height,Fe,Ge,ut.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe+1,Xe,ut.width,ut.height,0,Fe,Ge,ut.data)}}else{I?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,0,0,Fe,Ge,ve[ce]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,Xe,Fe,Ge,ve[ce]);for(let Oe=0;Oe<Ee.length;Oe++){const Ie=Ee[Oe];I?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe+1,0,0,Fe,Ge,Ie.image[ce]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Oe+1,Xe,Fe,Ge,Ie.image[ce])}}}d(g)&&b(i.TEXTURE_CUBE_MAP),ue.__version=$.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function se(T,g,O,W,$,ue){const pe=s.convert(O.format,O.colorSpace),j=s.convert(O.type),re=M(O.internalFormat,pe,j,O.normalized,O.colorSpace),me=n.get(g),Ue=n.get(O);if(Ue.__renderTarget=g,!me.__hasExternalTextures){const ve=Math.max(1,g.width>>ue),ge=Math.max(1,g.height>>ue);$===i.TEXTURE_3D||$===i.TEXTURE_2D_ARRAY?t.texImage3D($,ue,re,ve,ge,g.depth,0,pe,j,null):t.texImage2D($,ue,re,ve,ge,0,pe,j,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),ze(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,W,$,Ue.__webglTexture,0,Be(g)):($===i.TEXTURE_2D||$>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,W,$,Ue.__webglTexture,ue),t.bindFramebuffer(i.FRAMEBUFFER,null)}function de(T,g,O){if(i.bindRenderbuffer(i.RENDERBUFFER,T),g.depthBuffer){const W=g.depthTexture,$=W&&W.isDepthTexture?W.type:null,ue=E(g.stencilBuffer,$),pe=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;ze(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Be(g),ue,g.width,g.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,Be(g),ue,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ue,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,pe,i.RENDERBUFFER,T)}else{const W=g.textures;for(let $=0;$<W.length;$++){const ue=W[$],pe=s.convert(ue.format,ue.colorSpace),j=s.convert(ue.type),re=M(ue.internalFormat,pe,j,ue.normalized,ue.colorSpace);ze(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Be(g),re,g.width,g.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,Be(g),re,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,re,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ke(T,g,O){const W=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const $=n.get(g.depthTexture);if($.__renderTarget=g,(!$.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),W){if($.__webglInit===void 0&&($.__webglInit=!0,g.depthTexture.addEventListener("dispose",R)),$.__webglTexture===void 0){$.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,$.__webglTexture),Ye(i.TEXTURE_CUBE_MAP,g.depthTexture);const me=s.convert(g.depthTexture.format),Ue=s.convert(g.depthTexture.type);let ve;g.depthTexture.format===1026?ve=i.DEPTH_COMPONENT24:g.depthTexture.format===1027&&(ve=i.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,ve,g.width,g.height,0,me,Ue,null)}}else oe(g.depthTexture,0);const ue=$.__webglTexture,pe=Be(g),j=W?i.TEXTURE_CUBE_MAP_POSITIVE_X+O:i.TEXTURE_2D,re=g.depthTexture.format===1027?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===1026)ze(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,re,j,ue,0,pe):i.framebufferTexture2D(i.FRAMEBUFFER,re,j,ue,0);else if(g.depthTexture.format===1027)ze(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,re,j,ue,0,pe):i.framebufferTexture2D(i.FRAMEBUFFER,re,j,ue,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Z(T){const g=n.get(T),O=T.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==T.depthTexture){const W=T.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),W){const $=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,W.removeEventListener("dispose",$)};W.addEventListener("dispose",$),g.__depthDisposeCallback=$}g.__boundDepthTexture=W}if(T.depthTexture&&!g.__autoAllocateDepthBuffer)if(O)for(let W=0;W<6;W++)ke(g.__webglFramebuffer[W],T,W);else{const W=T.texture.mipmaps;W&&W.length>0?ke(g.__webglFramebuffer[0],T,0):ke(g.__webglFramebuffer,T,0)}else if(O){g.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[W]),g.__webglDepthbuffer[W]===void 0)g.__webglDepthbuffer[W]=i.createRenderbuffer(),de(g.__webglDepthbuffer[W],T,!1);else{const $=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ue=g.__webglDepthbuffer[W];i.bindRenderbuffer(i.RENDERBUFFER,ue),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,ue)}}else{const W=T.texture.mipmaps;if(W&&W.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),de(g.__webglDepthbuffer,T,!1);else{const $=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ue=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ue),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,ue)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function J(T,g,O){const W=n.get(T);g!==void 0&&se(W.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&Z(T)}function he(T){const g=T.texture,O=n.get(T),W=n.get(g);T.addEventListener("dispose",x);const $=T.textures,ue=T.isWebGLCubeRenderTarget===!0,pe=$.length>1;if(pe||(W.__webglTexture===void 0&&(W.__webglTexture=i.createTexture()),W.__version=g.version,a.memory.textures++),ue){O.__webglFramebuffer=[];for(let j=0;j<6;j++)if(g.mipmaps&&g.mipmaps.length>0){O.__webglFramebuffer[j]=[];for(let re=0;re<g.mipmaps.length;re++)O.__webglFramebuffer[j][re]=i.createFramebuffer()}else O.__webglFramebuffer[j]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){O.__webglFramebuffer=[];for(let j=0;j<g.mipmaps.length;j++)O.__webglFramebuffer[j]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(pe)for(let j=0,re=$.length;j<re;j++){const me=n.get($[j]);me.__webglTexture===void 0&&(me.__webglTexture=i.createTexture(),a.memory.textures++)}if(T.samples>0&&ze(T)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let j=0;j<$.length;j++){const re=$[j];O.__webglColorRenderbuffer[j]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[j]);const me=s.convert(re.format,re.colorSpace),Ue=s.convert(re.type),ve=M(re.internalFormat,me,Ue,re.normalized,re.colorSpace,T.isXRRenderTarget===!0),ge=Be(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,ge,ve,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+j,i.RENDERBUFFER,O.__webglColorRenderbuffer[j])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),de(O.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ue){t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture),Ye(i.TEXTURE_CUBE_MAP,g);for(let j=0;j<6;j++)if(g.mipmaps&&g.mipmaps.length>0)for(let re=0;re<g.mipmaps.length;re++)se(O.__webglFramebuffer[j][re],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,re);else se(O.__webglFramebuffer[j],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);d(g)&&b(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(pe){for(let j=0,re=$.length;j<re;j++){const me=$[j],Ue=n.get(me);let ve=i.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ve=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ve,Ue.__webglTexture),Ye(ve,me),se(O.__webglFramebuffer,T,me,i.COLOR_ATTACHMENT0+j,ve,0),d(me)&&b(ve)}t.unbindTexture()}else{let j=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(j=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(j,W.__webglTexture),Ye(j,g),g.mipmaps&&g.mipmaps.length>0)for(let re=0;re<g.mipmaps.length;re++)se(O.__webglFramebuffer[re],T,g,i.COLOR_ATTACHMENT0,j,re);else se(O.__webglFramebuffer,T,g,i.COLOR_ATTACHMENT0,j,0);d(g)&&b(j),t.unbindTexture()}T.depthBuffer&&Z(T)}function ae(T){const g=T.textures;for(let O=0,W=g.length;O<W;O++){const $=g[O];if(d($)){const ue=w(T),pe=n.get($).__webglTexture;t.bindTexture(ue,pe),b(ue),t.unbindTexture()}}}const le=[],De=[];function Te(T){if(T.samples>0){if(ze(T)===!1){const g=T.textures,O=T.width,W=T.height;let $=i.COLOR_BUFFER_BIT;const ue=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,pe=n.get(T),j=g.length>1;if(j)for(let me=0;me<g.length;me++)t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,pe.__webglMultisampledFramebuffer);const re=T.texture.mipmaps;re&&re.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,pe.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,pe.__webglFramebuffer);for(let me=0;me<g.length;me++){if(T.resolveDepthBuffer&&(T.depthBuffer&&($|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&($|=i.STENCIL_BUFFER_BIT)),j){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,pe.__webglColorRenderbuffer[me]);const Ue=n.get(g[me]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ue,0)}i.blitFramebuffer(0,0,O,W,0,0,O,W,$,i.NEAREST),l===!0&&(le.length=0,De.length=0,le.push(i.COLOR_ATTACHMENT0+me),T.depthBuffer&&T.storeMultisampledDepthBuffer===!1&&(le.push(ue),De.push(ue),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,De)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,le))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),j)for(let me=0;me<g.length;me++){t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.RENDERBUFFER,pe.__webglColorRenderbuffer[me]);const Ue=n.get(g[me]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.TEXTURE_2D,Ue,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,pe.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.storeMultisampledDepthBuffer===!1&&l){const g=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function Be(T){return Math.min(r.maxSamples,T.samples)}function ze(T){const g=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function C(T){const g=a.render.frame;u.get(T)!==g&&(u.set(T,g),T.update())}function $e(T,g){const O=T.colorSpace,W=T.format,$=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||O!==nr&&O!==""&&(tt.getTransfer(O)===ot?(W!==1023||$!==1009)&&He("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):rt("WebGLTextures: Unsupported texture color space:",O)),g}function qe(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=Q,this.resetTextureUnits=G,this.getTextureUnits=N,this.setTextureUnits=B,this.setTexture2D=oe,this.setTexture2DArray=Y,this.setTexture3D=ne,this.setTextureCube=te,this.rebindTextures=J,this.setupRenderTarget=he,this.updateRenderTargetMipmap=ae,this.updateMultisampleRenderTarget=Te,this.setupDepthRenderbuffer=Z,this.setupFrameBufferTexture=se,this.useMultisampledRTT=ze,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function xd(i,e){function t(n,r=""){let s;const a=tt.getTransfer(r);if(n===1009)return i.UNSIGNED_BYTE;if(n===1017)return i.UNSIGNED_SHORT_4_4_4_4;if(n===1018)return i.UNSIGNED_SHORT_5_5_5_1;if(n===35902)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===35899)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===1010)return i.BYTE;if(n===1011)return i.SHORT;if(n===1012)return i.UNSIGNED_SHORT;if(n===1013)return i.INT;if(n===1014)return i.UNSIGNED_INT;if(n===1015)return i.FLOAT;if(n===1016)return i.HALF_FLOAT;if(n===1021)return i.ALPHA;if(n===1022)return i.RGB;if(n===1023)return i.RGBA;if(n===1026)return i.DEPTH_COMPONENT;if(n===1027)return i.DEPTH_STENCIL;if(n===1028)return i.RED;if(n===1029)return i.RED_INTEGER;if(n===1030)return i.RG;if(n===1031)return i.RG_INTEGER;if(n===1033)return i.RGBA_INTEGER;if(n===33776||n===33777||n===33778||n===33779)if(a===ot)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===33776)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===33777)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===33778)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===33779)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===33776)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===33777)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===33778)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===33779)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===35840||n===35841||n===35842||n===35843)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===35840)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===35841)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===35842)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===35843)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===36196||n===37492||n===37496||n===37488||n===37489||n===37490||n===37491)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===36196||n===37492)return a===ot?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===37496)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===37488)return s.COMPRESSED_R11_EAC;if(n===37489)return s.COMPRESSED_SIGNED_R11_EAC;if(n===37490)return s.COMPRESSED_RG11_EAC;if(n===37491)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===37808||n===37809||n===37810||n===37811||n===37812||n===37813||n===37814||n===37815||n===37816||n===37817||n===37818||n===37819||n===37820||n===37821)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===37808)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===37809)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===37810)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===37811)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===37812)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===37813)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===37814)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===37815)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===37816)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===37817)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===37818)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===37819)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===37820)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===37821)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===36492||n===36494||n===36495)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===36492)return a===ot?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===36494)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===36495)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===36283||n===36284||n===36285||n===36286)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===36283)return s.COMPRESSED_RED_RGTC1_EXT;if(n===36284)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===36285)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===36286)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===1020?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const vd=`
void main() {
