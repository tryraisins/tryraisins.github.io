...
`)}const Ef={1:"Linear",2:"Reinhard",3:"Cineon",4:"ACESFilmic",6:"AgX",7:"Neutral",5:"Custom"};function Tf(i,e){const t=Ef[e];return t===void 0?(He("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ki=new O;function bf(){tt.getLuminanceCoefficients(Ki);const i=Ki.x.toFixed(4),e=Ki.y.toFixed(4),t=Ki.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);const R=T+m+a,S=T+p+o,b=ta(r,r.VERTEX_SHADER,R),y=ta(r,r.FRAGMENT_SHADER,S);r.attachShader(M,b),r.attachShader(M,y),t.index0AttributeName!==void 0?r.bindAttribLocation(M,0,t.index0AttributeName):t.hasPositionAttribute===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function w(N){if(i.debug.checkShaderErrors){const G=r.getProgramInfoLog(M)||"",k=r.getShaderInfoLog(b)||"",D=r.getShaderInfoLog(y)||"",z=G.trim(),$=k.trim(),q=D.trim();let ae=!0,Z=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(ae=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,M,b,y);else{const ne=ia(r,b,"vertex"),ie=ia(r,y,"fragment");rt("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
Program Info Log: `+z+`
`+ne+`
`+ie)}else z!==""?He("WebGLProgram: Program Info Log:",z):($===""||q==="")&&(Z=!1);Z&&(N.diagnostics={runnable:ae,programLog:z,vertexShader:{log:$,prefix:m},fragmentShader:{log:q,prefix:p}})}r.deleteShader(b),r.deleteShader(y),x=new Qi(r,M),A=wf(r,M)}let x;this.getUniforms=function(){return x===void 0&&w(this),x};let A;this.getAttributes=function(){return A===void 0&&w(this),A};let P=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return P===!1&&(P=r.getProgramParameter(M,xf)),P},this.destroy=function(){n.releaseStatesOfProgram(this),r.deleteProgram(M),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=vf++,this.cacheKey=e,this.usedTimes=1,this.program=M,this.vertexShader=b,this.fragmentShader=y,this}let Wf=0;class Xf{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,t,n){const r=this._getShaderCacheForMaterial(e);return r.has(t)===!1&&(r.add(t),t.usedTimes++),r.has(n)===!1&&(r.add(n),n.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new qf(e),t.set(e,n)),n}}class qf{constructor(e){this.id=Wf++,this.code=e,this.usedTimes=0}}function Yf(i){return i===1030||i===37490||i===36285}function Zf(i,e,t,n,r,s){const a=new ma,o=new Xf,c=new Set,l=[],u=new Map,d=n.logarithmicDepthBuffer;let h=n.precision;const f={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(x){return c.add(x),x===0?"uv":`uv${x}`}function M(x,A,P,N,G,k){const D=N.fog,z=G.geometry,$=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?N.environment:null,q=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,ae=e.get(x.envMap||$,q),Z=ae&&ae.mapping===306?ae.image.height:null,ne=f[x.type];x.precision!==null&&(h=n.getMaxPrecision(x.precision),h!==x.precision&&He("WebGLProgram.getParameters:",x.precision,"not supported, using",h,"instead."));const ie=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,De=ie!==void 0?ie.length:0;let Ae=0;z.morphAttributes.position!==void 0&&(Ae=1),z.morphAttributes.normal!==void 0&&(Ae=2),z.morphAttributes.color!==void 0&&(Ae=3);let nt,Ye,je,J;if(ne){const ut=$t[ne];nt=ut.vertexShader,Ye=ut.fragmentShader}else{nt=x.vertexShader,Ye=x.fragmentShader;const ut=o.getVertexShaderStage(x),st=o.getFragmentShaderStage(x);o.update(x,ut,st),je=ut.id,J=st.id}const L=i.getRenderTarget(),F=i.state.buffers.depth.getReversed(),ce=G.isInstancedMesh===!0,le=G.isBatchedMesh===!0,Me=!!x.map,Ve=!!x.matcap,X=!!ae,ee=!!x.aoMap,se=!!x.lightMap,te=!!x.bumpMap&&x.wireframe===!1,he=!!x.normalMap,Te=!!x.displacementMap,be=!!x.emissiveMap,Be=!!x.metalnessMap,Ge=!!x.roughnessMap,C=x.anisotropy>0,et=x.clearcoat>0,Xe=x.dispersion>0,E=x.retroreflectivity>0,g=x.iridescence>0,B=x.sheen>0,W=x.transmission>0,K=C&&!!x.anisotropyMap,ue=et&&!!x.clearcoatMap,de=et&&!!x.clearcoatNormalMap,Q=et&&!!x.clearcoatRoughnessMap,re=g&&!!x.iridescenceMap,pe=g&&!!x.iridescenceThicknessMap,Ue=B&&!!x.sheenColorMap,xe=B&&!!x.sheenRoughnessMap,me=!!x.specularMap,Fe=!!x.specularColorMap,ze=!!x.specularIntensityMap,qe=W&&!!x.transmissionMap,U=W&&!!x.thicknessMap,ge=!!x.gradientMap,j=!!x.alphaMap,_e=x.alphaTest>0,Ee=!!x.alphaHash,oe=!!x.extensions;let Oe=0;x.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(Oe=i.toneMapping);const Ie={shaderID:ne,shaderType:x.type,shaderName:x.name,vertexShader:nt,fragmentShader:Ye,defines:x.defines,customVertexShaderID:je,customFragmentShaderID:J,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:h,batching:le,batchingColor:le&&G._colorsTexture!==null,instancing:ce,instancingColor:ce&&G.instanceColor!==null,instancingMorph:ce&&G.morphTexture!==null,outputColorSpace:L===null?i.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:tt.workingColorSpace,alphaToCoverage:!!x.alphaToCoverage,map:Me,matcap:Ve,envMap:X,envMapMode:X&&ae.mapping,envMapCubeUVHeight:Z,aoMap:ee,lightMap:se,bumpMap:te,normalMap:he,displacementMap:Te,emissiveMap:be,normalMapObjectSpace:he&&x.normalMapType===1,normalMapTangentSpace:he&&x.normalMapType===0,packedNormalMap:he&&x.normalMapType===0&&Yf(x.normalMap.format),metalnessMap:Be,roughnessMap:Ge,anisotropy:C,anisotropyMap:K,clearcoat:et,clearcoatMap:ue,clearcoatNormalMap:de,clearcoatRoughnessMap:Q,dispersion:Xe,retroreflection:E,iridescence:g,iridescenceMap:re,iridescenceThicknessMap:pe,sheen:B,sheenColorMap:Ue,sheenRoughnessMap:xe,specularMap:me,specularColorMap:Fe,specularIntensityMap:ze,transmission:W,transmissionMap:qe,thicknessMap:U,gradientMap:ge,opaque:x.transparent===!1&&x.blending===1&&x.alphaToCoverage===!1,alphaMap:j,alphaTest:_e,alphaHash:Ee,combine:x.combine,mapUv:Me&&_(x.map.channel),aoMapUv:ee&&_(x.aoMap.channel),lightMapUv:se&&_(x.lightMap.channel),bumpMapUv:te&&_(x.bumpMap.channel),normalMapUv:he&&_(x.normalMap.channel),displacementMapUv:Te&&_(x.displacementMap.channel),emissiveMapUv:be&&_(x.emissiveMap.channel),metalnessMapUv:Be&&_(x.metalnessMap.channel),roughnessMapUv:Ge&&_(x.roughnessMap.channel),anisotropyMapUv:K&&_(x.anisotropyMap.channel),clearcoatMapUv:ue&&_(x.clearcoatMap.channel),clearcoatNormalMapUv:de&&_(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Q&&_(x.clearcoatRoughnessMap.channel),iridescenceMapUv:re&&_(x.iridescenceMap.channel),iridescenceThicknessMapUv:pe&&_(x.iridescenceThicknessMap.channel),sheenColorMapUv:Ue&&_(x.sheenColorMap.channel),sheenRoughnessMapUv:xe&&_(x.sheenRoughnessMap.channel),specularMapUv:me&&_(x.specularMap.channel),specularColorMapUv:Fe&&_(x.specularColorMap.channel),specularIntensityMapUv:ze&&_(x.specularIntensityMap.channel),transmissionMapUv:qe&&_(x.transmissionMap.channel),thicknessMapUv:U&&_(x.thicknessMap.channel),alphaMapUv:j&&_(x.alphaMap.channel),vertexTangents:!!z.attributes.tangent&&(he||C),vertexNormals:!!z.attributes.normal,vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,pointsUvs:G.isPoints===!0&&!!z.attributes.uv&&(Me||j),fog:!!D,useFog:x.fog===!0,fogExp2:!!D&&D.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||z.attributes.normal===void 0&&he===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:F,skinning:G.isSkinnedMesh===!0,hasPositionAttribute:z.attributes.position!==void 0,morphTargets:z.morphAttributes.position!==void 0,morphNormals:z.morphAttributes.normal!==void 0,morphColors:z.morphAttributes.color!==void 0,morphTargetsCount:De,morphTextureStride:Ae,numSunLights:A.sun.length,numDirLights:A.directional.length,numPointLights:A.point.length,numSpotLights:A.spot.length,numSpotLightMaps:A.spotLightMap.length,numRectAreaLights:A.rectArea.length,numHemiLights:A.hemi.length,numSunLightShadows:A.sunShadowMap.length,numDirLightShadows:A.directionalShadowMap.length,numPointLightShadows:A.pointShadowMap.length,numSpotLightShadows:A.spotShadowMap.length,numSpotLightShadowsWithMaps:A.numSpotLightShadowsWithMaps,numLightProbes:A.numLightProbes,numLightProbeGrids:k.length,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:x.dithering,shadowMapEnabled:i.shadowMap.enabled&&P.length>0,shadowMapType:i.shadowMap.type,toneMapping:Oe,decodeVideoTexture:Me&&x.map.isVideoTexture===!0&&tt.getTransfer(x.map.colorSpace)===ot,decodeVideoTextureEmissive:be&&x.emissiveMap.isVideoTexture===!0&&tt.getTransfer(x.emissiveMap.colorSpace)===ot,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===2,flipSided:x.side===1,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:oe&&x.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(oe&&x.extensions.multiDraw===!0||le)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return Ie.vertexUv1s=c.has(1),Ie.vertexUv2s=c.has(2),Ie.vertexUv3s=c.has(3),c.clear(),Ie}function m(x){const A=[];if(x.shaderID?A.push(x.shaderID):(A.push(x.customVertexShaderID),A.push(x.customFragmentShaderID)),x.defines!==void 0)for(const P in x.defines)A.push(P),A.push(x.defines[P]);return x.isRawShaderMaterial===!1&&(p(A,x),T(A,x),A.push(i.outputColorSpace)),A.push(x.customProgramCacheKey),A.join()}function p(x,A){x.push(A.precision),x.push(A.outputColorSpace),x.push(A.envMapMode),x.push(A.envMapCubeUVHeight),x.push(A.mapUv),x.push(A.alphaMapUv),x.push(A.lightMapUv),x.push(A.aoMapUv),x.push(A.bumpMapUv),x.push(A.normalMapUv),x.push(A.displacementMapUv),x.push(A.emissiveMapUv),x.push(A.metalnessMapUv),x.push(A.roughnessMapUv),x.push(A.anisotropyMapUv),x.push(A.clearcoatMapUv),x.push(A.clearcoatNormalMapUv),x.push(A.clearcoatRoughnessMapUv),x.push(A.iridescenceMapUv),x.push(A.iridescenceThicknessMapUv),x.push(A.sheenColorMapUv),x.push(A.sheenRoughnessMapUv),x.push(A.specularMapUv),x.push(A.specularColorMapUv),x.push(A.specularIntensityMapUv),x.push(A.transmissionMapUv),x.push(A.thicknessMapUv),x.push(A.combine),x.push(A.fogExp2),x.push(A.sizeAttenuation),x.push(A.morphTargetsCount),x.push(A.morphAttributeCount),x.push(A.numSunLights),x.push(A.numDirLights),x.push(A.numPointLights),x.push(A.numSpotLights),x.push(A.numSpotLightMaps),x.push(A.numHemiLights),x.push(A.numRectAreaLights),x.push(A.numSunLightShadows),x.push(A.numDirLightShadows),x.push(A.numPointLightShadows),x.push(A.numSpotLightShadows),x.push(A.numSpotLightShadowsWithMaps),x.push(A.numLightProbes),x.push(A.shadowMapType),x.push(A.toneMapping),x.push(A.numClippingPlanes),x.push(A.numClipIntersection),x.push(A.depthPacking)}function T(x,A){a.disableAll(),A.instancing&&a.enable(0),A.instancingColor&&a.enable(1),A.instancingMorph&&a.enable(2),A.matcap&&a.enable(3),A.envMap&&a.enable(4),A.normalMapObjectSpace&&a.enable(5),A.normalMapTangentSpace&&a.enable(6),A.clearcoat&&a.enable(7),A.iridescence&&a.enable(8),A.alphaTest&&a.enable(9),A.vertexColors&&a.enable(10),A.vertexAlphas&&a.enable(11),A.vertexUv1s&&a.enable(12),A.vertexUv2s&&a.enable(13),A.vertexUv3s&&a.enable(14),A.vertexTangents&&a.enable(15),A.anisotropy&&a.enable(16),A.alphaHash&&a.enable(17),A.batching&&a.enable(18),A.dispersion&&a.enable(19),A.retroreflection&&a.enable(24),A.batchingColor&&a.enable(20),A.gradientMap&&a.enable(21),A.packedNormalMap&&a.enable(22),A.vertexNormals&&a.enable(23),x.push(a.mask),a.disableAll(),A.fog&&a.enable(0),A.useFog&&a.enable(1),A.flatShading&&a.enable(2),A.logarithmicDepthBuffer&&a.enable(3),A.reversedDepthBuffer&&a.enable(4),A.skinning&&a.enable(5),A.morphTargets&&a.enable(6),A.morphNormals&&a.enable(7),A.morphColors&&a.enable(8),A.premultipliedAlpha&&a.enable(9),A.shadowMapEnabled&&a.enable(10),A.doubleSided&&a.enable(11),A.flipSided&&a.enable(12),A.useDepthPacking&&a.enable(13),A.dithering&&a.enable(14),A.transmission&&a.enable(15),A.sheen&&a.enable(16),A.opaque&&a.enable(17),A.pointsUvs&&a.enable(18),A.decodeVideoTexture&&a.enable(19),A.decodeVideoTextureEmissive&&a.enable(20),A.alphaToCoverage&&a.enable(21),A.numLightProbeGrids>0&&a.enable(22),A.hasPositionAttribute&&a.enable(23),x.push(a.mask)}function R(x){const A=f[x.type];let P;if(A){const N=$t[A];P=cl.clone(N.uniforms)}else P=x.uniforms;return P}function S(x,A){let P=u.get(A);return P!==void 0?++P.usedTimes:(P=new kf(i,A,x,r),l.push(P),u.set(A,P)),P}function b(x){if(--x.usedTimes===0){const A=l.indexOf(x);l[A]=l[l.length-1],l.pop(),u.delete(x.cacheKey),x.destroy()}}function y(x){o.remove(x)}function w(){o.dispose()}return{getParameters:M,getProgramCacheKey:m,getUniforms:R,acquireProgram:S,releaseProgram:b,releaseShaderCache:y,programs:l,dispose:w}}function Jf(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function r(a,o,c){i.get(a)[o]=c}function s(){i=new WeakMap}return{has:e,get:t,remove:n,update:r,dispose:s}}function Kf(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.materialVariant!==e.materialVariant?i.materialVariant-e.materialVariant:i.z!==e.z?i.z-e.z:i.id-e.id}function la(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function ca(){const i=[];let e=0;const t=[],n=[],r=[];function s(){e=0,t.length=0,n.length=0,r.length=0}function a(h){let f=0;return h.isInstancedMesh&&(f+=2),h.isSkinnedMesh&&(f+=1),f}function o(h,f,_,M,m,p){let T=i[e];return T===void 0?(T={id:h.id,object:h,geometry:f,material:_,materialVariant:a(h),groupOrder:M,renderOrder:h.renderOrder,z:m,group:p},i[e]=T):(T.id=h.id,T.object=h,T.geometry=f,T.material=_,T.materialVariant=a(h),T.groupOrder=M,T.renderOrder=h.renderOrder,T.z=m,T.group=p),e++,T}function c(h,f,_,M,m,p,T){T.reversedDepth===!0&&(m=-m);const R=o(h,f,_,M,m,p);_.transmission>0?n.push(R):_.transparent===!0?r.push(R):t.push(R)}function l(h,f,_,M,m,p){const T=o(h,f,_,M,m,p);_.transmission>0?n.unshift(T):_.transparent===!0?r.unshift(T):t.unshift(T)}function u(h,f){t.length>1&&t.sort(h||Kf),n.length>1&&n.sort(f||la),r.length>1&&r.sort(f||la)}function d(){for(let h=e,f=i.length;h<f;h++){const _=i[h];if(_.id===null)break;_.id=null,_.object=null,_.geometry=null,_.material=null,_.group=null}}return{opaque:t,transmissive:n,transparent:r,init:s,push:c,unshift:l,finish:d,sort:u}}function $f(){let i=new WeakMap;function e(n,r){const s=i.get(n);let a;return s===void 0?(a=new ca,i.set(n,[a])):r>=s.length?(a=new ca,s.push(a)):a=s[r],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function Qf(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"SunLight":case"DirectionalLight":t={direction:new O,color:new Qe};break;case"SpotLight":t={position:new O,direction:new O,color:new Qe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new O,color:new Qe,distance:0,decay:0};break;case"HemisphereLight":t={direction:new O,skyColor:new Qe,groundColor:new Qe};break;case"RectAreaLight":t={color:new Qe,position:new O,halfWidth:new O,halfHeight:new O};break}return i[e.id]=t,t}}}function jf(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"SunLight":case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new fe};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new fe};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new fe,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let ed=0;function td(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function nd(i){const e=new Qf,t=jf(),n={version:0,hash:{sunLength:-1,directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numSunShadows:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],sun:[],sunShadow:[],sunShadowMap:[],sunShadowMatrix:[],sunShadowCascade:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new O);const r=new O,s=new ht,a=new ht;function o(l){let u=0,d=0,h=0;for(let G=0;G<9;G++)n.probe[G].set(0,0,0);let f=0,_=0,M=0,m=0,p=0,T=0,R=0,S=0,b=0,y=0,w=0,x=0,A=0,P=0;l.sort(td);for(let G=0,k=l.length;G<k;G++){const D=l[G],z=D.color,$=D.intensity,q=D.distance;let ae=null;if(D.shadow&&D.shadow.map&&(D.shadow.map.texture.format===1030?ae=D.shadow.map.texture:ae=D.shadow.map.depthTexture||D.shadow.map.texture),D.isAmbientLight)u+=z.r*$,d+=z.g*$,h+=z.b*$;else if(D.isLightProbe){for(let Z=0;Z<9;Z++)n.probe[Z].addScaledVector(D.sh.coefficients[Z],$);P++}else if(D.isSunLight){const Z=e.get(D);if(Z.color.copy(D.color).multiplyScalar(D.intensity),D.castShadow){const ne=D.shadow,ie=t.get(D);ie.shadowIntensity=ne.intensity,ie.shadowBias=ne.bias,ie.shadowNormalBias=ne.normalBias,ie.shadowRadius=ne.radius,ie.shadowMapSize.copy(ne.mapSize).multiply(ne.getFrameExtents()),n.sunShadow[_]=ie,n.sunShadowMap[_]=ae;const De=ne.getViewportCount();for(let Ae=0;Ae<De;Ae++)n.sunShadowMatrix[M+Ae]=ne.getMatrix(Ae),n.sunShadowCascade[M+Ae]=ne._cascadeData[Ae];M+=De,_++}n.sun[f]=Z,f++}else if(D.isDirectionalLight){const Z=e.get(D);if(Z.color.copy(D.color).multiplyScalar(D.intensity),D.castShadow){const ne=D.shadow,ie=t.get(D);ie.shadowIntensity=ne.intensity,ie.shadowBias=ne.bias,ie.shadowNormalBias=ne.normalBias,ie.shadowRadius=ne.radius,ie.shadowMapSize=ne.mapSize,n.directionalShadow[m]=ie,n.directionalShadowMap[m]=ae,n.directionalShadowMatrix[m]=D.shadow.matrix,b++}n.directional[m]=Z,m++}else if(D.isSpotLight){const Z=e.get(D);Z.position.setFromMatrixPosition(D.matrixWorld),Z.color.copy(z).multiplyScalar($),Z.distance=q,Z.coneCos=Math.cos(D.angle),Z.penumbraCos=Math.cos(D.angle*(1-D.penumbra)),Z.decay=D.decay,n.spot[T]=Z;const ne=D.shadow;if(D.map&&(n.spotLightMap[x]=D.map,x++,ne.updateMatrices(D),D.castShadow&&A++),n.spotLightMatrix[T]=ne.matrix,D.castShadow){const ie=t.get(D);ie.shadowIntensity=ne.intensity,ie.shadowBias=ne.bias,ie.shadowNormalBias=ne.normalBias,ie.shadowRadius=ne.radius,ie.shadowMapSize=ne.mapSize,n.spotShadow[T]=ie,n.spotShadowMap[T]=ae,w++}T++}else if(D.isRectAreaLight){const Z=e.get(D);Z.color.copy(z).multiplyScalar($),Z.halfWidth.set(D.width*.5,0,0),Z.halfHeight.set(0,D.height*.5,0),n.rectArea[R]=Z,R++}else if(D.isPointLight){const Z=e.get(D);if(Z.color.copy(D.color).multiplyScalar(D.intensity),Z.distance=D.distance,Z.decay=D.decay,D.castShadow){const ne=D.shadow,ie=t.get(D);ie.shadowIntensity=ne.intensity,ie.shadowBias=ne.bias,ie.shadowNormalBias=ne.normalBias,ie.shadowRadius=ne.radius,ie.shadowMapSize=ne.mapSize,ie.shadowCameraNear=ne.camera.near,ie.shadowCameraFar=ne.camera.far,n.pointShadow[p]=ie,n.pointShadowMap[p]=ae,n.pointShadowMatrix[p]=D.shadow.matrix,y++}n.point[p]=Z,p++}else if(D.isHemisphereLight){const Z=e.get(D);Z.skyColor.copy(D.color).multiplyScalar($),Z.groundColor.copy(D.groundColor).multiplyScalar($),n.hemi[S]=Z,S++}}R>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ve.LTC_FLOAT_1,n.rectAreaLTC2=ve.LTC_FLOAT_2):(n.rectAreaLTC1=ve.LTC_HALF_1,n.rectAreaLTC2=ve.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=d,n.ambient[2]=h;const N=n.hash;(N.sunLength!==f||N.directionalLength!==m||N.pointLength!==p||N.spotLength!==T||N.rectAreaLength!==R||N.hemiLength!==S||N.numSunShadows!==_||N.numDirectionalShadows!==b||N.numPointShadows!==y||N.numSpotShadows!==w||N.numSpotMaps!==x||N.numLightProbes!==P)&&(n.sun.length=f,n.directional.length=m,n.spot.length=T,n.rectArea.length=R,n.point.length=p,n.hemi.length=S,n.sunShadow.length=_,n.sunShadowMap.length=_,n.sunShadowMatrix.length=M,n.sunShadowCascade.length=M,n.directionalShadow.length=b,n.directionalShadowMap.length=b,n.directionalShadowMatrix.length=b,n.pointShadow.length=y,n.pointShadowMap.length=y,n.pointShadowMatrix.length=y,n.spotShadow.length=w,n.spotShadowMap.length=w,n.spotLightMatrix.length=w+x-A,n.spotLightMap.length=x,n.numSpotLightShadowsWithMaps=A,n.numLightProbes=P,N.sunLength=f,N.directionalLength=m,N.pointLength=p,N.spotLength=T,N.rectAreaLength=R,N.hemiLength=S,N.numSunShadows=_,N.numDirectionalShadows=b,N.numPointShadows=y,N.numSpotShadows=w,N.numSpotMaps=x,N.numLightProbes=P,n.version=ed++)}function c(l,u){let d=0,h=0,f=0,_=0,M=0,m=0;const p=u.matrixWorldInverse;for(let T=0,R=l.length;T<R;T++){const S=l[T];if(S.isSunLight){const b=n.sun[d];b.direction.setFromMatrixPosition(S.matrixWorld),b.direction.transformDirection(p),d++}else if(S.isDirectionalLight){const b=n.directional[h];b.direction.setFromMatrixPosition(S.matrixWorld),r.setFromMatrixPosition(S.target.matrixWorld),b.direction.sub(r),b.direction.transformDirection(p),h++}else if(S.isSpotLight){const b=n.spot[_];b.position.setFromMatrixPosition(S.matrixWorld),b.position.applyMatrix4(p),b.direction.setFromMatrixPosition(S.matrixWorld),r.setFromMatrixPosition(S.target.matrixWorld),b.direction.sub(r),b.direction.transformDirection(p),_++}else if(S.isRectAreaLight){const b=n.rectArea[M];b.position.setFromMatrixPosition(S.matrixWorld),b.position.applyMatrix4(p),a.identity(),s.copy(S.matrixWorld),s.premultiply(p),a.extractRotation(s),b.halfWidth.set(S.width*.5,0,0),b.halfHeight.set(0,S.height*.5,0),b.halfWidth.applyMatrix4(a),b.halfHeight.applyMatrix4(a),M++}else if(S.isPointLight){const b=n.point[f];b.position.setFromMatrixPosition(S.matrixWorld),b.position.applyMatrix4(p),f++}else if(S.isHemisphereLight){const b=n.hemi[m];b.direction.setFromMatrixPosition(S.matrixWorld),b.direction.transformDirection(p),m++}}}return{setup:o,setupView:c,state:n}}function ha(i){const e=new nd(i),t=[],n=[],r=[];function s(h){d.camera=h,t.length=0,n.length=0,r.length=0}function a(h){t.push(h)}function o(h){n.push(h)}function c(h){r.push(h)}function l(){e.setup(t)}function u(h){e.setupView(t,h)}const d={lightsArray:t,shadowsArray:n,lightProbeGridArray:r,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:s,state:d,setupLights:l,setupLightsView:u,pushLight:a,pushShadow:o,pushLightProbeGrid:c}}function id(i){let e=new WeakMap;function t(r,s=0){const a=e.get(r);let o;return a===void 0?(o=new ha(i),e.set(r,[o])):s>=a.length?(o=new ha(i),a.push(o)):o=a[s],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const rd=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,ad=[new O(1,0,0),new O(-1,0,0),new O(0,1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1)],od=[new O(0,-1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1),new O(0,-1,0),new O(0,-1,0)],ua=new ht,di=new O,Gr=new O;function ld(i,e,t){let n=new Jr;const r=new fe,s=new fe,a=new pt,o=new pl,c=new ml,l={},u=t.maxTextureSize,d={0:1,1:0,2:2},h=new jt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new fe},radius:{value:4}},vertexShader:rd,fragmentShader:sd}),f=h.clone();f.defines.HORIZONTAL_PASS=1;const _=new It;_.setAttribute("position",new Qt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new xt(_,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=1;let p=this.type;this.render=function(y,w,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||y.length===0)return;this.type===2&&(He("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=1);const A=i.getRenderTarget(),P=i.getActiveCubeFace(),N=i.getActiveMipmapLevel(),G=i.state;G.setBlending(0),G.buffers.depth.getReversed()===!0?G.buffers.color.setClear(0,0,0,0):G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const k=p!==this.type;k&&w.traverse(function(D){D.material&&(Array.isArray(D.material)?D.material.forEach(z=>z.needsUpdate=!0):D.material.needsUpdate=!0)});for(let D=0,z=y.length;D<z;D++){const $=y[D],q=$.shadow;if(q===void 0){He("WebGLShadowMap:",$,"has no shadow.");continue}if(q.autoUpdate===!1&&q.needsUpdate===!1)continue;r.copy(q.mapSize);const ae=q.getFrameExtents();r.multiply(ae),s.copy(q.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/ae.x),r.x=s.x*ae.x,q.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/ae.y),r.y=s.y*ae.y,q.mapSize.y=s.y));const Z=i.state.buffers.depth.getReversed();if(q.camera._reversedDepth=Z,q.map===null||k===!0){if(q.map!==null&&(q.map.depthTexture!==null&&(q.map.depthTexture.dispose(),q.map.depthTexture=null),q.map.dispose()),this.type===3){if($.isPointLight){He("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}q.map=new Xt(r.x,r.y,{format:1030,type:1016,minFilter:1006,magFilter:1006,generateMipmaps:!1}),q.map.texture.name=$.name+".shadowMap",q.map.depthTexture=new xi(r.x,r.y,1015),q.map.depthTexture.name=$.name+".shadowMapDepth",q.map.depthTexture.format=1026,q.map.depthTexture.compareFunction=null,q.map.depthTexture.minFilter=1003,q.map.depthTexture.magFilter=1003}else $.isPointLight?(q.map=new Ba(r.x),q.map.depthTexture=new Ro(r.x,1014)):(q.map=new Xt(r.x,r.y),q.map.depthTexture=new xi(r.x,r.y,1014)),q.map.depthTexture.name=$.name+".shadowMap",q.map.depthTexture.format=1026,this.type===1?(q.map.depthTexture.compareFunction=Z?518:515,q.map.depthTexture.minFilter=1006,q.map.depthTexture.magFilter=1006):(q.map.depthTexture.compareFunction=null,q.map.depthTexture.minFilter=1003,q.map.depthTexture.magFilter=1003);q.camera.updateProjectionMatrix()}q.map.isWebGLCubeRenderTarget!==!0&&(q.map.width!==r.x||q.map.height!==r.y)&&q.map.setSize(r.x,r.y);const ne=q.map.isWebGLCubeRenderTarget?6:q.getViewportCount();$.isPointLight!==!0&&q.updateMatrices($,x);for(let ie=0;ie<ne;ie++){const De=q.getCamera(ie);if($.isPointLight){const Ae=q.camera,nt=q.matrix,Ye=$.distance||Ae.far;Ye!==Ae.far&&(Ae.far=Ye,Ae.updateProjectionMatrix()),di.setFromMatrixPosition($.matrixWorld),Ae.position.copy(di),Gr.copy(Ae.position),Gr.add(ad[ie]),Ae.up.copy(od[ie]),Ae.lookAt(Gr),Ae.updateMatrixWorld(),nt.makeTranslation(-di.x,-di.y,-di.z),ua.multiplyMatrices(Ae.projectionMatrix,Ae.matrixWorldInverse),q._frustum.setFromProjectionMatrix(ua,Ae.coordinateSystem,Ae.reversedDepth)}if(q.map.isWebGLCubeRenderTarget)i.setRenderTarget(q.map,ie),i.clear();else{ie===0&&(i.setRenderTarget(q.map),i.clear());const Ae=q.getViewport(ie);a.set(s.x*Ae.x,s.y*Ae.y,s.x*Ae.z,s.y*Ae.w),G.viewport(a)}n=q.getFrustum(ie),S(w,x,De,$,this.type)}q.isPointLightShadow!==!0&&this.type===3&&T(q,x),q.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(A,P,N)};function T(y,w){const x=e.update(M);h.defines.VSM_SAMPLES!==y.blurSamples&&(h.defines.VSM_SAMPLES=y.blurSamples,f.defines.VSM_SAMPLES=y.blurSamples,h.needsUpdate=!0,f.needsUpdate=!0),y.mapPass===null?y.mapPass=new Xt(r.x,r.y,{format:1030,type:1016}):(y.mapPass.width!==y.map.width||y.mapPass.height!==y.map.height)&&y.mapPass.setSize(y.map.width,y.map.height),h.uniforms.shadow_pass.value=y.map.depthTexture,h.uniforms.resolution.value.set(y.map.width,y.map.height),h.uniforms.radius.value=y.radius,i.setRenderTarget(y.mapPass),i.clear(),i.renderBufferDirect(w,null,x,h,M,null),f.uniforms.shadow_pass.value=y.mapPass.texture,f.uniforms.resolution.value.set(y.map.width,y.map.height),f.uniforms.radius.value=y.radius,i.setRenderTarget(y.map),i.clear(),i.renderBufferDirect(w,null,x,f,M,null)}function R(y,w,x,A){let P=null;const N=x.isPointLight===!0?y.customDistanceMaterial:y.customDepthMaterial;if(N!==void 0)P=N;else if(P=x.isPointLight===!0?c:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const G=P.uuid,k=w.uuid;let D=l[G];D===void 0&&(D={},l[G]=D);let z=D[k];z===void 0&&(z=P.clone(),D[k]=z,w.addEventListener("dispose",b)),P=z}if(P.visible=w.visible,P.wireframe=w.wireframe,A===3?P.side=w.shadowSide!==null?w.shadowSide:w.side:P.side=w.shadowSide!==null?w.shadowSide:d[w.side],P.alphaMap=w.alphaMap,P.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,P.map=w.map,P.clipShadows=w.clipShadows,P.clippingPlanes=w.clippingPlanes,P.clipIntersection=w.clipIntersection,P.displacementMap=w.displacementMap,P.displacementScale=w.displacementScale,P.displacementBias=w.displacementBias,P.wireframeLinewidth=w.wireframeLinewidth,P.linewidth=w.linewidth,x.isPointLight===!0&&P.isMeshDistanceMaterial===!0){const G=i.properties.get(P);G.light=x}return P}function S(y,w,x,A,P){if(y.visible===!1)return;if(y.layers.test(w.layers)&&(y.isMesh||y.isLine||y.isPoints)&&(y.castShadow||y.receiveShadow&&P===3)&&(!y.frustumCulled||y.intersectsFrustum(n))){y.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,y.matrixWorld);const k=e.update(y),D=y.material;if(Array.isArray(D)){const z=k.groups;for(let $=0,q=z.length;$<q;$++){const ae=z[$],Z=D[ae.materialIndex];if(Z&&Z.visible){const ne=R(y,Z,A,P);y.onBeforeShadow(i,y,w,x,k,ne,ae),i.renderBufferDirect(x,null,k,ne,y,ae),y.onAfterShadow(i,y,w,x,k,ne,ae)}}}else if(D.visible){const z=R(y,D,A,P);y.onBeforeShadow(i,y,w,x,k,z,null),i.renderBufferDirect(x,null,k,z,y,null),y.onAfterShadow(i,y,w,x,k,z,null)}}const G=y.children;for(let k=0,D=G.length;k<D;k++)S(G[k],w,x,A,P)}function b(y){y.target.removeEventListener("dispose",b);for(const x in l){const A=l[x],P=y.target.uuid;P in A&&(A[P].dispose(),delete A[P])}}}function cd(i,e){function t(){let U=!1;const ge=new pt;let j=null;const _e=new pt(0,0,0,0);return{setMask:function(Ee){j!==Ee&&!U&&(i.colorMask(Ee,Ee,Ee,Ee),j=Ee)},setLocked:function(Ee){U=Ee},setClear:function(Ee,oe,Oe,Ie,ut){ut===!0&&(Ee*=Ie,oe*=Ie,Oe*=Ie),ge.set(Ee,oe,Oe,Ie),_e.equals(ge)===!1&&(i.clearColor(Ee,oe,Oe,Ie),_e.copy(ge))},reset:function(){U=!1,j=null,_e.set(-1,0,0,0)}}}function n(){let U=!1,ge=!1,j=null,_e=null,Ee=null;return{setReversed:function(oe){if(ge!==oe){const Oe=e.get("EXT_clip_control");oe?Oe.clipControlEXT(Oe.LOWER_LEFT_EXT,Oe.ZERO_TO_ONE_EXT):Oe.clipControlEXT(Oe.LOWER_LEFT_EXT,Oe.NEGATIVE_ONE_TO_ONE_EXT),ge=oe;const Ie=Ee;Ee=null,this.setClear(Ie)}},getReversed:function(){return ge},setTest:function(oe){oe?L(i.DEPTH_TEST):F(i.DEPTH_TEST)},setMask:function(oe){j!==oe&&!U&&(i.depthMask(oe),j=oe)},setFunc:function(oe){if(ge&&(oe=eo[oe]),_e!==oe){switch(oe){case 0:i.depthFunc(i.NEVER);break;case 1:i.depthFunc(i.ALWAYS);break;case 2:i.depthFunc(i.LESS);break;case 3:i.depthFunc(i.LEQUAL);break;case 4:i.depthFunc(i.EQUAL);break;case 5:i.depthFunc(i.GEQUAL);break;case 6:i.depthFunc(i.GREATER);break;case 7:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}_e=oe}},setLocked:function(oe){U=oe},setClear:function(oe){Ee!==oe&&(Ee=oe,ge&&(oe=1-oe),i.clearDepth(oe))},reset:function(){U=!1,j=null,_e=null,Ee=null,ge=!1}}}function r(){let U=!1,ge=null,j=null,_e=null,Ee=null,oe=null,Oe=null,Ie=null,ut=null;return{setTest:function(st){U||(st?L(i.STENCIL_TEST):F(i.STENCIL_TEST))},setMask:function(st){ge!==st&&!U&&(i.stencilMask(st),ge=st)},setFunc:function(st,zt,qt){(j!==st||_e!==zt||Ee!==qt)&&(i.stencilFunc(st,zt,qt),j=st,_e=zt,Ee=qt)},setOp:function(st,zt,qt){(oe!==st||Oe!==zt||Ie!==qt)&&(i.stencilOp(st,zt,qt),oe=st,Oe=zt,Ie=qt)},setLocked:function(st){U=st},setClear:function(st){ut!==st&&(i.clearStencil(st),ut=st)},reset:function(){U=!1,ge=null,j=null,_e=null,Ee=null,oe=null,Oe=null,Ie=null,ut=null}}}const s=new t,a=new n,o=new r,c=new WeakMap,l=new WeakMap;let u={},d={},h={},f=new WeakMap,_=[],M=null,m=!1,p=null,T=null,R=null,S=null,b=null,y=null,w=null,x=new Qe(0,0,0),A=0,P=!1,N=null,G=null,k=null,D=null,z=null;const $=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let q=!1,ae=0;const Z=i.getParameter(i.VERSION);Z.indexOf("WebGL")!==-1?(ae=parseFloat(/^WebGL (\d)/.exec(Z)[1]),q=ae>=1):Z.indexOf("OpenGL ES")!==-1&&(ae=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),q=ae>=2);let ne=null,ie={};const De=i.getParameter(i.SCISSOR_BOX),Ae=i.getParameter(i.VIEWPORT),nt=new pt().fromArray(De),Ye=new pt().fromArray(Ae);function je(U,ge,j,_e){const Ee=new Uint8Array(4),oe=i.createTexture();i.bindTexture(U,oe),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Oe=0;Oe<j;Oe++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(ge,0,i.RGBA,1,1,_e,0,i.RGBA,i.UNSIGNED_BYTE,Ee):i.texImage2D(ge+Oe,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Ee);return oe}const J={};J[i.TEXTURE_2D]=je(i.TEXTURE_2D,i.TEXTURE_2D,1),J[i.TEXTURE_CUBE_MAP]=je(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),J[i.TEXTURE_2D_ARRAY]=je(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),J[i.TEXTURE_3D]=je(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),L(i.DEPTH_TEST),a.setFunc(3),te(!1),he(1),L(i.CULL_FACE),ee(0);function L(U){u[U]!==!0&&(i.enable(U),u[U]=!0)}function F(U){u[U]!==!1&&(i.disable(U),u[U]=!1)}function ce(U,ge){return h[U]!==ge?(i.bindFramebuffer(U,ge),h[U]=ge,U===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ge),U===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ge),!0):!1}function le(U,ge){let j=_,_e=!1;if(U){j=f.get(ge),j===void 0&&(j=[],f.set(ge,j));const Ee=U.textures;if(j.length!==Ee.length||j[0]!==i.COLOR_ATTACHMENT0){for(let oe=0,Oe=Ee.length;oe<Oe;oe++)j[oe]=i.COLOR_ATTACHMENT0+oe;j.length=Ee.length,_e=!0}}else j[0]!==i.BACK&&(j[0]=i.BACK,_e=!0);_e&&i.drawBuffers(j)}function Me(U){return M!==U?(i.useProgram(U),M=U,!0):!1}const Ve={100:i.FUNC_ADD,101:i.FUNC_SUBTRACT,102:i.FUNC_REVERSE_SUBTRACT};Ve[103]=i.MIN,Ve[104]=i.MAX;const X={200:i.ZERO,201:i.ONE,202:i.SRC_COLOR,204:i.SRC_ALPHA,210:i.SRC_ALPHA_SATURATE,208:i.DST_COLOR,206:i.DST_ALPHA,203:i.ONE_MINUS_SRC_COLOR,205:i.ONE_MINUS_SRC_ALPHA,209:i.ONE_MINUS_DST_COLOR,207:i.ONE_MINUS_DST_ALPHA,211:i.CONSTANT_COLOR,212:i.ONE_MINUS_CONSTANT_COLOR,213:i.CONSTANT_ALPHA,214:i.ONE_MINUS_CONSTANT_ALPHA};function ee(U,ge,j,_e,Ee,oe,Oe,Ie,ut,st){if(U===0){m===!0&&(F(i.BLEND),m=!1);return}if(m===!1&&(L(i.BLEND),m=!0),U!==5){if(U!==p||st!==P){if((T!==100||b!==100)&&(i.blendEquation(i.FUNC_ADD),T=100,b=100),st)switch(U){case 1:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case 2:i.blendFunc(i.ONE,i.ONE);break;case 3:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case 4:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:rt("WebGLState: Invalid blending: ",U);break}else switch(U){case 1:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case 2:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case 3:rt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case 4:rt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:rt("WebGLState: Invalid blending: ",U);break}R=null,S=null,y=null,w=null,x.set(0,0,0),A=0,p=U,P=st}return}Ee=Ee||ge,oe=oe||j,Oe=Oe||_e,(ge!==T||Ee!==b)&&(i.blendEquationSeparate(Ve[ge],Ve[Ee]),T=ge,b=Ee),(j!==R||_e!==S||oe!==y||Oe!==w)&&(i.blendFuncSeparate(X[j],X[_e],X[oe],X[Oe]),R=j,S=_e,y=oe,w=Oe),(Ie.equals(x)===!1||ut!==A)&&(i.blendColor(Ie.r,Ie.g,Ie.b,ut),x.copy(Ie),A=ut),p=U,P=!1}function se(U,ge){U.side===2?F(i.CULL_FACE):L(i.CULL_FACE);let j=U.side===1;ge&&(j=!j),te(j),U.blending===1&&U.transparent===!1?ee(0):ee(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),a.setFunc(U.depthFunc),a.setTest(U.depthTest),a.setMask(U.depthWrite),s.setMask(U.colorWrite);const _e=U.stencilWrite;o.setTest(_e),_e&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),be(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?L(i.SAMPLE_ALPHA_TO_COVERAGE):F(i.SAMPLE_ALPHA_TO_COVERAGE)}function te(U){N!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),N=U)}function he(U){U!==0?(L(i.CULL_FACE),U!==G&&(U===1?i.cullFace(i.BACK):U===2?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):F(i.CULL_FACE),G=U}function Te(U){U!==k&&(q&&i.lineWidth(U),k=U)}function be(U,ge,j){U?(L(i.POLYGON_OFFSET_FILL),(D!==ge||z!==j)&&(D=ge,z=j,a.getReversed()&&(ge=-ge),i.polygonOffset(ge,j))):F(i.POLYGON_OFFSET_FILL)}function Be(U){U?L(i.SCISSOR_TEST):F(i.SCISSOR_TEST)}function Ge(U){U===void 0&&(U=i.TEXTURE0+$-1),ne!==U&&(i.activeTexture(U),ne=U)}function C(U,ge,j){j===void 0&&(ne===null?j=i.TEXTURE0+$-1:j=ne);let _e=ie[j];_e===void 0&&(_e={type:void 0,texture:void 0},ie[j]=_e),(_e.type!==U||_e.texture!==ge)&&(ne!==j&&(i.activeTexture(j),ne=j),i.bindTexture(U,ge||J[U]),_e.type=U,_e.texture=ge)}function et(){const U=ie[ne];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function Xe(){try{i.compressedTexImage2D(...arguments)}catch(U){rt("WebGLState:",U)}}function E(){try{i.compressedTexImage3D(...arguments)}catch(U){rt("WebGLState:",U)}}function g(){try{i.texSubImage2D(...arguments)}catch(U){rt("WebGLState:",U)}}function B(){try{i.texSubImage3D(...arguments)}catch(U){rt("WebGLState:",U)}}function W(){try{i.compressedTexSubImage2D(...arguments)}catch(U){rt("WebGLState:",U)}}function K(){try{i.compressedTexSubImage3D(...arguments)}catch(U){rt("WebGLState:",U)}}function ue(){try{i.texStorage2D(...arguments)}catch(U){rt("WebGLState:",U)}}function de(){try{i.texStorage3D(...arguments)}catch(U){rt("WebGLState:",U)}}function Q(){try{i.texImage2D(...arguments)}catch(U){rt("WebGLState:",U)}}function re(){try{i.texImage3D(...arguments)}catch(U){rt("WebGLState:",U)}}function pe(U){return d[U]!==void 0?d[U]:i.getParameter(U)}function Ue(U,ge){d[U]!==ge&&(i.pixelStorei(U,ge),d[U]=ge)}function xe(U){nt.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),nt.copy(U))}function me(U){Ye.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),Ye.copy(U))}function Fe(U,ge){let j=l.get(ge);j===void 0&&(j=new WeakMap,l.set(ge,j));let _e=j.get(U);_e===void 0&&(_e=i.getUniformBlockIndex(ge,U.name),j.set(U,_e))}function ze(U,ge){const _e=l.get(ge).get(U);c.get(ge)!==_e&&(i.uniformBlockBinding(ge,_e,U.__bindingPointIndex),c.set(ge,_e))}function qe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),u={},d={},ne=null,ie={},h={},f=new WeakMap,_=[],M=null,m=!1,p=null,T=null,R=null,S=null,b=null,y=null,w=null,x=new Qe(0,0,0),A=0,P=!1,N=null,G=null,k=null,D=null,z=null,nt.set(0,0,i.canvas.width,i.canvas.height),Ye.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:L,disable:F,bindFramebuffer:ce,drawBuffers:le,useProgram:Me,setBlending:ee,setMaterial:se,setFlipSided:te,setCullFace:he,setLineWidth:Te,setPolygonOffset:be,setScissorTest:Be,activeTexture:Ge,bindTexture:C,unbindTexture:et,compressedTexImage2D:Xe,compressedTexImage3D:E,texImage2D:Q,texImage3D:re,pixelStorei:Ue,getParameter:pe,updateUBOMapping:Fe,uniformBlockBinding:ze,texStorage2D:ue,texStorage3D:de,texSubImage2D:g,texSubImage3D:B,compressedTexSubImage2D:W,compressedTexSubImage3D:K,scissor:xe,viewport:me,reset:qe}}function hd(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new fe,u=new WeakMap,d=new Set;let h;const f=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(E,g){return _?new OffscreenCanvas(E,g):tr("canvas")}function m(E,g,B){let W=1;const K=Xe(E);if((K.width>B||K.height>B)&&(W=B/Math.max(K.width,K.height)),W<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const ue=Math.floor(W*K.width),de=Math.floor(W*K.height);h===void 0&&(h=M(ue,de));const Q=g?M(ue,de):h;return Q.width=ue,Q.height=de,Q.getContext("2d").drawImage(E,0,0,ue,de),He("WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+ue+"x"+de+")."),Q}else return"data"in E&&He("WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),E;return E}function p(E){return E.generateMipmaps}function T(E){i.generateMipmap(E)}function R(E){return E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?i.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function S(E,g,B,W,K,ue=!1){if(E!==null){if(i[E]!==void 0)return i[E];He("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let de;W&&(de=e.get("EXT_texture_norm16"),de||He("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Q=g;if(g===i.RED&&(B===i.FLOAT&&(Q=i.R32F),B===i.HALF_FLOAT&&(Q=i.R16F),B===i.UNSIGNED_BYTE&&(Q=i.R8),B===i.UNSIGNED_SHORT&&de&&(Q=de.R16_EXT),B===i.SHORT&&de&&(Q=de.R16_SNORM_EXT)),g===i.RED_INTEGER&&(B===i.UNSIGNED_BYTE&&(Q=i.R8UI),B===i.UNSIGNED_SHORT&&(Q=i.R16UI),B===i.UNSIGNED_INT&&(Q=i.R32UI),B===i.BYTE&&(Q=i.R8I),B===i.SHORT&&(Q=i.R16I),B===i.INT&&(Q=i.R32I)),g===i.RG&&(B===i.FLOAT&&(Q=i.RG32F),B===i.HALF_FLOAT&&(Q=i.RG16F),B===i.UNSIGNED_BYTE&&(Q=i.RG8),B===i.UNSIGNED_SHORT&&de&&(Q=de.RG16_EXT),B===i.SHORT&&de&&(Q=de.RG16_SNORM_EXT)),g===i.RG_INTEGER&&(B===i.UNSIGNED_BYTE&&(Q=i.RG8UI),B===i.UNSIGNED_SHORT&&(Q=i.RG16UI),B===i.UNSIGNED_INT&&(Q=i.RG32UI),B===i.BYTE&&(Q=i.RG8I),B===i.SHORT&&(Q=i.RG16I),B===i.INT&&(Q=i.RG32I)),g===i.RGB_INTEGER&&(B===i.UNSIGNED_BYTE&&(Q=i.RGB8UI),B===i.UNSIGNED_SHORT&&(Q=i.RGB16UI),B===i.UNSIGNED_INT&&(Q=i.RGB32UI),B===i.BYTE&&(Q=i.RGB8I),B===i.SHORT&&(Q=i.RGB16I),B===i.INT&&(Q=i.RGB32I)),g===i.RGBA_INTEGER&&(B===i.UNSIGNED_BYTE&&(Q=i.RGBA8UI),B===i.UNSIGNED_SHORT&&(Q=i.RGBA16UI),B===i.UNSIGNED_INT&&(Q=i.RGBA32UI),B===i.BYTE&&(Q=i.RGBA8I),B===i.SHORT&&(Q=i.RGBA16I),B===i.INT&&(Q=i.RGBA32I)),g===i.RGB&&(B===i.UNSIGNED_SHORT&&de&&(Q=de.RGB16_EXT),B===i.SHORT&&de&&(Q=de.RGB16_SNORM_EXT),B===i.UNSIGNED_INT_5_9_9_9_REV&&(Q=i.RGB9_E5),B===i.UNSIGNED_INT_10F_11F_11F_REV&&(Q=i.R11F_G11F_B10F)),g===i.RGBA){const re=ue?er:tt.getTransfer(K);B===i.FLOAT&&(Q=i.RGBA32F),B===i.HALF_FLOAT&&(Q=i.RGBA16F),B===i.UNSIGNED_BYTE&&(Q=re===ot?i.SRGB8_ALPHA8:i.RGBA8),B===i.UNSIGNED_SHORT&&de&&(Q=de.RGBA16_EXT),B===i.SHORT&&de&&(Q=de.RGBA16_SNORM_EXT),B===i.UNSIGNED_SHORT_4_4_4_4&&(Q=i.RGBA4),B===i.UNSIGNED_SHORT_5_5_5_1&&(Q=i.RGB5_A1)}return(Q===i.R16F||Q===i.R32F||Q===i.RG16F||Q===i.RG32F||Q===i.RGBA16F||Q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),Q}function b(E,g){let B;return E?g===null||g===1014||g===1020?B=i.DEPTH24_STENCIL8:g===1015?B=i.DEPTH32F_STENCIL8:g===1012&&(B=i.DEPTH24_STENCIL8,He("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===1014||g===1020?B=i.DEPTH_COMPONENT24:g===1015?B=i.DEPTH_COMPONENT32F:g===1012&&(B=i.DEPTH_COMPONENT16),B}function y(E,g){return p(E)===!0||E.isFramebufferTexture&&E.minFilter!==1003&&E.minFilter!==1006?Math.log2(Math.max(g.width,g.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?g.mipmaps.length:1}function w(E){const g=E.target;g.removeEventListener("dispose",w),A(g),g.isVideoTexture&&u.delete(g),g.isHTMLTexture&&d.delete(g)}function x(E){const g=E.target;g.removeEventListener("dispose",x),N(g)}function A(E){const g=n.get(E);if(g.__webglInit===void 0)return;const B=E.source,W=f.get(B);if(W){const K=W[g.__cacheKey];K.usedTimes--,K.usedTimes===0&&P(E),Object.keys(W).length===0&&f.delete(B)}n.remove(E)}function P(E){const g=n.get(E);i.deleteTexture(g.__webglTexture);const B=E.source,W=f.get(B);delete W[g.__cacheKey],a.memory.textures--}function N(E){const g=n.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),n.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(g.__webglFramebuffer[W]))for(let K=0;K<g.__webglFramebuffer[W].length;K++)i.deleteFramebuffer(g.__webglFramebuffer[W][K]);else i.deleteFramebuffer(g.__webglFramebuffer[W]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[W])}else{if(Array.isArray(g.__webglFramebuffer))for(let W=0;W<g.__webglFramebuffer.length;W++)i.deleteFramebuffer(g.__webglFramebuffer[W]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let W=0;W<g.__webglColorRenderbuffer.length;W++)g.__webglColorRenderbuffer[W]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[W]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const B=E.textures;for(let W=0,K=B.length;W<K;W++){const ue=n.get(B[W]);ue.__webglTexture&&(i.deleteTexture(ue.__webglTexture),a.memory.textures--),n.remove(B[W])}n.remove(E)}let G=0;function k(){G=0}function D(){return G}function z(E){G=E}function $(){const E=G;return E>=r.maxTextures&&He("WebGLTextures: Trying to use "+(E+1)+" texture units while this GPU supports only "+r.maxTextures),G+=1,E}function q(E){const g=[];return g.push(E.wrapS),g.push(E.wrapT),g.push(E.wrapR||0),g.push(E.magFilter),g.push(E.minFilter),g.push(E.anisotropy),g.push(E.internalFormat),g.push(E.format),g.push(E.type),g.push(E.generateMipmaps),g.push(E.premultiplyAlpha),g.push(E.flipY),g.push(E.unpackAlignment),g.push(E.colorSpace),g.join()}function ae(E,g){const B=n.get(E);if(E.isVideoTexture&&C(E),E.isRenderTargetTexture===!1&&E.isExternalTexture!==!0&&E.version>0&&B.__version!==E.version){const W=E.image;if(W===null)He("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)He("WebGLRenderer: Texture marked for update but image is incomplete");else{F(B,E,g);return}}else E.isExternalTexture&&(B.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,B.__webglTexture,i.TEXTURE0+g)}function Z(E,g){const B=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&B.__version!==E.version){F(B,E,g);return}else E.isExternalTexture&&(B.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,B.__webglTexture,i.TEXTURE0+g)}function ne(E,g){const B=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&B.__version!==E.version){F(B,E,g);return}t.bindTexture(i.TEXTURE_3D,B.__webglTexture,i.TEXTURE0+g)}function ie(E,g){const B=n.get(E);if(E.isCubeDepthTexture!==!0&&E.version>0&&B.__version!==E.version){ce(B,E,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,B.__webglTexture,i.TEXTURE0+g)}const De={1e3:i.REPEAT,1001:i.CLAMP_TO_EDGE,1002:i.MIRRORED_REPEAT},Ae={1003:i.NEAREST,1004:i.NEAREST_MIPMAP_NEAREST,1005:i.NEAREST_MIPMAP_LINEAR,1006:i.LINEAR,1007:i.LINEAR_MIPMAP_NEAREST,1008:i.LINEAR_MIPMAP_LINEAR},nt={512:i.NEVER,519:i.ALWAYS,513:i.LESS,515:i.LEQUAL,514:i.EQUAL,518:i.GEQUAL,516:i.GREATER,517:i.NOTEQUAL};function Ye(E,g){if(g.type===1015&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===1006||g.magFilter===1007||g.magFilter===1005||g.magFilter===1008||g.minFilter===1006||g.minFilter===1007||g.minFilter===1005||g.minFilter===1008)&&He("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(E,i.TEXTURE_WRAP_S,De[g.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,De[g.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,De[g.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,Ae[g.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,Ae[g.minFilter]),g.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,nt[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===1003||g.minFilter!==1005&&g.minFilter!==1008||g.type===1015&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const B=e.get("EXT_texture_filter_anisotropic");i.texParameterf(E,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function je(E,g){let B=!1;E.__webglInit===void 0&&(E.__webglInit=!0,g.addEventListener("dispose",w));const W=g.source;let K=f.get(W);K===void 0&&(K={},f.set(W,K));const ue=q(g);if(ue!==E.__cacheKey){K[ue]===void 0&&(K[ue]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,B=!0),K[ue].usedTimes++;const de=K[E.__cacheKey];de!==void 0&&(K[E.__cacheKey].usedTimes--,de.usedTimes===0&&P(g)),E.__cacheKey=ue,E.__webglTexture=K[ue].texture}return B}function J(E,g,B){return Math.floor(Math.floor(E/B)/g)}function L(E,g,B,W){const ue=E.updateRanges;if(ue.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,B,W,g.data);else{ue.sort((Ue,xe)=>Ue.start-xe.start);let de=0;for(let Ue=1;Ue<ue.length;Ue++){const xe=ue[de],me=ue[Ue],Fe=xe.start+xe.count,ze=J(me.start,g.width,4),qe=J(xe.start,g.width,4);me.start<=Fe+1&&ze===qe&&J(me.start+me.count-1,g.width,4)===ze?xe.count=Math.max(xe.count,me.start+me.count-xe.start):(++de,ue[de]=me)}ue.length=de+1;const Q=t.getParameter(i.UNPACK_ROW_LENGTH),re=t.getParameter(i.UNPACK_SKIP_PIXELS),pe=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let Ue=0,xe=ue.length;Ue<xe;Ue++){const me=ue[Ue],Fe=Math.floor(me.start/4),ze=Math.ceil(me.count/4),qe=Fe%g.width,U=Math.floor(Fe/g.width),ge=ze,j=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,qe),t.pixelStorei(i.UNPACK_SKIP_ROWS,U),t.texSubImage2D(i.TEXTURE_2D,0,qe,U,ge,j,B,W,g.data)}E.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,Q),t.pixelStorei(i.UNPACK_SKIP_PIXELS,re),t.pixelStorei(i.UNPACK_SKIP_ROWS,pe)}}function F(E,g,B){let W=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(W=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(W=i.TEXTURE_3D);const K=je(E,g),ue=g.source;t.bindTexture(W,E.__webglTexture,i.TEXTURE0+B);const de=n.get(ue);if(ue.version!==de.__version||K===!0){if(t.activeTexture(i.TEXTURE0+B),(typeof ImageBitmap<"u"&&g.image instanceof ImageBitmap)===!1){const j=tt.getPrimaries(tt.workingColorSpace),_e=g.colorSpace===""?null:tt.getPrimaries(g.colorSpace),Ee=g.colorSpace===""||j===_e?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee)}t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment);let re=m(g.image,!1,r.maxTextureSize);re=et(g,re);const pe=s.convert(g.format,g.colorSpace),Ue=s.convert(g.type);let xe=S(g.internalFormat,pe,Ue,g.normalized,g.colorSpace,g.isVideoTexture);Ye(W,g);let me;const Fe=g.mipmaps,ze=g.isVideoTexture!==!0,qe=de.__version===void 0||K===!0,U=ue.dataReady,ge=y(g,re);if(g.isDepthTexture)xe=b(g.format===1027,g.type),qe&&(ze?t.texStorage2D(i.TEXTURE_2D,1,xe,re.width,re.height):t.texImage2D(i.TEXTURE_2D,0,xe,re.width,re.height,0,pe,Ue,null));else if(g.isDataTexture)if(Fe.length>0){ze&&qe&&t.texStorage2D(i.TEXTURE_2D,ge,xe,Fe[0].width,Fe[0].height);for(let j=0,_e=Fe.length;j<_e;j++)me=Fe[j],ze?U&&t.texSubImage2D(i.TEXTURE_2D,j,0,0,me.width,me.height,pe,Ue,me.data):t.texImage2D(i.TEXTURE_2D,j,xe,me.width,me.height,0,pe,Ue,me.data);g.generateMipmaps=!1}else ze?(qe&&t.texStorage2D(i.TEXTURE_2D,ge,xe,re.width,re.height),U&&L(g,re,pe,Ue)):t.texImage2D(i.TEXTURE_2D,0,xe,re.width,re.height,0,pe,Ue,re.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){ze&&qe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ge,xe,Fe[0].width,Fe[0].height,re.depth);for(let j=0,_e=Fe.length;j<_e;j++)if(me=Fe[j],g.format!==1023)if(pe!==null)if(ze){if(U)if(g.layerUpdates.size>0){const Ee=Ws(me.width,me.height,g.format,g.type);for(const oe of g.layerUpdates){const Oe=me.data.subarray(oe*Ee/me.data.BYTES_PER_ELEMENT,(oe+1)*Ee/me.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,oe,me.width,me.height,1,pe,Oe)}}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,0,me.width,me.height,re.depth,pe,me.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,j,xe,me.width,me.height,re.depth,0,me.data,0,0);else He("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ze?U&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,0,me.width,me.height,re.depth,pe,Ue,me.data):t.texImage3D(i.TEXTURE_2D_ARRAY,j,xe,me.width,me.height,re.depth,0,pe,Ue,me.data);g.layerUpdates.size>0&&g.clearLayerUpdates()}else{ze&&qe&&t.texStorage2D(i.TEXTURE_2D,ge,xe,Fe[0].width,Fe[0].height);for(let j=0,_e=Fe.length;j<_e;j++)me=Fe[j],g.format!==1023?pe!==null?ze?U&&t.compressedTexSubImage2D(i.TEXTURE_2D,j,0,0,me.width,me.height,pe,me.data):t.compressedTexImage2D(i.TEXTURE_2D,j,xe,me.width,me.height,0,me.data):He("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ze?U&&t.texSubImage2D(i.TEXTURE_2D,j,0,0,me.width,me.height,pe,Ue,me.data):t.texImage2D(i.TEXTURE_2D,j,xe,me.width,me.height,0,pe,Ue,me.data)}else if(g.isDataArrayTexture)if(ze){if(qe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ge,xe,re.width,re.height,re.depth),U)if(g.layerUpdates.size>0){const j=Ws(re.width,re.height,g.format,g.type);for(const _e of g.layerUpdates){const Ee=re.data.subarray(_e*j/re.data.BYTES_PER_ELEMENT,(_e+1)*j/re.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,_e,re.width,re.height,1,pe,Ue,Ee)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,re.width,re.height,re.depth,pe,Ue,re.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,xe,re.width,re.height,re.depth,0,pe,Ue,re.data);else if(g.isData3DTexture)ze?(qe&&t.texStorage3D(i.TEXTURE_3D,ge,xe,re.width,re.height,re.depth),U&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,re.width,re.height,re.depth,pe,Ue,re.data)):t.texImage3D(i.TEXTURE_3D,0,xe,re.width,re.height,re.depth,0,pe,Ue,re.data);else if(g.isFramebufferTexture){if(qe)if(ze)t.texStorage2D(i.TEXTURE_2D,ge,xe,re.width,re.height);else{let j=re.width,_e=re.height;for(let Ee=0;Ee<ge;Ee++)t.texImage2D(i.TEXTURE_2D,Ee,xe,j,_e,0,pe,Ue,null),j>>=1,_e>>=1}}else if(g.isHTMLTexture){if("texElementImage2D"in i){const j=i.canvas;if(j.hasAttribute("layoutsubtree")||j.setAttribute("layoutsubtree","true"),re.parentNode!==j){j.appendChild(re),d.add(g),j.onpaint=_e=>{const Ee=_e.changedElements;for(const oe of d)Ee.includes(oe.image)&&(oe.needsUpdate=!0)},j.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,re);else{const Ee=i.RGBA,oe=i.RGBA,Oe=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,Ee,oe,Oe,re)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Fe.length>0){if(ze&&qe){const j=Xe(Fe[0]);t.texStorage2D(i.TEXTURE_2D,ge,xe,j.width,j.height)}for(let j=0,_e=Fe.length;j<_e;j++)me=Fe[j],ze?U&&t.texSubImage2D(i.TEXTURE_2D,j,0,0,pe,Ue,me):t.texImage2D(i.TEXTURE_2D,j,xe,pe,Ue,me);g.generateMipmaps=!1}else if(ze){if(qe){const j=Xe(re);t.texStorage2D(i.TEXTURE_2D,ge,xe,j.width,j.height)}U&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,pe,Ue,re)}else t.texImage2D(i.TEXTURE_2D,0,xe,pe,Ue,re);p(g)&&T(W),de.__version=ue.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function ce(E,g,B){if(g.image.length!==6)return;const W=je(E,g),K=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+B);const ue=n.get(K);if(K.version!==ue.__version||W===!0){t.activeTexture(i.TEXTURE0+B);const de=tt.getPrimaries(tt.workingColorSpace),Q=g.colorSpace===""?null:tt.getPrimaries(g.colorSpace),re=g.colorSpace===""||de===Q?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,re);const pe=g.isCompressedTexture||g.image[0].isCompressedTexture,Ue=g.image[0]&&g.image[0].isDataTexture,xe=[];for(let oe=0;oe<6;oe++)!pe&&!Ue?xe[oe]=m(g.image[oe],!0,r.maxCubemapSize):xe[oe]=Ue?g.image[oe].image:g.image[oe],xe[oe]=et(g,xe[oe]);const me=xe[0],Fe=s.convert(g.format,g.colorSpace),ze=s.convert(g.type),qe=S(g.internalFormat,Fe,ze,g.normalized,g.colorSpace),U=g.isVideoTexture!==!0,ge=ue.__version===void 0||W===!0,j=K.dataReady;let _e=y(g,me);Ye(i.TEXTURE_CUBE_MAP,g);let Ee;if(pe){U&&ge&&t.texStorage2D(i.TEXTURE_CUBE_MAP,_e,qe,me.width,me.height);for(let oe=0;oe<6;oe++){Ee=xe[oe].mipmaps;for(let Oe=0;Oe<Ee.length;Oe++){const Ie=Ee[Oe];g.format!==1023?Fe!==null?U?j&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Oe,0,0,Ie.width,Ie.height,Fe,Ie.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Oe,qe,Ie.width,Ie.height,0,Ie.data):He("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?j&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Oe,0,0,Ie.width,Ie.height,Fe,ze,Ie.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Oe,qe,Ie.width,Ie.height,0,Fe,ze,Ie.data)}}}else{if(Ee=g.mipmaps,U&&ge){Ee.length>0&&_e++;const oe=Xe(xe[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,_e,qe,oe.width,oe.height)}for(let oe=0;oe<6;oe++)if(Ue){U?j&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,xe[oe].width,xe[oe].height,Fe,ze,xe[oe].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,qe,xe[oe].width,xe[oe].height,0,Fe,ze,xe[oe].data);for(let Oe=0;Oe<Ee.length;Oe++){const ut=Ee[Oe].image[oe].image;U?j&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Oe+1,0,0,ut.width,ut.height,Fe,ze,ut.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Oe+1,qe,ut.width,ut.height,0,Fe,ze,ut.data)}}else{U?j&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,Fe,ze,xe[oe]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,qe,Fe,ze,xe[oe]);for(let Oe=0;Oe<Ee.length;Oe++){const Ie=Ee[Oe];U?j&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Oe+1,0,0,Fe,ze,Ie.image[oe]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Oe+1,qe,Fe,ze,Ie.image[oe])}}}p(g)&&T(i.TEXTURE_CUBE_MAP),ue.__version=K.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function le(E,g,B,W,K,ue){const de=s.convert(B.format,B.colorSpace),Q=s.convert(B.type),re=S(B.internalFormat,de,Q,B.normalized,B.colorSpace),pe=n.get(g),Ue=n.get(B);if(Ue.__renderTarget=g,!pe.__hasExternalTextures){const xe=Math.max(1,g.width>>ue),me=Math.max(1,g.height>>ue);K===i.TEXTURE_3D||K===i.TEXTURE_2D_ARRAY?t.texImage3D(K,ue,re,xe,me,g.depth,0,de,Q,null):t.texImage2D(K,ue,re,xe,me,0,de,Q,null)}t.bindFramebuffer(i.FRAMEBUFFER,E),Ge(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,W,K,Ue.__webglTexture,0,Be(g)):(K===i.TEXTURE_2D||K>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,W,K,Ue.__webglTexture,ue),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Me(E,g,B){if(i.bindRenderbuffer(i.RENDERBUFFER,E),g.depthBuffer){const W=g.depthTexture,K=W&&W.isDepthTexture?W.type:null,ue=b(g.stencilBuffer,K),de=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Ge(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Be(g),ue,g.width,g.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,Be(g),ue,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ue,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,de,i.RENDERBUFFER,E)}else{const W=g.textures;for(let K=0;K<W.length;K++){const ue=W[K],de=s.convert(ue.format,ue.colorSpace),Q=s.convert(ue.type),re=S(ue.internalFormat,de,Q,ue.normalized,ue.colorSpace);Ge(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Be(g),re,g.width,g.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,Be(g),re,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,re,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Ve(E,g,B){const W=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,E),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const K=n.get(g.depthTexture);if(K.__renderTarget=g,(!K.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),W){if(K.__webglInit===void 0&&(K.__webglInit=!0,g.depthTexture.addEventListener("dispose",w)),K.__webglTexture===void 0){K.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),Ye(i.TEXTURE_CUBE_MAP,g.depthTexture);const pe=s.convert(g.depthTexture.format),Ue=s.convert(g.depthTexture.type);let xe;g.depthTexture.format===1026?xe=i.DEPTH_COMPONENT24:g.depthTexture.format===1027&&(xe=i.DEPTH24_STENCIL8);for(let me=0;me<6;me++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,xe,g.width,g.height,0,pe,Ue,null)}}else ae(g.depthTexture,0);const ue=K.__webglTexture,de=Be(g),Q=W?i.TEXTURE_CUBE_MAP_POSITIVE_X+B:i.TEXTURE_2D,re=g.depthTexture.format===1027?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===1026)Ge(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,re,Q,ue,0,de):i.framebufferTexture2D(i.FRAMEBUFFER,re,Q,ue,0);else if(g.depthTexture.format===1027)Ge(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,re,Q,ue,0,de):i.framebufferTexture2D(i.FRAMEBUFFER,re,Q,ue,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function X(E){const g=n.get(E),B=E.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==E.depthTexture){const W=E.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),W){const K=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,W.removeEventListener("dispose",K)};W.addEventListener("dispose",K),g.__depthDisposeCallback=K}g.__boundDepthTexture=W}if(E.depthTexture&&!g.__autoAllocateDepthBuffer)if(B)for(let W=0;W<6;W++)Ve(g.__webglFramebuffer[W],E,W);else{const W=E.texture.mipmaps;W&&W.length>0?Ve(g.__webglFramebuffer[0],E,0):Ve(g.__webglFramebuffer,E,0)}else if(B){g.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[W]),g.__webglDepthbuffer[W]===void 0)g.__webglDepthbuffer[W]=i.createRenderbuffer(),Me(g.__webglDepthbuffer[W],E,!1);else{const K=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ue=g.__webglDepthbuffer[W];i.bindRenderbuffer(i.RENDERBUFFER,ue),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,ue)}}else{const W=E.texture.mipmaps;if(W&&W.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),Me(g.__webglDepthbuffer,E,!1);else{const K=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ue=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ue),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,ue)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function ee(E,g,B){const W=n.get(E);g!==void 0&&le(W.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),B!==void 0&&X(E)}function se(E){const g=E.texture,B=n.get(E),W=n.get(g);E.addEventListener("dispose",x);const K=E.textures,ue=E.isWebGLCubeRenderTarget===!0,de=K.length>1;if(de||(W.__webglTexture===void 0&&(W.__webglTexture=i.createTexture()),W.__version=g.version,a.memory.textures++),ue){B.__webglFramebuffer=[];for(let Q=0;Q<6;Q++)if(g.mipmaps&&g.mipmaps.length>0){B.__webglFramebuffer[Q]=[];for(let re=0;re<g.mipmaps.length;re++)B.__webglFramebuffer[Q][re]=i.createFramebuffer()}else B.__webglFramebuffer[Q]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){B.__webglFramebuffer=[];for(let Q=0;Q<g.mipmaps.length;Q++)B.__webglFramebuffer[Q]=i.createFramebuffer()}else B.__webglFramebuffer=i.createFramebuffer();if(de)for(let Q=0,re=K.length;Q<re;Q++){const pe=n.get(K[Q]);pe.__webglTexture===void 0&&(pe.__webglTexture=i.createTexture(),a.memory.textures++)}if(E.samples>0&&Ge(E)===!1){B.__webglMultisampledFramebuffer=i.createFramebuffer(),B.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let Q=0;Q<K.length;Q++){const re=K[Q];B.__webglColorRenderbuffer[Q]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,B.__webglColorRenderbuffer[Q]);const pe=s.convert(re.format,re.colorSpace),Ue=s.convert(re.type),xe=S(re.internalFormat,pe,Ue,re.normalized,re.colorSpace,E.isXRRenderTarget===!0),me=Be(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,me,xe,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Q,i.RENDERBUFFER,B.__webglColorRenderbuffer[Q])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(B.__webglDepthRenderbuffer=i.createRenderbuffer(),Me(B.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ue){t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture),Ye(i.TEXTURE_CUBE_MAP,g);for(let Q=0;Q<6;Q++)if(g.mipmaps&&g.mipmaps.length>0)for(let re=0;re<g.mipmaps.length;re++)le(B.__webglFramebuffer[Q][re],E,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,re);else le(B.__webglFramebuffer[Q],E,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0);p(g)&&T(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(de){for(let Q=0,re=K.length;Q<re;Q++){const pe=K[Q],Ue=n.get(pe);let xe=i.TEXTURE_2D;(E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(xe=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(xe,Ue.__webglTexture),Ye(xe,pe),le(B.__webglFramebuffer,E,pe,i.COLOR_ATTACHMENT0+Q,xe,0),p(pe)&&T(xe)}t.unbindTexture()}else{let Q=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(Q=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Q,W.__webglTexture),Ye(Q,g),g.mipmaps&&g.mipmaps.length>0)for(let re=0;re<g.mipmaps.length;re++)le(B.__webglFramebuffer[re],E,g,i.COLOR_ATTACHMENT0,Q,re);else le(B.__webglFramebuffer,E,g,i.COLOR_ATTACHMENT0,Q,0);p(g)&&T(Q),t.unbindTexture()}E.depthBuffer&&X(E)}function te(E){const g=E.textures;for(let B=0,W=g.length;B<W;B++){const K=g[B];if(p(K)){const ue=R(E),de=n.get(K).__webglTexture;t.bindTexture(ue,de),T(ue),t.unbindTexture()}}}const he=[],Te=[];function be(E){if(E.samples>0){if(Ge(E)===!1){const g=E.textures,B=E.width,W=E.height;let K=i.COLOR_BUFFER_BIT;const ue=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,de=n.get(E),Q=g.length>1;if(Q)for(let pe=0;pe<g.length;pe++)t.bindFramebuffer(i.FRAMEBUFFER,de.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,de.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,de.__webglMultisampledFramebuffer);const re=E.texture.mipmaps;re&&re.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,de.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,de.__webglFramebuffer);for(let pe=0;pe<g.length;pe++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(K|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(K|=i.STENCIL_BUFFER_BIT)),Q){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,de.__webglColorRenderbuffer[pe]);const Ue=n.get(g[pe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ue,0)}i.blitFramebuffer(0,0,B,W,0,0,B,W,K,i.NEAREST),c===!0&&(he.length=0,Te.length=0,he.push(i.COLOR_ATTACHMENT0+pe),E.depthBuffer&&E.storeMultisampledDepthBuffer===!1&&(he.push(ue),Te.push(ue),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Te)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,he))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Q)for(let pe=0;pe<g.length;pe++){t.bindFramebuffer(i.FRAMEBUFFER,de.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.RENDERBUFFER,de.__webglColorRenderbuffer[pe]);const Ue=n.get(g[pe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,de.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.TEXTURE_2D,Ue,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,de.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.storeMultisampledDepthBuffer===!1&&c){const g=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function Be(E){return Math.min(r.maxSamples,E.samples)}function Ge(E){const g=n.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function C(E){const g=a.render.frame;u.get(E)!==g&&(u.set(E,g),E.update())}function et(E,g){const B=E.colorSpace,W=E.format,K=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||B!==ji&&B!==""&&(tt.getTransfer(B)===ot?(W!==1023||K!==1009)&&He("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):rt("WebGLTextures: Unsupported texture color space:",B)),g}function Xe(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(l.width=E.naturalWidth||E.width,l.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(l.width=E.displayWidth,l.height=E.displayHeight):(l.width=E.width,l.height=E.height),l}this.allocateTextureUnit=$,this.resetTextureUnits=k,this.getTextureUnits=D,this.setTextureUnits=z,this.setTexture2D=ae,this.setTexture2DArray=Z,this.setTexture3D=ne,this.setTextureCube=ie,this.rebindTextures=ee,this.setupRenderTarget=se,this.updateRenderTargetMipmap=te,this.updateMultisampleRenderTarget=be,this.setupDepthRenderbuffer=X,this.setupFrameBufferTexture=le,this.useMultisampledRTT=Ge,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function ud(i,e){function t(n,r=""){let s;const a=tt.getTransfer(r);if(n===1009)return i.UNSIGNED_BYTE;if(n===1017)return i.UNSIGNED_SHORT_4_4_4_4;if(n===1018)return i.UNSIGNED_SHORT_5_5_5_1;if(n===35902)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===35899)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===1010)return i.BYTE;if(n===1011)return i.SHORT;if(n===1012)return i.UNSIGNED_SHORT;if(n===1013)return i.INT;if(n===1014)return i.UNSIGNED_INT;if(n===1015)return i.FLOAT;if(n===1016)return i.HALF_FLOAT;if(n===1021)return i.ALPHA;if(n===1022)return i.RGB;if(n===1023)return i.RGBA;if(n===1026)return i.DEPTH_COMPONENT;if(n===1027)return i.DEPTH_STENCIL;if(n===1028)return i.RED;if(n===1029)return i.RED_INTEGER;if(n===1030)return i.RG;if(n===1031)return i.RG_INTEGER;if(n===1033)return i.RGBA_INTEGER;if(n===33776||n===33777||n===33778||n===33779)if(a===ot)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===33776)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===33777)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===33778)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===33779)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===33776)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===33777)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===33778)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===33779)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===35840||n===35841||n===35842||n===35843)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===35840)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===35841)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===35842)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===35843)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===36196||n===37492||n===37496||n===37488||n===37489||n===37490||n===37491)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===36196||n===37492)return a===ot?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===37496)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===37488)return s.COMPRESSED_R11_EAC;if(n===37489)return s.COMPRESSED_SIGNED_R11_EAC;if(n===37490)return s.COMPRESSED_RG11_EAC;if(n===37491)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===37808||n===37809||n===37810||n===37811||n===37812||n===37813||n===37814||n===37815||n===37816||n===37817||n===37818||n===37819||n===37820||n===37821)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===37808)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===37809)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===37810)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===37811)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===37812)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===37813)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===37814)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===37815)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===37816)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===37817)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===37818)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===37819)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===37820)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===37821)return a===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===36492||n===36494||n===36495)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===36492)return a===ot?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===36494)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===36495)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===36283||n===36284||n===36285||n===36286)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===36283)return s.COMPRESSED_RED_RGTC1_EXT;if(n===36284)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===36285)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===36286)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===1020?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const fd=`
void main() {
...
}`;class pd{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new ya(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new jt({vertexShader:fd,fragmentShader:dd,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new xt(new Ti(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class md extends wn{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",c=1,l=null,u=null,d=null,h=null,f=null,_=null;const M=typeof XRWebGLBinding<"u",m=new pd,p={},T=t.getContextAttributes();let R=null,S=null;const b=[],y=[],w=new fe;let x=null,A=null;const P=new Gt;P.viewport=new pt;const N=new Gt;N.viewport=new pt;const G=[P,N],k=new yl;let D=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(J){let L=b[J];return L===void 0&&(L=new mr,b[J]=L),L.getTargetRaySpace()},this.getControllerGrip=function(J){let L=b[J];return L===void 0&&(L=new mr,b[J]=L),L.getGripSpace()},this.getHand=function(J){let L=b[J];return L===void 0&&(L=new mr,b[J]=L),L.getHandSpace()};function $(J){const L=y.indexOf(J.inputSource);if(L===-1)return;const F=b[L];F!==void 0&&(F.update(J.inputSource,J.frame,l||a),F.dispatchEvent({type:J.type,data:J.inputSource}))}function q(){r.removeEventListener("select",$),r.removeEventListener("selectstart",$),r.removeEventListener("selectend",$),r.removeEventListener("squeeze",$),r.removeEventListener("squeezestart",$),r.removeEventListener("squeezeend",$),r.removeEventListener("end",q),r.removeEventListener("inputsourceschange",ae);for(let J=0;J<b.length;J++){const L=y[J];L!==null&&(y[J]=null,b[J].disconnect(L))}D=null,z=null,m.reset();for(const J in p)delete p[J];if(e.setRenderTarget(R),f=null,h=null,d=null,r=null,S=null,je.stop(),n.isPresenting=!1,e.setPixelRatio(x),e.setSize(w.width,w.height,!1),A!==null){const J=A.camera;J.fov=A.fov,J.zoom=A.zoom,J.updateProjectionMatrix(),A=null}n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(J){s=J,n.isPresenting===!0&&He("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(J){o=J,n.isPresenting===!0&&He("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(J){l=J},this.getBaseLayer=function(){return h!==null?h:f},this.getBinding=function(){return d===null&&M&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(J){if(r=J,r!==null){if(R=e.getRenderTarget(),r.addEventListener("select",$),r.addEventListener("selectstart",$),r.addEventListener("selectend",$),r.addEventListener("squeeze",$),r.addEventListener("squeezestart",$),r.addEventListener("squeezeend",$),r.addEventListener("end",q),r.addEventListener("inputsourceschange",ae),T.xrCompatible!==!0&&await t.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(w),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let F=null,ce=null,le=null;T.depth&&(le=T.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,F=T.stencil?1027:1026,ce=T.stencil?1020:1014);const Me={colorFormat:t.RGBA8,depthFormat:le,scaleFactor:s};d=this.getBinding(),h=d.createProjectionLayer(Me),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),S=new Xt(h.textureWidth,h.textureHeight,{format:1023,type:1009,depthTexture:new xi(h.textureWidth,h.textureHeight,ce,void 0,void 0,void 0,void 0,void 0,void 0,F),stencilBuffer:T.stencil,colorSpace:e.outputColorSpace,samples:T.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1,storeMultisampledDepthBuffer:h.ignoreDepthValues===!1,storeMultisampledStencilBuffer:h.ignoreDepthValues===!1})}else{const F={antialias:T.antialias,alpha:!0,depth:T.depth,stencil:T.stencil,framebufferScaleFactor:s};f=new XRWebGLLayer(r,t,F),r.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),S=new Xt(f.framebufferWidth,f.framebufferHeight,{format:1023,type:1009,colorSpace:e.outputColorSpace,stencilBuffer:T.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1,storeMultisampledDepthBuffer:f.ignoreDepthValues===!1,storeMultisampledStencilBuffer:f.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await r.requestReferenceSpace(o),je.setContext(r),je.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function ae(J){for(let L=0;L<J.removed.length;L++){const F=J.removed[L],ce=y.indexOf(F);ce>=0&&(y[ce]=null,b[ce].disconnect(F))}for(let L=0;L<J.added.length;L++){const F=J.added[L];let ce=y.indexOf(F);if(ce===-1){for(let Me=0;Me<b.length;Me++)if(Me>=y.length){y.push(F),ce=Me;break}else if(y[Me]===null){y[Me]=F,ce=Me;break}if(ce===-1)break}const le=b[ce];le&&le.connect(F)}}const Z=new O,ne=new O;function ie(J,L,F){Z.setFromMatrixPosition(L.matrixWorld),ne.setFromMatrixPosition(F.matrixWorld);const ce=Z.distanceTo(ne),le=L.projectionMatrix.elements,Me=F.projectionMatrix.elements,Ve=le[14]/(le[10]-1),X=le[14]/(le[10]+1),ee=(le[9]+1)/le[5],se=(le[9]-1)/le[5],te=(le[8]-1)/le[0],he=(Me[8]+1)/Me[0],Te=Ve*te,be=Ve*he,Be=ce/(-te+he),Ge=Be*-te;if(L.matrixWorld.decompose(J.position,J.quaternion,J.scale),J.translateX(Ge),J.translateZ(Be),J.matrixWorld.compose(J.position,J.quaternion,J.scale),J.matrixWorldInverse.copy(J.matrixWorld).invert(),le[10]===-1)J.projectionMatrix.copy(L.projectionMatrix),J.projectionMatrixInverse.copy(L.projectionMatrixInverse);else{const C=Ve+Be,et=X+Be,Xe=Te-Ge,E=be+(ce-Ge),g=ee*X/et*C,B=se*X/et*C;J.projectionMatrix.makePerspective(Xe,E,g,B,C,et),J.projectionMatrixInverse.copy(J.projectionMatrix).invert()}}function De(J,L){L===null?J.matrixWorld.copy(J.matrix):J.matrixWorld.multiplyMatrices(L.matrixWorld,J.matrix),J.matrixWorldInverse.copy(J.matrixWorld).invert()}this.updateCamera=function(J){if(r===null)return;let L=J.near,F=J.far;m.texture!==null&&(m.depthNear>0&&(L=m.depthNear),m.depthFar>0&&(F=m.depthFar)),k.near=N.near=P.near=L,k.far=N.far=P.far=F,(D!==k.near||z!==k.far)&&(r.updateRenderState({depthNear:k.near,depthFar:k.far}),D=k.near,z=k.far),k.layers.mask=J.layers.mask|6,P.layers.mask=k.layers.mask&-5,N.layers.mask=k.layers.mask&-3;const ce=J.parent,le=k.cameras;De(k,ce);for(let Me=0;Me<le.length;Me++)De(le[Me],ce);le.length===2?ie(k,P,N):k.projectionMatrix.copy(P.projectionMatrix),A===null&&J.isPerspectiveCamera&&(A={camera:J,fov:J.fov,zoom:J.zoom}),Ae(J,k,ce)};function Ae(J,L,F){F===null?J.matrix.copy(L.matrixWorld):(J.matrix.copy(F.matrixWorld),J.matrix.invert(),J.matrix.multiply(L.matrixWorld)),J.matrix.decompose(J.position,J.quaternion,J.scale),J.updateMatrixWorld(!0),J.projectionMatrix.copy(L.projectionMatrix),J.projectionMatrixInverse.copy(L.projectionMatrixInverse),J.isPerspectiveCamera&&(J.fov=zr*2*Math.atan(1/J.projectionMatrix.elements[5]),J.zoom=1)}this.getCamera=function(){return k},this.getFoveation=function(){if(!(h===null&&f===null))return c},this.setFoveation=function(J){c=J,h!==null&&(h.fixedFoveation=J),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=J)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(k)},this.getCameraTexture=function(J){return p[J]};let nt=null;function Ye(J,L){if(u=L.getViewerPose(l||a),_=L,u!==null){const F=u.views;f!==null&&(e.setRenderTargetFramebuffer(S,f.framebuffer),e.setRenderTarget(S));let ce=!1;F.length!==k.cameras.length&&(k.cameras.length=0,ce=!0);for(let X=0;X<F.length;X++){const ee=F[X];let se=null;if(f!==null)se=f.getViewport(ee);else{const he=d.getViewSubImage(h,ee);se=he.viewport,X===0&&(e.setRenderTargetTextures(S,he.colorTexture,he.depthStencilTexture),e.setRenderTarget(S))}let te=G[X];te===void 0&&(te=new Gt,te.layers.enable(X),te.viewport=new pt,G[X]=te),te.matrix.fromArray(ee.transform.matrix),te.matrix.decompose(te.position,te.quaternion,te.scale),te.projectionMatrix.fromArray(ee.projectionMatrix),te.projectionMatrixInverse.copy(te.projectionMatrix).invert(),te.viewport.set(se.x,se.y,se.width,se.height),X===0&&(k.matrix.copy(te.matrix),k.matrix.decompose(k.position,k.quaternion,k.scale)),ce===!0&&k.cameras.push(te)}const le=r.enabledFeatures;if(le&&le.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&M){d=n.getBinding();const X=d.getDepthInformation(F[0]);X&&X.isValid&&X.texture&&m.init(X,r.renderState)}if(le&&le.includes("camera-access")&&M){e.state.unbindTexture(),d=n.getBinding();for(let X=0;X<F.length;X++){const ee=F[X].camera;if(ee){let se=p[ee];se||(se=new ya,p[ee]=se);const te=d.getCameraImage(ee);se.sourceTexture=te}}}}for(let F=0;F<b.length;F++){const ce=y[F],le=b[F];ce!==null&&le!==void 0&&le.update(ce,L,l||a)}nt&&nt(J,L),L.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:L}),_=null}const je=new Fa;je.setAnimationLoop(Ye),this.setAnimationLoop=function(J){nt=J},this.dispose=function(){}}}const gd=new ht,ka=new We;ka.set(-1,0,0,0,1,0,0,0,1);function _d(i,e){function t(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Da(i)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function r(m,p,T,R,S){p.isNodeMaterial?p.uniformsNeedUpdate=!1:p.isMeshBasicMaterial?s(m,p):p.isMeshLambertMaterial?(s(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshToonMaterial?(s(m,p),d(m,p)):p.isMeshPhongMaterial?(s(m,p),u(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshStandardMaterial?(s(m,p),h(m,p),p.isMeshPhysicalMaterial&&f(m,p,S)):p.isMeshMatcapMaterial?(s(m,p),_(m,p)):p.isMeshDepthMaterial?s(m,p):p.isMeshDistanceMaterial?(s(m,p),M(m,p)):p.isMeshNormalMaterial?s(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?c(m,p,T,R):p.isSpriteMaterial?l(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function s(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,t(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===1&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,t(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===1&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,t(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,t(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,t(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const T=e.get(p),R=T.envMap,S=T.envMapRotation;R&&(m.envMap.value=R,m.envMapRotation.value.setFromMatrix4(gd.makeRotationFromEuler(S)).transpose(),R.isCubeTexture&&R.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(ka),m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,t(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,t(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function c(m,p,T,R){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*T,m.scale.value=R*.5,p.map&&(m.map.value=p.map,t(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function l(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function u(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function d(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function h(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,t(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,t(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,T){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,t(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,t(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,t(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,t(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,t(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===1&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.retroreflectivity>0&&(m.retroreflectivity.value=p.retroreflectivity),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,t(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,t(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=T.texture,m.transmissionSamplerSize.value.set(T.width,T.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,t(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,t(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,t(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,t(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,t(p.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,p){p.matcap&&(m.matcap.value=p.matcap)}function M(m,p){const T=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(T.matrixWorld),m.nearDistance.value=T.shadow.camera.near,m.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function xd(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(S,b){const y=b.program;n.uniformBlockBinding(S,y)}function l(S,b){let y=r[S.id];y===void 0&&(m(S),y=u(S),r[S.id]=y,S.addEventListener("dispose",T));const w=b.program;n.updateUBOMapping(S,w);const x=e.render.frame;s[S.id]!==x&&(h(S),s[S.id]=x)}function u(S){const b=d();S.__bindingPointIndex=b;const y=i.createBuffer(),w=S.__size,x=S.usage;return i.bindBuffer(i.UNIFORM_BUFFER,y),i.bufferData(i.UNIFORM_BUFFER,w,x),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,b,y),y}function d(){for(let S=0;S<o;S++)if(a.indexOf(S)===-1)return a.push(S),S;return rt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(S){const b=r[S.id],y=S.uniforms,w=S.__cache;i.bindBuffer(i.UNIFORM_BUFFER,b);for(let x=0,A=y.length;x<A;x++){const P=y[x];if(Array.isArray(P))for(let N=0,G=P.length;N<G;N++)f(P[N],x,N,w);else f(P,x,0,w)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function f(S,b,y,w){if(M(S,b,y,w)===!0){const x=S.__offset,A=S.value;if(Array.isArray(A)){let P=0;for(let N=0;N<A.length;N++){const G=A[N],k=p(G);_(G,S.__data,P),typeof G!="number"&&typeof G!="boolean"&&!G.isMatrix3&&!ArrayBuffer.isView(G)&&(P+=k.storage/Float32Array.BYTES_PER_ELEMENT)}}else _(A,S.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,x,S.__data)}}function _(S,b,y){typeof S=="number"||typeof S=="boolean"?b[0]=S:S.isMatrix3?(b[0]=S.elements[0],b[1]=S.elements[1],b[2]=S.elements[2],b[3]=0,b[4]=S.elements[3],b[5]=S.elements[4],b[6]=S.elements[5],b[7]=0,b[8]=S.elements[6],b[9]=S.elements[7],b[10]=S.elements[8],b[11]=0):ArrayBuffer.isView(S)?b.set(new S.constructor(S.buffer,S.byteOffset,b.length)):S.toArray(b,y)}function M(S,b,y,w){const x=S.value,A=b+"_"+y;if(w[A]===void 0)return typeof x=="number"||typeof x=="boolean"?w[A]=x:ArrayBuffer.isView(x)?w[A]=x.slice():w[A]=x.clone(),!0;{const P=w[A];if(typeof x=="number"||typeof x=="boolean"){if(P!==x)return w[A]=x,!0}else{if(ArrayBuffer.isView(x))return!0;if(P.equals(x)===!1)return P.copy(x),!0}}return!1}function m(S){const b=S.uniforms;let y=0;const w=16;for(let A=0,P=b.length;A<P;A++){const N=Array.isArray(b[A])?b[A]:[b[A]];for(let G=0,k=N.length;G<k;G++){const D=N[G],z=Array.isArray(D.value)?D.value:[D.value];for(let $=0,q=z.length;$<q;$++){const ae=z[$],Z=p(ae),ne=y%w,ie=ne%Z.boundary,De=ne+ie;y+=ie,De!==0&&w-De<Z.storage&&(y+=w-De),D.__data=new Float32Array(Z.storage/Float32Array.BYTES_PER_ELEMENT),D.__offset=y,y+=Z.storage}}}const x=y%w;return x>0&&(y+=w-x),S.__size=y,S.__cache={},this}function p(S){const b={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(b.boundary=4,b.storage=4):S.isVector2?(b.boundary=8,b.storage=8):S.isVector3||S.isColor?(b.boundary=16,b.storage=12):S.isVector4?(b.boundary=16,b.storage=16):S.isMatrix3?(b.boundary=48,b.storage=48):S.isMatrix4?(b.boundary=64,b.storage=64):S.isTexture?He("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(S)?(b.boundary=16,b.storage=S.byteLength):He("WebGLRenderer: Unsupported uniform value type.",S),b}function T(S){const b=S.target;b.removeEventListener("dispose",T);const y=a.indexOf(b.__bindingPointIndex);a.splice(y,1),i.deleteBuffer(r[b.id]),delete r[b.id],delete s[b.id]}function R(){for(const S in r)i.deleteBuffer(r[S]);a=[],r={},s={}}return{bind:c,update:l,dispose:R}}const vd=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Jt=null;function Sd(){return Jt===null&&(Jt=new Sa(vd,16,16,1030,1016),Jt.name="DFG_LUT",Jt.minFilter=1006,Jt.magFilter=1006,Jt.wrapS=1001,Jt.wrapT=1001,Jt.generateMipmaps=!1,Jt.needsUpdate=!0),Jt}class Md{constructor(e={}){const{canvas:t=Qa(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:h=!1,outputBufferType:f=1009}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=a;const M=f,m=new Set([1033,1031,1029]),p=new Set([1009,1014,1012,1020,1017,1018]),T=new Uint32Array(4),R=new Int32Array(4),S=new O;let b=null,y=null;const w=[],x=[];let A=null;this.domElement=t,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const P=this;let N=!1,G=null,k=null,D=null,z=null;this._outputColorSpace=Bt;let $=0,q=0,ae=null,Z=-1,ne=null;const ie=new pt,De=new pt;let Ae=null;const nt=new Qe(0);let Ye=0,je=t.width,J=t.height,L=1,F=null,ce=null;const le=new pt(0,0,je,J),Me=new pt(0,0,je,J);let Ve=!1;const X=new Jr;let ee=!1,se=!1;const te=new ht,he=new O,Te=new pt,be={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Be=!1;function Ge(){return ae===null?L:1}let C=n;function et(v,I){return t.getContext(v,I)}let Xe,E,g,B,W,K,ue,de,Q,re,pe,Ue,xe,me,Fe,ze,qe,U,ge,j,_e,Ee,oe;try{const v={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine","three.js r186"),t.addEventListener("webglcontextlost",ut,!1),t.addEventListener("webglcontextrestored",st,!1),t.addEventListener("webglcontextcreationerror",zt,!1),C===null){const I="webgl2";if(C=et(I,v),C===null)throw et(I)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}Oe()}catch(v){throw t.removeEventListener("webglcontextlost",ut,!1),t.removeEventListener("webglcontextrestored",st,!1),t.removeEventListener("webglcontextcreationerror",zt,!1),rt("WebGLRenderer: "+v.message),v}function Oe(){Xe=new vu(C),Xe.init(),_e=new ud(C,Xe),E=new cu(C,Xe,e,_e),g=new cd(C,Xe),E.reversedDepthBuffer&&h&&g.buffers.depth.setReversed(!0),k=C.createFramebuffer(),D=C.createFramebuffer(),z=C.createFramebuffer(),B=new yu(C),W=new Jf,K=new hd(C,Xe,g,W,E,_e,B),ue=new xu(P),de=new Tl(C),Ee=new ou(C,de),Q=new Su(C,de,B,Ee),re=new Tu(C,Q,de,Ee,B),U=new Eu(C,E,K),Fe=new hu(W),pe=new Zf(P,ue,Xe,E,Ee,Fe),Ue=new _d(P,W),xe=new $f,me=new id(Xe),qe=new au(P,ue,g,re,_,c),ze=new ld(P,re,E),oe=new xd(C,B,E,g),ge=new lu(C,Xe,B),j=new Mu(C,Xe,B),B.programs=pe.programs,P.capabilities=E,P.extensions=Xe,P.properties=W,P.renderLists=xe,P.shadowMap=ze,P.state=g,P.info=B}M!==1009&&(A=new Au(M,t.width,t.height,o,r,s));const Ie=new md(P,C);this.xr=Ie,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){const v=Xe.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=Xe.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return L},this.setPixelRatio=function(v){v!==void 0&&(L=v,this.setSize(je,J,!1))},this.getSize=function(v){return v.set(je,J)},this.setSize=function(v,I,Y=!0){if(Ie.isPresenting){He("WebGLRenderer: Can't change size while VR device is presenting.");return}je=v,J=I,t.width=Math.floor(v*L),t.height=Math.floor(I*L),Y===!0&&(t.style.width=v+"px",t.style.height=I+"px"),A!==null&&A.setSize(t.width,t.height),this.setViewport(0,0,v,I)},this.getDrawingBufferSize=function(v){return v.set(je*L,J*L).floor()},this.setDrawingBufferSize=function(v,I,Y){je=v,J=I,L=Y,t.width=Math.floor(v*Y),t.height=Math.floor(I*Y),this.setViewport(0,0,v,I)},this.setEffects=function(v){if(M===1009){rt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(v){for(let I=0;I<v.length;I++)if(v[I].isOutputPass===!0){He("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}A.setEffects(v||[])},this.getCurrentViewport=function(v){return v.copy(ie)},this.getViewport=function(v){return v.copy(le)},this.setViewport=function(v,I,Y,V){v.isVector4?le.set(v.x,v.y,v.z,v.w):le.set(v,I,Y,V),g.viewport(ie.copy(le).multiplyScalar(L).round())},this.getScissor=function(v){return v.copy(Me)},this.setScissor=function(v,I,Y,V){v.isVector4?Me.set(v.x,v.y,v.z,v.w):Me.set(v,I,Y,V),g.scissor(De.copy(Me).multiplyScalar(L).round())},this.getScissorTest=function(){return Ve},this.setScissorTest=function(v){g.setScissorTest(Ve=v)},this.setOpaqueSort=function(v){F=v},this.setTransparentSort=function(v){ce=v},this.getClearColor=function(v){return v.copy(qe.getClearColor())},this.setClearColor=function(){qe.setClearColor(...arguments)},this.getClearAlpha=function(){return qe.getClearAlpha()},this.setClearAlpha=function(){qe.setClearAlpha(...arguments)},this.clear=function(v=!0,I=!0,Y=!0){let V=0;if(v){let H=!1;if(ae!==null){const ye=ae.texture.format;H=m.has(ye)}if(H){const ye=ae.texture.type,we=p.has(ye),Se=qe.getClearColor(),Pe=qe.getClearAlpha(),Ne=Se.r,Ze=Se.g,$e=Se.b;we?(T[0]=Ne,T[1]=Ze,T[2]=$e,T[3]=Pe,C.clearBufferuiv(C.COLOR,0,T)):(R[0]=Ne,R[1]=Ze,R[2]=$e,R[3]=Pe,C.clearBufferiv(C.COLOR,0,R))}else V|=C.COLOR_BUFFER_BIT}I&&(V|=C.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),Y&&(V|=C.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),V!==0&&C.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(v){v.setRenderer(this),G=v},this.dispose=function(){t.removeEventListener("webglcontextlost",ut,!1),t.removeEventListener("webglcontextrestored",st,!1),t.removeEventListener("webglcontextcreationerror",zt,!1),qe.dispose(),xe.dispose(),me.dispose(),W.dispose(),ue.dispose(),re.dispose(),Ee.dispose(),oe.dispose(),pe.dispose(),Ie.dispose(),Ie.removeEventListener("sessionstart",is),Ie.removeEventListener("sessionend",rs),Sn.stop()};function ut(v){v.preventDefault(),ps("WebGLRenderer: Context Lost."),N=!0}function st(){ps("WebGLRenderer: Context Restored."),N=!1;const v=B.autoReset,I=ze.enabled,Y=ze.autoUpdate,V=ze.needsUpdate,H=ze.type;Oe(),B.autoReset=v,ze.enabled=I,ze.autoUpdate=Y,ze.needsUpdate=V,ze.type=H}function zt(v){rt("WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function qt(v){const I=v.target;I.removeEventListener("dispose",qt),Wa(I)}function Wa(v){Xa(v),W.remove(v)}function Xa(v){const I=W.get(v).programs;I!==void 0&&(I.forEach(function(Y){pe.releaseProgram(Y)}),v.isShaderMaterial&&pe.releaseShaderCache(v))}this.renderBufferDirect=function(v,I,Y,V,H,ye){I===null&&(I=be);const we=H.isMesh&&H.matrixWorld.determinantAffine()<0,Se=Za(v,I,Y,V,H);g.setMaterial(V,we);let Pe=Y.index,Ne=1;if(V.wireframe===!0){if(Pe=Q.getWireframeAttribute(Y),Pe===void 0)return;Ne=2}const Ze=Y.drawRange,$e=Y.attributes.position;let Le=Ze.start*Ne,at=(Ze.start+Ze.count)*Ne;ye!==null&&(Le=Math.max(Le,ye.start*Ne),at=Math.min(at,(ye.start+ye.count)*Ne)),Pe!==null?(Le=Math.max(Le,0),at=Math.min(at,Pe.count)):$e!=null&&(Le=Math.max(Le,0),at=Math.min(at,$e.count));const vt=at-Le;if(vt<0||vt===1/0)return;Ee.setup(H,V,Se,Y,Pe);let dt,ct=ge;if(Pe!==null&&(dt=de.get(Pe),ct=j,ct.setIndex(dt)),H.isMesh)V.wireframe===!0?(g.setLineWidth(V.wireframeLinewidth*Ge()),ct.setMode(C.LINES)):ct.setMode(C.TRIANGLES);else if(H.isLine){let bt=V.linewidth;bt===void 0&&(bt=1),g.setLineWidth(bt*Ge()),H.isLineSegments?ct.setMode(C.LINES):H.isLineLoop?ct.setMode(C.LINE_LOOP):ct.setMode(C.LINE_STRIP)}else H.isPoints?ct.setMode(C.POINTS):H.isSprite&&ct.setMode(C.TRIANGLES);if(H.isBatchedMesh)if(Xe.get("WEBGL_multi_draw"))ct.renderMultiDraw(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount);else{const bt=H._multiDrawStarts,Re=H._multiDrawCounts,Ct=H._multiDrawCount,it=Pe?de.get(Pe).bytesPerElement:1,Ft=W.get(V).currentProgram.getUniforms();for(let Yt=0;Yt<Ct;Yt++)Ft.setValue(C,"_gl_DrawID",Yt),ct.render(bt[Yt]/it,Re[Yt])}else if(H.isInstancedMesh)ct.renderInstances(Le,vt,H.count);else if(Y.isInstancedBufferGeometry){const bt=Y._maxInstanceCount!==void 0?Y._maxInstanceCount:1/0,Re=Math.min(Y.instanceCount,bt);ct.renderInstances(Le,vt,Re)}else ct.render(Le,vt)};function ns(v,I,Y,V){G!==null&&v.isNodeMaterial&&G.setObject(V,v),ee===!0&&Fe.setState(v,Y,!1),v.transparent===!0&&v.side===2&&v.forceSinglePass===!1?(v.side=1,v.needsUpdate=!0,Ai(v,I,V),v.side=0,v.needsUpdate=!0,Ai(v,I,V),v.side=2):Ai(v,I,V)}this.compile=function(v,I,Y=null){Y===null&&(Y=v),G!==null&&G.renderStart(v,I,Y),y=me.get(Y),y.init(I),x.push(y),Y.traverseVisible(function(H){H.isLight&&H.layers.test(I.layers)&&(y.pushLight(H),H.castShadow&&y.pushShadow(H))}),v!==Y&&v.traverseVisible(function(H){H.isLight&&H.layers.test(I.layers)&&(y.pushLight(H),H.castShadow&&y.pushShadow(H))}),y.setupLights(),G!==null&&G.updateLights(y.state.lightsArray),se=this.localClippingEnabled,ee=Fe.init(this.clippingPlanes,se),ee===!0&&Fe.setGlobalState(this.clippingPlanes,I),G!==null&&ze.render(y.state.shadowsArray,Y,I);const V=new Set;return v.traverse(function(H){if(!(H.isMesh||H.isPoints||H.isLine||H.isSprite))return;const ye=H.material;if(ye)if(Array.isArray(ye))for(let we=0;we<ye.length;we++){const Se=ye[we];ns(Se,Y,I,H),V.add(Se)}else ns(ye,Y,I,H),V.add(ye)}),y=x.pop(),G!==null&&G.renderEnd(),V},this.compileAsync=function(v,I,Y=null){const V=this.compile(v,I,Y);return new Promise(H=>{function ye(){if(V.forEach(function(we){const Pe=W.get(we).currentProgram;(Pe===void 0||Pe.isReady())&&V.delete(we)}),V.size===0){H(v);return}setTimeout(ye,10)}Xe.get("KHR_parallel_shader_compile")!==null?ye():setTimeout(ye,10)})};let ar=null;function qa(v){ar&&ar(v)}function is(){Sn.stop()}function rs(){Sn.start()}const Sn=new Fa;Sn.setAnimationLoop(qa),typeof self<"u"&&Sn.setContext(self),this.setAnimationLoop=function(v){ar=v,Ie.setAnimationLoop(v),v===null?Sn.stop():Sn.start()},Ie.addEventListener("sessionstart",is),Ie.addEventListener("sessionend",rs),this.render=function(v,I){if(I!==void 0&&I.isCamera!==!0){rt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(N===!0)return;G!==null&&G.renderStart(v,I);const Y=Ie.enabled===!0&&Ie.isPresenting===!0,V=A!==null&&(ae===null||Y)&&A.begin(P,ae);if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),Ie.enabled===!0&&Ie.isPresenting===!0&&(A===null||A.isCompositing()===!1)&&(Ie.cameraAutoUpdate===!0&&Ie.updateCamera(I),I=Ie.getCamera()),v.isScene===!0&&v.onBeforeRender(P,v,I,ae),y=me.get(v,x.length),y.init(I),y.state.textureUnits=K.getTextureUnits(),x.push(y),te.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),X.setFromProjectionMatrix(te,2e3,I.reversedDepth),se=this.localClippingEnabled,ee=Fe.init(this.clippingPlanes,se),b=xe.get(v,w.length),b.init(),w.push(b),Ie.enabled===!0&&Ie.isPresenting===!0){const we=P.xr.getDepthSensingMesh();we!==null&&or(we,I,-1/0,P.sortObjects)}or(v,I,0,P.sortObjects),b.finish(),G!==null&&G.updateLights(y.state.lightsArray),P.sortObjects===!0&&b.sort(F,ce),Be=Ie.enabled===!1||Ie.isPresenting===!1||Ie.hasDepthSensing()===!1,Be&&qe.addToRenderList(b,v),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),ee===!0&&Fe.beginShadows();const H=y.state.shadowsArray;if(ze.render(H,v,I),ee===!0&&Fe.endShadows(),(V&&A.hasRenderPass())===!1){const we=b.opaque,Se=b.transmissive;if(y.setupLights(),I.isArrayCamera){const Pe=I.cameras;if(Se.length>0)for(let Ne=0,Ze=Pe.length;Ne<Ze;Ne++){const $e=Pe[Ne];as(we,Se,v,$e)}Be&&qe.render(v);for(let Ne=0,Ze=Pe.length;Ne<Ze;Ne++){const $e=Pe[Ne];ss(b,v,$e,$e.viewport)}}else Se.length>0&&as(we,Se,v,I),Be&&qe.render(v),ss(b,v,I)}ae!==null&&q===0&&(K.updateMultisampleRenderTarget(ae),K.updateRenderTargetMipmap(ae)),V&&A.end(P),v.isScene===!0&&v.onAfterRender(P,v,I),Ee.resetDefaultState(),Z=-1,ne=null,x.pop(),x.length>0?(y=x[x.length-1],K.setTextureUnits(y.state.textureUnits),ee===!0&&Fe.setGlobalState(P.clippingPlanes,y.state.camera)):y=null,w.pop(),w.length>0?b=w[w.length-1]:b=null,G!==null&&G.renderEnd()};function or(v,I,Y,V){if(v.visible===!1)return;if(v.layers.test(I.layers)){if(v.isGroup)Y=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(I);else if(v.isLightProbeGrid)y.pushLightProbeGrid(v);else if(v.isLight)y.pushLight(v),v.castShadow&&y.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||v.intersectsFrustum(X)){V&&Te.setFromMatrixPosition(v.matrixWorld).applyMatrix4(te);const we=re.update(v),Se=v.material;Se.visible&&b.push(v,we,Se,Y,Te.z,null,I)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||v.intersectsFrustum(X))){const we=re.update(v),Se=v.material;if(V&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),Te.copy(v.boundingSphere.center)):(we.boundingSphere===null&&we.computeBoundingSphere(),Te.copy(we.boundingSphere.center)),Te.applyMatrix4(v.matrixWorld).applyMatrix4(te)),Array.isArray(Se)){const Pe=we.groups;for(let Ne=0,Ze=Pe.length;Ne<Ze;Ne++){const $e=Pe[Ne],Le=Se[$e.materialIndex];Le&&Le.visible&&b.push(v,we,Le,Y,Te.z,$e,I)}}else Se.visible&&b.push(v,we,Se,Y,Te.z,null,I)}}const ye=v.children;for(let we=0,Se=ye.length;we<Se;we++)or(ye[we],I,Y,V)}function ss(v,I,Y,V){const{opaque:H,transmissive:ye,transparent:we}=v;y.setupLightsView(Y),ee===!0&&Fe.setGlobalState(P.clippingPlanes,Y),V&&g.viewport(ie.copy(V)),H.length>0&&bi(H,I,Y),ye.length>0&&bi(ye,I,Y),we.length>0&&bi(we,I,Y),g.buffers.depth.setTest(!0),g.buffers.depth.setMask(!0),g.buffers.color.setMask(!0),g.setPolygonOffset(!1)}function as(v,I,Y,V){if((Y.isScene===!0?Y.overrideMaterial:null)!==null)return;if(y.state.transmissionRenderTarget[V.id]===void 0){const Le=Xe.has("EXT_color_buffer_half_float")||Xe.has("EXT_color_buffer_float");y.state.transmissionRenderTarget[V.id]=new Xt(1,1,{generateMipmaps:!0,type:Le?1016:1009,minFilter:1008,samples:Math.max(4,E.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:tt.workingColorSpace})}const ye=y.state.transmissionRenderTarget[V.id],we=V.viewport||ie;ye.setSize(we.z*P.transmissionResolutionScale,we.w*P.transmissionResolutionScale);const Se=P.getRenderTarget(),Pe=P.getActiveCubeFace(),Ne=P.getActiveMipmapLevel();P.setRenderTarget(ye),P.getClearColor(nt),Ye=P.getClearAlpha(),Ye<1&&P.setClearColor(16777215,.5),P.clear(),Be&&qe.render(Y);const Ze=P.toneMapping;P.toneMapping=0;const $e=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),y.setupLightsView(V),ee===!0&&Fe.setGlobalState(P.clippingPlanes,V),bi(v,Y,V),K.updateMultisampleRenderTarget(ye),K.updateRenderTargetMipmap(ye),Xe.has("WEBGL_multisampled_render_to_texture")===!1){let Le=!1;for(let at=0,vt=I.length;at<vt;at++){const dt=I[at],{object:ct,geometry:bt,material:Re,group:Ct}=dt;if(Re.side===2&&ct.layers.test(V.layers)){const it=Re.side;Re.side=1,Re.needsUpdate=!0,os(ct,Y,V,bt,Re,Ct),Re.side=it,Re.needsUpdate=!0,Le=!0}}Le===!0&&(K.updateMultisampleRenderTarget(ye),K.updateRenderTargetMipmap(ye))}P.setRenderTarget(Se,Pe,Ne),P.setClearColor(nt,Ye),$e!==void 0&&(V.viewport=$e),P.toneMapping=Ze}function bi(v,I,Y){const V=I.isScene===!0?I.overrideMaterial:null;for(let H=0,ye=v.length;H<ye;H++){const we=v[H],{object:Se,geometry:Pe,group:Ne}=we;let Ze=we.material;Ze.allowOverride===!0&&V!==null&&(Ze=V),Se.layers.test(Y.layers)&&os(Se,I,Y,Pe,Ze,Ne)}}function os(v,I,Y,V,H,ye){G!==null&&H.isNodeMaterial&&G.setObject(v,H),v.onBeforeRender(P,I,Y,V,H,ye),v.modelViewMatrix.multiplyMatrices(Y.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),H.onBeforeRender(P,I,Y,V,v,ye),H.transparent===!0&&H.side===2&&H.forceSinglePass===!1?(H.side=1,H.needsUpdate=!0,P.renderBufferDirect(Y,I,V,H,v,ye),H.side=0,H.needsUpdate=!0,P.renderBufferDirect(Y,I,V,H,v,ye),H.side=2):P.renderBufferDirect(Y,I,V,H,v,ye),v.onAfterRender(P,I,Y,V,H,ye)}function Ai(v,I,Y){I.isScene!==!0&&(I=be);const V=W.get(v),H=y.state.lights,ye=y.state.shadowsArray,we=H.state.version,Se=pe.getParameters(v,H.state,ye,I,Y,y.state.lightProbeGridArray),Pe=pe.getProgramCacheKey(Se);let Ne=V.programs;V.environment=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?I.environment:null,V.fog=I.fog;const Ze=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap;V.envMap=ue.get(v.envMap||V.environment,Ze),V.envMapRotation=V.environment!==null&&v.envMap===null?I.environmentRotation:v.envMapRotation,Ne===void 0&&(v.addEventListener("dispose",qt),Ne=new Map,V.programs=Ne);let $e=Ne.get(Pe);if($e!==void 0){if(V.currentProgram===$e&&V.lightsStateVersion===we)return cs(v,Se),$e}else Se.uniforms=pe.getUniforms(v),G!==null&&v.isNodeMaterial&&G.build(v,Y,Se),v.onBeforeCompile(Se,P),$e=pe.acquireProgram(Se,Pe),Ne.set(Pe,$e),V.uniforms=Se.uniforms;const Le=V.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(Le.clippingPlanes=Fe.uniform),cs(v,Se),V.needsLights=Ka(v),V.lightsStateVersion=we,V.needsLights&&(Le.ambientLightColor.value=H.state.ambient,Le.lightProbe.value=H.state.probe,Le.sunLights.value=H.state.sun,Le.sunLightShadows.value=H.state.sunShadow,Le.directionalLights.value=H.state.directional,Le.directionalLightShadows.value=H.state.directionalShadow,Le.spotLights.value=H.state.spot,Le.spotLightShadows.value=H.state.spotShadow,Le.rectAreaLights.value=H.state.rectArea,Le.ltc_1.value=H.state.rectAreaLTC1,Le.ltc_2.value=H.state.rectAreaLTC2,Le.pointLights.value=H.state.point,Le.pointLightShadows.value=H.state.pointShadow,Le.hemisphereLights.value=H.state.hemi,Le.sunShadowMatrix.value=H.state.sunShadowMatrix,Le.sunShadowCascade.value=H.state.sunShadowCascade,Le.directionalShadowMatrix.value=H.state.directionalShadowMatrix,Le.spotLightMatrix.value=H.state.spotLightMatrix,Le.spotLightMap.value=H.state.spotLightMap,Le.pointShadowMatrix.value=H.state.pointShadowMatrix),V.lightProbeGrid=y.state.lightProbeGridArray.length>0,V.currentProgram=$e,V.uniformsList=null,$e}function ls(v){if(v.uniformsList===null){const I=v.currentProgram.getUniforms();v.uniformsList=Qi.seqWithValue(I.seq,v.uniforms)}return v.uniformsList}function cs(v,I){const Y=W.get(v);Y.outputColorSpace=I.outputColorSpace,Y.batching=I.batching,Y.batchingColor=I.batchingColor,Y.instancing=I.instancing,Y.instancingColor=I.instancingColor,Y.instancingMorph=I.instancingMorph,Y.skinning=I.skinning,Y.morphTargets=I.morphTargets,Y.morphNormals=I.morphNormals,Y.morphColors=I.morphColors,Y.morphTargetsCount=I.morphTargetsCount,Y.numClippingPlanes=I.numClippingPlanes,Y.numIntersection=I.numClipIntersection,Y.vertexAlphas=I.vertexAlphas,Y.vertexTangents=I.vertexTangents,Y.toneMapping=I.toneMapping}function Ya(v,I){if(v.length===0)return null;if(v.length===1)return v[0].texture!==null?v[0]:null;S.setFromMatrixPosition(I.matrixWorld);for(let Y=0,V=v.length;Y<V;Y++){const H=v[Y];if(H.texture!==null&&H.boundingBox.containsPoint(S))return H}return null}function Za(v,I,Y,V,H){I.isScene!==!0&&(I=be),K.resetTextureUnits();const ye=I.fog,we=V.isMeshStandardMaterial||V.isMeshLambertMaterial||V.isMeshPhongMaterial?I.environment:null,Se=ae===null?P.outputColorSpace:ae.isXRRenderTarget===!0?ae.texture.colorSpace:tt.workingColorSpace,Pe=V.isMeshStandardMaterial||V.isMeshLambertMaterial&&!V.envMap||V.isMeshPhongMaterial&&!V.envMap,Ne=ue.get(V.envMap||we,Pe),Ze=V.vertexColors===!0&&!!Y.attributes.color&&Y.attributes.color.itemSize===4,$e=!!Y.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),Le=!!Y.morphAttributes.position,at=!!Y.morphAttributes.normal,vt=!!Y.morphAttributes.color;let dt=0;V.toneMapped&&(ae===null||ae.isXRRenderTarget===!0)&&(dt=P.toneMapping);const ct=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,bt=ct!==void 0?ct.length:0,Re=W.get(V),Ct=y.state.lights;if(ee===!0&&(se===!0||v!==ne)){const ft=v===ne&&V.id===Z;Fe.setState(V,v,ft)}let it=!1;V.version===Re.__version?(Re.needsLights&&Re.lightsStateVersion!==Ct.state.version||Re.outputColorSpace!==Se||H.isBatchedMesh&&Re.batching===!1||!H.isBatchedMesh&&Re.batching===!0||H.isBatchedMesh&&Re.batchingColor===!0&&H._colorsTexture===null||H.isBatchedMesh&&Re.batchingColor===!1&&H._colorsTexture!==null||H.isInstancedMesh&&Re.instancing===!1||!H.isInstancedMesh&&Re.instancing===!0||H.isSkinnedMesh&&Re.skinning===!1||!H.isSkinnedMesh&&Re.skinning===!0||H.isInstancedMesh&&Re.instancingColor===!0&&H.instanceColor===null||H.isInstancedMesh&&Re.instancingColor===!1&&H.instanceColor!==null||H.isInstancedMesh&&Re.instancingMorph===!0&&H.morphTexture===null||H.isInstancedMesh&&Re.instancingMorph===!1&&H.morphTexture!==null||Re.envMap!==Ne||V.fog===!0&&Re.fog!==ye||Re.numClippingPlanes!==void 0&&(Re.numClippingPlanes!==Fe.numPlanes||Re.numIntersection!==Fe.numIntersection)||Re.vertexAlphas!==Ze||Re.vertexTangents!==$e||Re.morphTargets!==Le||Re.morphNormals!==at||Re.morphColors!==vt||Re.toneMapping!==dt||Re.morphTargetsCount!==bt||!!Re.lightProbeGrid!=y.state.lightProbeGridArray.length>0)&&(it=!0):(it=!0,Re.__version=V.version);let Ft=Re.currentProgram;it===!0&&(Ft=Ai(V,I,H),G&&V.isNodeMaterial&&G.onUpdateProgram(V,Ft,Re));let Yt=!1,cn=!1,Pn=!1;const lt=Ft.getUniforms(),_t=Re.uniforms;if(g.useProgram(Ft.program)&&(Yt=!0,cn=!0,Pn=!0),V.id!==Z&&(Z=V.id,cn=!0),Re.needsLights){const ft=Ya(y.state.lightProbeGridArray,H);Re.lightProbeGrid!==ft&&(Re.lightProbeGrid=ft,cn=!0)}if(Yt||ne!==v){g.buffers.depth.getReversed()&&v.reversedDepth!==!0&&(v._reversedDepth=!0,v.updateProjectionMatrix()),lt.setValue(C,"projectionMatrix",v.projectionMatrix),lt.setValue(C,"viewMatrix",v.matrixWorldInverse);const un=lt.map.cameraPosition;un!==void 0&&un.setValue(C,he.setFromMatrixPosition(v.matrixWorld)),E.logarithmicDepthBuffer&&lt.setValue(C,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&lt.setValue(C,"isOrthographic",v.isOrthographicCamera===!0),ne!==v&&(ne=v,cn=!0,Pn=!0)}if(Re.needsLights&&(Ct.state.sunShadowMap.length>0&&lt.setValue(C,"sunShadowMap",Ct.state.sunShadowMap,K),Ct.state.directionalShadowMap.length>0&&lt.setValue(C,"directionalShadowMap",Ct.state.directionalShadowMap,K),Ct.state.spotShadowMap.length>0&&lt.setValue(C,"spotShadowMap",Ct.state.spotShadowMap,K),Ct.state.pointShadowMap.length>0&&lt.setValue(C,"pointShadowMap",Ct.state.pointShadowMap,K)),H.isSkinnedMesh){lt.setOptional(C,H,"bindMatrix"),lt.setOptional(C,H,"bindMatrixInverse");const ft=H.skeleton;ft&&(ft.boneTexture===null&&ft.computeBoneTexture(),lt.setValue(C,"boneTexture",ft.boneTexture,K))}H.isBatchedMesh&&(lt.setOptional(C,H,"batchingTexture"),lt.setValue(C,"batchingTexture",H._matricesTexture,K),lt.setOptional(C,H,"batchingIdTexture"),lt.setValue(C,"batchingIdTexture",H._indirectTexture,K),lt.setOptional(C,H,"batchingColorTexture"),H._colorsTexture!==null&&lt.setValue(C,"batchingColorTexture",H._colorsTexture,K));const hn=Y.morphAttributes;if((hn.position!==void 0||hn.normal!==void 0||hn.color!==void 0)&&U.update(H,Y,Ft),(cn||Re.receiveShadow!==H.receiveShadow)&&(Re.receiveShadow=H.receiveShadow,lt.setValue(C,"receiveShadow",H.receiveShadow)),(V.isMeshStandardMaterial||V.isMeshLambertMaterial||V.isMeshPhongMaterial)&&V.envMap===null&&I.environment!==null&&(_t.envMapIntensity.value=I.environmentIntensity),_t.dfgLUT!==void 0&&(_t.dfgLUT.value=Sd()),cn){if(lt.setValue(C,"toneMappingExposure",P.toneMappingExposure),Re.needsLights&&Ja(_t,Pn),ye&&V.fog===!0&&Ue.refreshFogUniforms(_t,ye),Ue.refreshMaterialUniforms(_t,V,L,J,y.state.transmissionRenderTarget[v.id]),Re.needsLights&&Re.lightProbeGrid){const ft=Re.lightProbeGrid;_t.probesSH.value=ft.texture,_t.probesMin.value.copy(ft.boundingBox.min),_t.probesMax.value.copy(ft.boundingBox.max),_t.probesResolution.value.copy(ft.resolution)}Qi.upload(C,ls(Re),_t,K)}if(V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(Qi.upload(C,ls(Re),_t,K),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&lt.setValue(C,"center",H.center),lt.setValue(C,"modelViewMatrix",H.modelViewMatrix),lt.setValue(C,"normalMatrix",H.normalMatrix),lt.setValue(C,"modelMatrix",H.matrixWorld),V.uniformsGroups!==void 0){const ft=V.uniformsGroups;for(let un=0,Ln=ft.length;un<Ln;un++){const us=ft[un];oe.update(us,Ft),oe.bind(us,Ft)}}return Ft}function Ja(v,I){v.ambientLightColor.needsUpdate=I,v.lightProbe.needsUpdate=I,v.sunLights.needsUpdate=I,v.sunLightShadows.needsUpdate=I,v.directionalLights.needsUpdate=I,v.directionalLightShadows.needsUpdate=I,v.pointLights.needsUpdate=I,v.pointLightShadows.needsUpdate=I,v.spotLights.needsUpdate=I,v.spotLightShadows.needsUpdate=I,v.rectAreaLights.needsUpdate=I,v.hemisphereLights.needsUpdate=I}function Ka(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return $},this.getActiveMipmapLevel=function(){return q},this.getRenderTarget=function(){return ae},this.setRenderTargetTextures=function(v,I,Y){const V=W.get(v);V.__autoAllocateDepthBuffer=v.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),W.get(v.texture).__webglTexture=I,W.get(v.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:Y,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(v,I){const Y=W.get(v);Y.__webglFramebuffer=I,Y.__useDefaultFramebuffer=I===void 0},this.setRenderTarget=function(v,I=0,Y=0){ae=v,$=I,q=Y;let V=null,H=!1,ye=!1;if(v){const Se=W.get(v);if(Se.__useDefaultFramebuffer!==void 0){g.bindFramebuffer(C.FRAMEBUFFER,Se.__webglFramebuffer),ie.copy(v.viewport),De.copy(v.scissor),Ae=v.scissorTest,g.viewport(ie),g.scissor(De),g.setScissorTest(Ae),Z=-1;return}else if(Se.__webglFramebuffer===void 0)K.setupRenderTarget(v);else if(Se.__hasExternalTextures)K.rebindTextures(v,W.get(v.texture).__webglTexture,W.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const Ze=v.depthTexture;if(Se.__boundDepthTexture!==Ze){if(Ze!==null&&W.has(Ze)&&(v.width!==Ze.image.width||v.height!==Ze.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");K.setupDepthRenderbuffer(v)}}const Pe=v.texture;(Pe.isData3DTexture||Pe.isDataArrayTexture||Pe.isCompressedArrayTexture)&&(ye=!0);const Ne=W.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(Ne[I])?V=Ne[I][Y]:V=Ne[I],H=!0):v.samples>0&&K.useMultisampledRTT(v)===!1?V=W.get(v).__webglMultisampledFramebuffer:Array.isArray(Ne)?V=Ne[Y]:V=Ne,ie.copy(v.viewport),De.copy(v.scissor),Ae=v.scissorTest}else ie.copy(le).multiplyScalar(L).floor(),De.copy(Me).multiplyScalar(L).floor(),Ae=Ve;if(Y!==0&&(V=k),g.bindFramebuffer(C.FRAMEBUFFER,V)&&g.drawBuffers(v,V),g.viewport(ie),g.scissor(De),g.setScissorTest(Ae),H){const Se=W.get(v.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+I,Se.__webglTexture,Y)}else if(ye){const Se=I;for(let Pe=0;Pe<v.textures.length;Pe++){const Ne=W.get(v.textures[Pe]);C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0+Pe,Ne.__webglTexture,Y,Se)}}else if(v!==null&&Y!==0){const Se=W.get(v.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Se.__webglTexture,Y)}Z=-1};function hs(v){const I=W.get(v);return(I.__readFormat!==v.format||I.__readType!==v.type)&&(I.__readFormat=v.format,I.__readType=v.type,I.__formatReadable=E.textureFormatReadable(v.format),I.__typeReadable=E.textureTypeReadable(v.type)),I}this.readRenderTargetPixels=function(v,I,Y,V,H,ye,we,Se=0){if(!(v&&v.isWebGLRenderTarget)){rt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Pe=W.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&we!==void 0&&(Pe=Pe[we]),Pe){g.bindFramebuffer(C.FRAMEBUFFER,Pe);try{const Ne=v.textures[Se],Ze=Ne.format,$e=Ne.type;v.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+Se);const Le=hs(Ne);if(Le.__formatReadable===!1){rt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(Le.__typeReadable===!1){rt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=v.width-V&&Y>=0&&Y<=v.height-H&&C.readPixels(I,Y,V,H,_e.convert(Ze),_e.convert($e),ye)}finally{const Ne=ae!==null?W.get(ae).__webglFramebuffer:null;g.bindFramebuffer(C.FRAMEBUFFER,Ne)}}},this.readRenderTargetPixelsAsync=async function(v,I,Y,V,H,ye,we,Se=0){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Pe=W.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&we!==void 0&&(Pe=Pe[we]),Pe)if(I>=0&&I<=v.width-V&&Y>=0&&Y<=v.height-H){g.bindFramebuffer(C.FRAMEBUFFER,Pe);const Ne=v.textures[Se],Ze=Ne.format,$e=Ne.type;v.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+Se);const Le=hs(Ne);if(Le.__formatReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(Le.__typeReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const at=C.createBuffer();C.bindBuffer(C.PIXEL_PACK_BUFFER,at),C.bufferData(C.PIXEL_PACK_BUFFER,ye.byteLength,C.STREAM_READ),C.readPixels(I,Y,V,H,_e.convert(Ze),_e.convert($e),0),C.bindBuffer(C.PIXEL_PACK_BUFFER,null);const vt=ae!==null?W.get(ae).__webglFramebuffer:null;g.bindFramebuffer(C.FRAMEBUFFER,vt);const dt=C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE,0);return C.flush(),await ja(C,dt,4),C.bindBuffer(C.PIXEL_PACK_BUFFER,at),C.getBufferSubData(C.PIXEL_PACK_BUFFER,0,ye),C.bindBuffer(C.PIXEL_PACK_BUFFER,null),C.deleteBuffer(at),C.deleteSync(dt),ye}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(v,I=null,Y=0){const V=Math.pow(2,-Y),H=Math.floor(v.image.width*V),ye=Math.floor(v.image.height*V),we=I!==null?I.x:0,Se=I!==null?I.y:0;K.setTexture2D(v,0),C.copyTexSubImage2D(C.TEXTURE_2D,Y,0,0,we,Se,H,ye),g.unbindTexture()},this.copyTextureToTexture=function(v,I,Y=null,V=null,H=0,ye=0){let we,Se,Pe,Ne,Ze,$e,Le,at,vt;const dt=v.isCompressedTexture?v.mipmaps[ye]:v.image;if(Y!==null)we=Y.max.x-Y.min.x,Se=Y.max.y-Y.min.y,Pe=Y.isBox3?Y.max.z-Y.min.z:1,Ne=Y.min.x,Ze=Y.min.y,$e=Y.isBox3?Y.min.z:0;else{const _t=Math.pow(2,-H);we=Math.floor(dt.width*_t),Se=Math.floor(dt.height*_t),v.isDataArrayTexture?Pe=dt.depth:v.isData3DTexture?Pe=Math.floor(dt.depth*_t):Pe=1,Ne=0,Ze=0,$e=0}V!==null?(Le=V.x,at=V.y,vt=V.z):(Le=0,at=0,vt=0);const ct=_e.convert(I.format),bt=_e.convert(I.type);let Re;I.isData3DTexture?(K.setTexture3D(I,0),Re=C.TEXTURE_3D):I.isDataArrayTexture||I.isCompressedArrayTexture?(K.setTexture2DArray(I,0),Re=C.TEXTURE_2D_ARRAY):(K.setTexture2D(I,0),Re=C.TEXTURE_2D),g.activeTexture(C.TEXTURE0),g.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,I.flipY),g.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,I.premultiplyAlpha),g.pixelStorei(C.UNPACK_ALIGNMENT,I.unpackAlignment);const Ct=g.getParameter(C.UNPACK_ROW_LENGTH),it=g.getParameter(C.UNPACK_IMAGE_HEIGHT),Ft=g.getParameter(C.UNPACK_SKIP_PIXELS),Yt=g.getParameter(C.UNPACK_SKIP_ROWS),cn=g.getParameter(C.UNPACK_SKIP_IMAGES);g.pixelStorei(C.UNPACK_ROW_LENGTH,dt.width),g.pixelStorei(C.UNPACK_IMAGE_HEIGHT,dt.height),g.pixelStorei(C.UNPACK_SKIP_PIXELS,Ne),g.pixelStorei(C.UNPACK_SKIP_ROWS,Ze),g.pixelStorei(C.UNPACK_SKIP_IMAGES,$e);const Pn=v.isDataArrayTexture||v.isData3DTexture,lt=I.isDataArrayTexture||I.isData3DTexture;if(v.isDepthTexture){const _t=W.get(v),hn=W.get(I),ft=W.get(_t.__renderTarget),un=W.get(hn.__renderTarget);g.bindFramebuffer(C.READ_FRAMEBUFFER,ft.__webglFramebuffer),g.bindFramebuffer(C.DRAW_FRAMEBUFFER,un.__webglFramebuffer);for(let Ln=0;Ln<Pe;Ln++)Pn&&(C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,W.get(v).__webglTexture,H,$e+Ln),C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,W.get(I).__webglTexture,ye,vt+Ln)),C.blitFramebuffer(Ne,Ze,we,Se,Le,at,we,Se,C.DEPTH_BUFFER_BIT,C.NEAREST);g.bindFramebuffer(C.READ_FRAMEBUFFER,null),g.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else if(H!==0||v.isRenderTargetTexture||W.has(v)){const _t=W.get(v),hn=W.get(I);g.bindFramebuffer(C.READ_FRAMEBUFFER,D),g.bindFramebuffer(C.DRAW_FRAMEBUFFER,z);for(let ft=0;ft<Pe;ft++)Pn?C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,_t.__webglTexture,H,$e+ft):C.framebufferTexture2D(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,_t.__webglTexture,H),lt?C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,hn.__webglTexture,ye,vt+ft):C.framebufferTexture2D(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,hn.__webglTexture,ye),H!==0?C.blitFramebuffer(Ne,Ze,we,Se,Le,at,we,Se,C.COLOR_BUFFER_BIT,C.NEAREST):lt?C.copyTexSubImage3D(Re,ye,Le,at,vt+ft,Ne,Ze,we,Se):C.copyTexSubImage2D(Re,ye,Le,at,Ne,Ze,we,Se);g.bindFramebuffer(C.READ_FRAMEBUFFER,null),g.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else lt?v.isDataTexture||v.isData3DTexture?C.texSubImage3D(Re,ye,Le,at,vt,we,Se,Pe,ct,bt,dt.data):I.isCompressedArrayTexture?C.compressedTexSubImage3D(Re,ye,Le,at,vt,we,Se,Pe,ct,dt.data):C.texSubImage3D(Re,ye,Le,at,vt,we,Se,Pe,ct,bt,dt):v.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,ye,Le,at,we,Se,ct,bt,dt.data):v.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,ye,Le,at,dt.width,dt.height,ct,dt.data):C.texSubImage2D(C.TEXTURE_2D,ye,Le,at,we,Se,ct,bt,dt);g.pixelStorei(C.UNPACK_ROW_LENGTH,Ct),g.pixelStorei(C.UNPACK_IMAGE_HEIGHT,it),g.pixelStorei(C.UNPACK_SKIP_PIXELS,Ft),g.pixelStorei(C.UNPACK_SKIP_ROWS,Yt),g.pixelStorei(C.UNPACK_SKIP_IMAGES,cn),ye===0&&I.generateMipmaps&&C.generateMipmap(Re),g.unbindTexture()},this.initRenderTarget=function(v){W.get(v).__webglFramebuffer===void 0&&K.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?K.setTextureCube(v,0):v.isData3DTexture?K.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?K.setTexture2DArray(v,0):K.setTexture2D(v,0),g.unbindTexture()},this.resetState=function(){$=0,q=0,ae=null,g.reset(),Ee.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return 2e3}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=tt._getDrawingBufferColorSpace(e),t.unpackColorSpace=tt._getUnpackColorSpace()}}class yd extends _a{constructor(){super(),this.name="RoomEnvironment",this.position.y=-3.5;const e=new ii;e.deleteAttribute("uv");const t=new Jn({side:1}),n=new Jn,r=new xl(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);const s=new xt(e,t);s.position.set(-.757,13.219,.717),s.scale.set(31.713,28.305,28.591),this.add(s);const a=new bo(e,n,6),o=new Tt;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);const c=new xt(e,qn(50));c.position.set(-16.116,14.37,8.208),c.scale.set(.1,2.428,2.739),this.add(c);const l=new xt(e,qn(50));l.position.set(-16.109,18.021,-8.207),l.scale.set(.1,2.425,2.751),this.add(l);const u=new xt(e,qn(17));u.position.set(14.904,12.198,-1.832),u.scale.set(.15,4.265,6.331),this.add(u);const d=new xt(e,qn(43));d.position.set(-.462,8.89,14.52),d.scale.set(4.38,5.441,.088),this.add(d);const h=new xt(e,qn(20));h.position.set(3.235,11.486,-12.541),h.scale.set(2.5,2,.1),this.add(h);const f=new xt(e,qn(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){const e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(const t of e)t.dispose()}}function qn(i){return new dl({color:0,emissive:16777215,emissiveIntensity:i})}function Ed(i,e){let t;try{t=new Md({alpha:!0,antialias:!0})}catch{return()=>{}}i.replaceChildren(t.domElement),t.setPixelRatio(Math.min(devicePixelRatio,1.5)),t.shadowMap.enabled=!0,t.shadowMap.type=2,t.toneMapping=4,t.toneMappingExposure=1.25;const n=new _a,r=new Wr(t),s=new yd,a=r.fromScene(s,.04);n.environment=a.texture,s.dispose(),r.dispose();const o=new ir,c=.68,l=Math.sin(c);n.add(new gl(16777215,9273717,2.3));const u=new Sl(16774110,3.2);u.position.set(-250,650,200),u.castShadow=!0,u.shadow.mapSize.set(1024,1024),u.shadow.bias=-1e-4,u.shadow.normalBias=.3,n.add(u,u.target);const d=new xt(new Ti(6e3,6e3),new ol({opacity:.2}));d.rotation.x=-Math.PI/2,d.receiveShadow=!0,n.add(d);const h=new Jn({color:12239820,metalness:.88,roughness:.25}),f=new Jn({color:2107187,metalness:.5,roughness:.34}),_=new Jn({color:14134614,metalness:.75,roughness:.27}),M=[2579150,13124145,14068006,3120496,9067765].map((L,F)=>{const ce=new Yn,le=new Yn;ce.add(le),n.add(ce);const Me=new Jn({color:L,metalness:.35,roughness:.23}),Ve=(se,te,he)=>{const Te=new xt(se,te);return Te.position.y=he,Te.castShadow=!0,Te.receiveShadow=!0,le.add(Te),Te},X=[[.06,0],[.13,.08],[.16,.24],[.27,.3],[.42,.39],[.58,.48],[.72,.56],[.76,.65],[.63,.72]];Ve(new jr(X.map(([se,te])=>new fe(se,te)),48),f,0),Ve(new An(.84,.77,.13,64),h,.66),Ve(new An(.68,.79,.15,48),Me,.79),Ve(new An(.36,.43,.13,48),h,.91),Ve(new An(.29,.34,.09,6),_,1.01),Ve(new nr(.22,24,12,0,Math.PI*2,0,Math.PI/2),Me,1.045);const ee=Ve(new es(.58,.065,10,64),h,.9);ee.rotation.x=Math.PI/2;for(let se=0;se<6;se++){const te=new Ra;te.moveTo(.42,-.13),te.lineTo(.8,-.26),te.lineTo(1.02,-.1),te.lineTo(.9,.17),te.lineTo(.64,.24),te.lineTo(.48,.1),te.closePath(),Ve(new Qr(te,{depth:.13,bevelEnabled:!0,bevelSegments:2,steps:1,bevelSize:.035,bevelThickness:.025}),se%2?Me:h,.81).rotation.set(-Math.PI/2,0,se*Math.PI/3);const Te=Ve(new An(.042,.042,.025,12),f,.98);Te.position.x=Math.cos(se*Math.PI/3)*.48,Te.position.z=Math.sin(se*Math.PI/3)*.48}return{pivot:ce,model:le,index:F,x:0,y:0,vx:0,vy:0,spin:0,angle:0,age:0,life:0,tilt:0,precession:0,phase:"spinning",rest:0,radius:40,mass:1+F*.12}}),m=[],p=new nr(1.3,4,3),T=new Zr({color:16759370});let R=1,S=1,b=[],y=null,w=0,x=0,A=0,P=0,N=!1,G=!0;const k=matchMedia("(prefers-reduced-motion: reduce)"),D=(L,F)=>L+Math.random()*(F-L),z=(L,F)=>[L-R/2,(F-S/2)/l];function $(){P=0,i.dataset.hitCount="0",M.forEach((L,F)=>{const ce=F*Math.PI*2/5,le=Math.floor(Math.random()*3),Me=le===0?R*.2:le===1?R*.5:R*.8;L.x=Me+D(-Math.min(R*.08,56),Math.min(R*.08,56)),L.y=Math.min(S*.3,240)+D(-42,42),L.x=Math.max(L.radius+12,Math.min(R-L.radius-12,L.x)),L.vx=-Math.cos(ce)*D(100,150),L.vy=-Math.sin(ce)*D(100,150),L.spin=D(64,84),L.angle=D(0,6),L.age=0,L.life=85+D(-1.5,1.5),L.tilt=.03,L.precession=ce,L.phase="spinning",L.rest=0})}function q(){const L=i.getBoundingClientRect();R=L.width,S=L.height,t.setSize(R,S),o.left=-R/2,o.right=R/2,o.top=S/2,o.bottom=-S/2,o.near=1,o.far=5e3,o.position.set(0,Math.sin(c)*1800,Math.cos(c)*1800),o.lookAt(0,0,0),o.updateProjectionMatrix();const F=Math.max(R,S);u.shadow.camera.left=-F,u.shadow.camera.right=F,u.shadow.camera.top=F,u.shadow.camera.bottom=-F,u.shadow.camera.far=3e3,u.shadow.camera.updateProjectionMatrix(),M.forEach(ce=>{ce.radius=R<620?26:43,ce.model.scale.setScalar(ce.radius)}),b=[...e.querySelectorAll("[data-battle-obstacle]")].flatMap(ce=>(ce.tagName==="H1"?(()=>{const Me=document.createRange();return Me.selectNodeContents(ce),[...Me.getClientRects()]})():[ce.getBoundingClientRect()]).map(Me=>({l:Me.left-L.left,r:Me.right-L.left,t:Me.top-L.top,b:Me.bottom-L.top}))),$(),ie(),t.render(n,o)}function ae(L,F,ce){if(ce<45||m.length>36)return;const[le,Me]=z(L,F);for(let Ve=0;Ve<6;Ve++){const X=new xt(p,T);X.position.set(le,22,Me),n.add(X),m.push({mesh:X,vx:D(-75,75),vy:D(30,100),vz:D(-75,75),life:.3})}}function Z(L,F,ce,le,Me,Ve){L.x+=F*le,L.y+=ce*le;const X=L.vx*F+L.vy*ce;X<0&&(L.vx-=1.82*X*F,L.vy-=1.82*X*ce,ae(Me,Ve,-X))}function ne(L){M.forEach(F=>{if(F.phase==="resting")return;F.age+=L;const ce=Math.max(0,1-F.age/F.life);F.spin=Math.max(0,65*Math.pow(ce,.75));const le=Math.max(0,1-F.spin/24);F.phase=ce===0?"tumbling":le>.05?"wobbling":"spinning",F.precession+=L*(2+le*9);const Me=ce===0?1.43:.025+le*.48;F.tilt+=(Me-F.tilt)*(1-Math.exp(-L*(ce===0?2.4:5))),ce===0&&(F.rest+=L,F.spin=5*Math.exp(-F.rest*2),F.rest>3&&(F.phase="resting",F.spin=0,F.vx=0,F.vy=0)),F.angle+=F.spin*L;const Ve=F.phase==="tumbling"?2.5:.045;F.phase==="spinning"&&(F.vx+=(R*.77-F.x)*.65*L,F.vy+=(Math.min(S*.3,240)-F.y)*.65*L),F.vx*=Math.exp(-Ve*L),F.vy*=Math.exp(-Ve*L),F.x+=F.vx*L,F.y+=F.vy*L;const X=F.radius+5;F.x<X&&Z(F,1,0,X-F.x,X,F.y),F.x>R-X&&Z(F,-1,0,F.x-R+X,R-X,F.y),F.y<X&&Z(F,0,1,X-F.y,F.x,X),F.y>S-X&&Z(F,0,-1,F.y-S+X,F.x,S-X);for(const ee of b){const se=Math.max(ee.l,Math.min(F.x,ee.r)),te=Math.max(ee.t,Math.min(F.y,ee.b)),he=F.x-se,Te=F.y-te,be=Math.hypot(he,Te);if(be>0&&be<X)Z(F,he/be,Te/be,X-be,se,te);else if(be===0){const Be=[[F.x-ee.l,-1,0],[ee.r-F.x,1,0],[F.y-ee.t,0,-1],[ee.b-F.y,0,1]].sort((Xe,E)=>Xe[0]-E[0]),[Ge,C,et]=Be[0];Z(F,C,et,Ge+X,F.x,F.y)}}if(y){const ee=F.x-y.x,se=F.y-y.y,te=Math.hypot(ee,se);te>0&&te<X+12&&Z(F,ee/te,se/te,X+12-te,y.x,y.y)}}),M.forEach((F,ce)=>M.slice(ce+1).forEach(le=>{const Me=le.x-F.x,Ve=le.y-F.y,X=Math.hypot(Me,Ve),ee=F.radius+le.radius;if(X>=ee||X<.001)return;const se=Me/X,te=Ve/X,he=F.phase==="resting"?0:1/F.mass,Te=le.phase==="resting"?0:1/le.mass,be=he+Te;if(!be)return;F.x-=se*(ee-X)*he/be,F.y-=te*(ee-X)*he/be,le.x+=se*(ee-X)*Te/be,le.y+=te*(ee-X)*Te/be;const Be=(le.vx-F.vx)*se+(le.vy-F.vy)*te;if(Be>=0)return;const Ge=-2.55*D(.92,1.12)*Be/be;F.vx-=Ge*se*he,F.vy-=Ge*te*he,le.vx+=Ge*se*Te,le.vy+=Ge*te*Te;for(const C of[F,le]){const et=Math.hypot(C.vx,C.vy),Xe=360;et>Xe&&(C.vx=C.vx/et*Xe,C.vy=C.vy/et*Xe)}ae((F.x+le.x)/2,(F.y+le.y)/2,-Be),i.dataset.hitCount=String(Number(i.dataset.hitCount||0)+1)}));for(let F=m.length-1;F>=0;F--){const ce=m[F];ce.life-=L,ce.vy-=240*L,ce.mesh.position.x+=ce.vx*L,ce.mesh.position.y+=ce.vy*L,ce.mesh.position.z+=ce.vz*L,ce.mesh.scale.setScalar(Math.max(0,ce.life/.3)),ce.life<=0&&(n.remove(ce.mesh),m.splice(F,1))}M.every(F=>F.phase==="resting")&&(P+=L,P>3&&$())}function ie(){for(const L of M){const[F,ce]=z(L.x,L.y);if(L.phase!=="resting"){const Me=new O(Math.cos(L.precession),0,Math.sin(L.precession));L.pivot.quaternion.setFromAxisAngle(Me,L.tilt),L.model.rotation.y=L.angle}L.pivot.position.set(F,0,ce),L.pivot.updateMatrixWorld(!0);const le=new vn().setFromObject(L.pivot);L.pivot.position.y=-le.min.y+.4}i.dataset.phases=M.map(L=>L.phase).join(",")}function De(L){if(N)return;const F=Math.min(.05,(L-x)/1e3||0);if(x=L,G&&!document.hidden&&!k.matches){for(A+=F;A>=1/120;)ne(1/120),A-=1/120;ie(),t.render(n,o)}w=requestAnimationFrame(De)}const Ae=L=>{if(L.pointerType==="touch")return;const F=i.getBoundingClientRect();y={x:L.clientX-F.left,y:L.clientY-F.top}},nt=()=>{y=null};e.addEventListener("pointermove",Ae),e.addEventListener("pointerleave",nt);const Ye=new ResizeObserver(q);Ye.observe(i);const je=new IntersectionObserver(L=>{G=L[0].isIntersecting});je.observe(e);const J=()=>{$(),ie(),t.render(n,o)};return k.addEventListener("change",J),q(),w=requestAnimationFrame(De),()=>{N=!0,cancelAnimationFrame(w),Ye.disconnect(),je.disconnect(),e.removeEventListener("pointermove",Ae),e.removeEventListener("pointerleave",nt),k.removeEventListener("change",J),n.traverse(L=>{L.geometry&&L.geometry.dispose(),L.material&&L.material.dispose()}),a.dispose(),t.dispose(),t.domElement.remove()}}const Ce=(...i)=>i,wt=(...i)=>[...i,i[0]],ke=(i,e,t,n=0,r=Math.PI*2,s=30)=>Array.from({length:s+1},(a,o)=>{const c=n+(r-n)*o/s;return[i+Math.cos(c)*t,e+Math.sin(c)*t]}),$i=[{name:"portrait",paths:[ke(50,48,25),ke(50,37,26,Math.PI,Math.PI*2),Ce([40,47],[45,47]),Ce([55,47],[60,47]),ke(50,56,7,.1,Math.PI-.1),Ce([35,78],[42,66],[58,66],[66,78])]},{name:"cat",paths:[wt([30,38],[39,23],[48,31],[58,23],[70,38],[67,65],[50,72],[33,65]),Ce([39,49],[45,49]),Ce([55,49],[61,49]),Ce([50,53],[50,59]),Ce([50,59],[39,62]),Ce([50,59],[61,62]),Ce([34,42],[18,37]),Ce([34,49],[16,50]),Ce([66,42],[82,37]),Ce([66,49],[84,50])]},{name:"dinosaur",paths:[wt([18,59],[30,44],[47,42],[58,31],[68,41],[82,43],[72,51],[77,62],[62,67],[58,80],[51,80],[49,67],[39,66],[35,78],[28,78],[29,62]),Ce([61,45],[64,45]),Ce([20,59],[10,51]),Ce([45,42],[41,30]),Ce([52,40],[49,28])]},{name:"landscape",paths:[Ce([8,71],[26,48],[39,65],[57,34],[82,71]),Ce([8,71],[92,71]),Ce([18,71],[31,57],[41,71]),ke(75,30,9),Ce([12,82],[36,77],[57,82],[88,76])]},{name:"rocket",paths:[wt([48,19],[61,36],[59,61],[50,75],[41,61],[39,36]),ke(50,42,7),Ce([41,57],[28,65],[41,67]),Ce([59,57],[72,65],[59,67]),Ce([46,75],[42,88],[50,82],[57,88],[54,75])]},{name:"house",paths:[wt([25,48],[50,25],[75,48],[75,76],[25,76]),wt([44,76],[44,58],[57,58],[57,76]),wt([31,53],[40,53],[40,62],[31,62]),Ce([65,33],[65,22],[72,22],[72,39])]},{name:"flower",paths:[ke(50,50,8),ke(50,35,13),ke(64,45,13),ke(60,61,13),ke(40,61,13),ke(36,45,13),Ce([50,58],[50,82]),ke(43,72,10,.2,2.5),ke(57,67,10,.6,2.9)]},{name:"robot",paths:[wt([27,32],[73,32],[73,71],[27,71]),ke(50,51,4),wt([35,43],[44,43],[44,52],[35,52]),wt([56,43],[65,43],[65,52],[56,52]),Ce([50,32],[50,20]),ke(50,17,3),Ce([27,58],[17,58]),Ce([73,58],[83,58]),Ce([39,80],[39,71]),Ce([61,80],[61,71])]},{name:"fish",paths:[ke(47,51,22),wt([65,51],[84,33],[84,69]),ke(39,47,3),Ce([28,56],[44,62],[57,58]),Ce([19,44],[9,36]),Ce([19,56],[9,64])]},{name:"whale",paths:[wt([19,60],[29,43],[57,40],[73,51],[84,38],[82,57],[90,64],[72,67],[56,77],[32,75]),ke(44,57,3),Ce([55,75],[58,86]),Ce([58,86],[61,75])]},{name:"mountains",paths:[Ce([10,76],[33,31],[51,65],[69,24],[92,76]),Ce([10,76],[92,76]),Ce([28,40],[33,31],[39,44]),Ce([64,34],[69,24],[75,42]),Ce([15,87],[35,82],[56,88],[85,82])]},{name:"coffee",paths:[wt([27,39],[65,39],[65,69],[27,69]),ke(66,53,11,-1.3,1.3),ke(46,79,20,.1,Math.PI-.1),ke(39,29,8,-.2,2.3),ke(53,29,8,-.2,2.3)]},{name:"guitar",paths:[ke(43,60,16),ke(57,43,16),Ce([52,34],[69,17]),wt([68,14],[76,18],[72,25]),ke(43,60,5),Ce([47,55],[71,19])]},{name:"light bulb",paths:[ke(50,43,20,Math.PI*1.08,Math.PI*2.92),Ce([39,61],[43,73],[57,73],[61,61]),Ce([43,78],[57,78]),Ce([46,83],[54,83]),Ce([50,12],[50,4]),Ce([25,22],[18,16]),Ce([75,22],[82,16])]},{name:"planet",paths:[ke(50,50,23),ke(50,50,34,.2,Math.PI-.2),ke(50,50,34,Math.PI+.2,Math.PI*2-.2),ke(43,42,4),ke(61,57,3)]},{name:"tree",paths:[Ce([50,83],[50,54]),Ce([50,65],[35,52]),Ce([50,65],[64,48]),ke(50,42,22),ke(33,52,14),ke(67,52,14),Ce([24,84],[76,84])]},{name:"bicycle",paths:[ke(31,66,15),ke(70,66,15),Ce([31,66],[43,43],[57,66],[31,66]),Ce([43,43],[61,43]),Ce([57,66],[67,35]),Ce([61,43],[68,35]),Ce([41,43],[36,35]),Ce([67,35],[76,35])]},{name:"cassette",paths:[wt([18,32],[82,32],[82,70],[18,70]),ke(37,51,9),ke(63,51,9),Ce([46,51],[54,51]),wt([34,37],[66,37],[66,43],[34,43]),Ce([40,66],[60,66])]},{name:"snail",paths:[ke(42,58,20),ke(42,58,10),Ce([60,68],[80,68],[85,60]),Ce([80,68],[85,78]),Ce([77,58],[79,48]),Ce([84,58],[88,48]),ke(79,48,2),ke(88,48,2)]},{name:"hero insignia",paths:[ke(50,50,29),wt([33,67],[51,27],[68,67],[57,58],[50,70],[43,58]),Ce([41,54],[59,54]),ke(50,50,21)]}],Td=i=>i.slice(1).reduce((e,t,n)=>e+Math.hypot(t[0]-i[n][0],t[1]-i[n][1]),0),xn=i=>Td(i);function yi(i,e,t,n,r){if(t<=0)return;let s=xn(e)*Math.min(t,1);i.beginPath(),i.moveTo(e[0][0]*n/100,e[0][1]*r/100);for(let a=1;a<e.length&&s>0;a+=1){const o=e[a-1],c=e[a],l=Math.hypot(c[0]-o[0],c[1]-o[1]),u=Math.min(1,s/l);i.lineTo((o[0]+(c[0]-o[0])*u)*n/100,(o[1]+(c[1]-o[1])*u)*r/100),s-=l}i.stroke()}function fa(i,e,t,n,r){let a=e.reduce((o,c)=>o+xn(c),0)*Math.min(1,Math.max(0,t));e.forEach(o=>{const c=xn(o);yi(i,o,Math.min(1,a/c),n,r),a-=c})}function bd(i,e,t,n,r){let s=e.reduce((a,o)=>a+xn(o),0)*Math.max(0,1-t);e.forEach(a=>{const o=xn(a),c=Math.min(o,Math.max(0,s));yi(i,a,c/o,n,r),s-=o})}function Ad(i,e,t,n,r){let s=e.reduce((o,c)=>o+xn(c),0)*Math.max(0,1-t);const a=new Map;[...e].reverse().forEach(o=>{const c=xn(o);a.set(o,Math.min(c,Math.max(0,s))),s-=c}),e.forEach(o=>yi(i,o,(a.get(o)||0)/xn(o),n,r))}function Rd(i,e,t,n,r){const s=o=>o*n/100,a=o=>o*r/100;if(i.save(),i.globalAlpha=.42,i.lineWidth=1.6,i.setLineDash([5,6]),i.beginPath(),e==="mountains"||e==="landscape"){const o=t*8%130-20;i.arc(s(o),a(23),s(6),0,Math.PI*2),i.arc(s(o+7),a(21),s(8),0,Math.PI*2),i.moveTo(s(10+Math.sin(t*2)*3),a(64)),i.lineTo(s(30),a(62)),i.moveTo(s(18+Math.sin(t*1.4)*4),a(69)),i.lineTo(s(38),a(67))}else if(e==="tree")i.moveTo(s(30),a(42+Math.sin(t*2)*2)),i.lineTo(s(27),a(48)),i.moveTo(s(71),a(50+Math.sin(t*1.7)*2)),i.lineTo(s(74),a(57)),i.arc(s(37+Math.sin(t)*5),a(74+t%2*8),s(2),0,Math.PI*2);else if(e==="light bulb"){const o=Math.sin(t*3)*3;i.moveTo(s(50),a(2)),i.lineTo(s(50),a(10+o)),i.moveTo(s(19),a(13)),i.lineTo(s(26+o),a(20)),i.moveTo(s(81),a(13)),i.lineTo(s(74-o),a(20))}else e==="planet"?i.arc(s(50),a(50),s(36),t%2,Math.PI+t%2):e==="flower"&&(i.moveTo(s(50),a(59)),i.lineTo(s(50+Math.sin(t*2)*4),a(82)));i.stroke(),i.restore()}function wd(i){const e=[...i.querySelectorAll("[data-doodle]")].map((l,u)=>({note:l,canvas:l.querySelector("[data-doodle-canvas]"),sketch:u%$i.length,phase:"drawing",started:performance.now()+u*500,userStrokes:[],activeStroke:null})).filter(l=>l.canvas instanceof HTMLCanvasElement),t=window.matchMedia("(prefers-reduced-motion: reduce)");let n=0;const r=(l,u)=>{const d=l.canvas,h=d.getContext("2d");if(!h)return;const f=d.width,_=d.height,m=(t.matches?8e3:u-l.started)%23e3,p=l.phase;m<8e3?l.phase="drawing":m<19e3?l.phase="complete":l.phase="reversing",l.phase==="reversing"&&p==="complete"&&l.activeStroke&&(l.activeStroke.length>1&&l.userStrokes.push(l.activeStroke),l.activeStroke=null),l.note.dataset.doodleState=l.phase,h.clearRect(0,0,f,_),h.strokeStyle="rgba(48, 49, 43, .82)",h.lineWidth=2.1,h.lineJoin="round",h.lineCap="round";const T=$i[l.sketch].paths;if(l.phase==="drawing"&&fa(h,T,m/8e3,f,_),l.phase==="complete"&&(fa(h,T,1,f,_),l.userStrokes.forEach(R=>yi(h,R,1,f,_)),Rd(h,$i[l.sketch].name,(m-8e3)/1e3,f,_)),l.phase==="reversing"){const R=(m-19e3)/4e3;bd(h,T,R,f,_),Ad(h,l.userStrokes,R,f,_)}l.activeStroke&&l.phase==="complete"&&yi(h,l.activeStroke,1,f,_),l.phase==="reversing"&&m>=22980&&(l.userStrokes=[],l.activeStroke=null,l.sketch=(l.sketch+1+s(l))%$i.length,l.started=u)},s=l=>e.indexOf(l),a=l=>{e.forEach(u=>r(u,l)),n=requestAnimationFrame(a)},o=(l,u)=>{const d=u.getBoundingClientRect();return[(l.clientX-d.left)*u.width/d.width,(l.clientY-d.top)*u.height/d.height]},c=e.map(l=>{const u=l.canvas,d=_=>{l.phase==="complete"&&(u.setPointerCapture(_.pointerId),l.activeStroke=[o(_,u)])},h=_=>{!l.activeStroke||l.phase!=="complete"||l.activeStroke.push(o(_,u))},f=()=>{l.activeStroke&&(l.phase==="complete"&&l.activeStroke.length>1&&l.userStrokes.push(l.activeStroke),l.activeStroke=null)};return u.addEventListener("pointerdown",d),u.addEventListener("pointermove",h),u.addEventListener("pointerup",f),u.addEventListener("pointercancel",f),()=>{u.removeEventListener("pointerdown",d),u.removeEventListener("pointermove",h),u.removeEventListener("pointerup",f),u.removeEventListener("pointercancel",f)}});return n=requestAnimationFrame(a),()=>{cancelAnimationFrame(n),c.forEach(l=>l())}}const Kt=document.querySelector("[data-play-root]");if(Kt instanceof HTMLElement){const i=window.matchMedia("(prefers-reduced-motion: reduce)"),e=Kt.querySelector("[data-shuffle]"),t=[...Kt.querySelectorAll("[data-play-tile]")],n=Kt.querySelector("[data-play-status]"),r=[...Kt.querySelectorAll("[data-play-reveal]")],s=Kt.querySelector("[data-battlefield]"),a=Kt.querySelector(".play-hero"),o=wd(Kt);if(document.addEventListener("astro:before-swap",o,{once:!0}),i.matches)r.forEach(c=>c.setAttribute("data-visible",""));else{Kt.dataset.motion="ready";const c=l=>l.setAttribute("data-visible","");if("IntersectionObserver"in window){const l=new IntersectionObserver(u=>{u.forEach(d=>{d.isIntersecting&&(c(d.target),l.unobserve(d.target))})},{threshold:.12,rootMargin:"0px 0px -8% 0px"});r.forEach(u=>l.observe(u))}else r.forEach(c)}if(e?.addEventListener("click",()=>{if(window.matchMedia("(max-width: 620px)").matches)return;const c=Kt.querySelector("[data-play-grid]");if(!(c instanceof HTMLElement))return;const l=window.matchMedia("(max-width: 980px)").matches?[[0,2],[42,54],[442,5],[482,53],[900,2],[932,54]]:[[0,2],[42,35],[4,68],[500,8],[475,39],[520,68]],u=[...t].sort(()=>Math.random()-.5),d=new Map(u.map(h=>[h,h.getBoundingClientRect()]));c.append(...u),u.forEach((h,f)=>{const[_,M]=l[f],m=(Math.random()*7-3.5).toFixed(2);h.style.top=`${_}px`,h.style.left=`${M}%`,h.style.right="auto",h.style.zIndex=String(f+1),h.style.setProperty("--play-desk-rotation",`${m}deg`),h.style.transform=`translate3d(0, 0, 0) rotate(${m}deg)`}),i.matches||u.forEach(h=>{const f=d.get(h),_=h.getBoundingClientRect();if(!f)return;const M=h.style.getPropertyValue("--play-desk-rotation");h.style.transform=`translate3d(${f.left-_.left}px, ${f.top-_.top}px, 0) rotate(${M})`,requestAnimationFrame(()=>{h.style.transform=`translate3d(0, 0, 0) rotate(${M})`})}),e.textContent="Shuffle again",n&&(n.textContent="The project desk has been rearranged into a new order.")}),s instanceof HTMLElement&&a instanceof HTMLElement){const c=Ed(s,a);document.addEventListener("astro:before-swap",c,{once:!0})}}
